# --
# Kernel/Output/Template/Plugin/OFORK.pm
...
package Kernel::Output::Template::Plugin::OFORK;
...
Kernel::Output::Template::Plugin::OFORK - Template Toolkit extension plugin
