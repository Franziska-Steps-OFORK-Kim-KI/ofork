# --
# Kernel/Output/Template/Document.pm
# Modified version of the work:
# Copyright (C) 2010-2025 OFORK, https://o-fork.de
# based on the original work of:
# Copyright (C) 2001-2018 OTRS AG, http://otrs.com/
# --
# $Id: Document.pm,v 1.1.1.1 2018/07/16 14:49:06 ud Exp $
# --
...
sub process {
    ...
    $Self->_InstallOFORKExtensions($Context);
...
=head2 _InstallOFORKExtensions()

adds some OFORK specific extensions to Template::Toolkit.

=cut

sub _InstallOFORKExtensions {
    my ( $Self, $Context ) = @_;

    # Already installed, nothing to do.
    return if $Context->stash()->get('OFORK');

    #
    # Load the OFORK plugin. This will register some filters and functions.
    #
    $Context->stash()->set( 'OFORK', $Context->plugin('OFORK') );

    #
    # The RenderBlock macro makes it possible to use the old dtl:block-Style block calls
    #   that are still used by OFORK with Template::Toolkit.
    #
