...
# --
# $Id: LDAP.pm,v 1.1.1.1 2018/07/16 14:49:06 ud Exp $
# --
...
sub Sync {
    ...
    # sync ldap group 2 ofork group permissions
    ...
    # sync ldap attribute 2 ofork group permissions
    ...
    # sync ldap group 2 ofork role permissions
    ...
    # sync ldap attribute 2 ofork role permissions
