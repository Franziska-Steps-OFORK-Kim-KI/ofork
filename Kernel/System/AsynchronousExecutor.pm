...
# --
# $Id: AsynchronousExecutor.pm,v 1.1.1.1 2018/07/16 14:49:06 ud Exp $
# --
...
Kernel::System::AsynchronousExecutor - base class to delegate tasks to the OFORK Scheduler Daemon

=head1 DESCRIPTION

ObjectManager controlled modules can add this base class to execute some time consuming tasks in the
background using the separate process OFORK Scheduler Daemon.
