...
# --
# $Id: Email.pm,v 1.1.1.1 2018/07/16 14:49:06 ud Exp $
# --
...
sub Send {
    ...
    # Check from
    if ( !$Param{From} ) {
        $Param{From} = $ConfigObject->Get('AdminEmail') || 'ofork@localhost';
    }
...
sub _CreateMimeEntity {
    ...
    if ( $ConfigObject->Get('Secure::DisableBanner') ) {
        ...
        $Header{'X-Powered-By'} = 'OFORK (https://o-fork.de/)';
    }
