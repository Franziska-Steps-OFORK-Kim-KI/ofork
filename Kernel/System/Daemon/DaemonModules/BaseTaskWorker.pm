# --
# Kernel/System/Daemon/DaemonModules/BaseTaskWorker.pm
# Modified version of the work:
# Copyright (C) 2010-2024 OFORK, https://o-fork.de
# based on the original work of:
# Copyright (C) 2001-2018 OTRS AG, http://otrs.com/
# --
# $Id: BaseTaskWorker.pm,v 1.1.1.1 2018/07/16 14:49:06 ud Exp $
# --
...
Creates a system error message and sends an email with the error messages form a task execution.
    ...
    my $Success = $TaskWorkerObject->_HandleError(
        TaskName     => 'some name',
        TaksType     => 'some type',
        LogMessage   => 'some message',       # message to set in the OFORK error log
...
sub _HandleError {
    ...
    if ( $From && $To ) {
        ...
        my $Sent = $Kernel::OM->Get('Kernel::System::Email')->Send(
            From     => $From,
            To       => $To,
            Subject  => "OFORK Scheduler Daemon $Param{TaskType}: $Param{TaskName}",
            Charset  => 'utf-8',
            MimeType => 'text/plain',
