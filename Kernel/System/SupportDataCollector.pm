# --
# Kernel/System/SupportDataCollector.pm
# Modified version of the work:
# Copyright (C) 2010-2024 OFORK, https://o-fork.de
# based on the original work of:
# Copyright (C) 2001-2018 OTRS AG, http://otrs.com/
# --
# $Id: SupportDataCollector.pm,v 1.1.1.1 2018/07/16 14:49:06 ud Exp $
# --
...
collect system data
    ...
    (
        ...
        Result  => [
            {
                Identifier  => 'Kernel::System::SupportDataCollector::OFORK::Version',
                DisplayPath => 'OFORK',
                Status      => $StatusOK,
                Label       => 'OFORK Version'
                Value       => '3.3.2',
            ...
            },
            {
                ...
                Value       => '0',
                Message     => 'Please enable mod_perl to speed up OFORK.',
            },
            {
