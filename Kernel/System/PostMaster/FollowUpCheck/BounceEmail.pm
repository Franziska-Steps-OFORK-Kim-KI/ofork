# --
# Kernel/System/PostMaster/FollowUpCheck/BounceEmail.pm
# Modified version of the work:
# Copyright (C) 2010-2024 OFORK, https://o-fork.de
# based on the original work of:
# Copyright (C) 2001-2018 OTRS AG, http://otrs.com/
# --
# $Id: BounceEmail.pm,v 1.1.1.1 2018/07/16 14:49:06 ud Exp $
# --
...
sub Run {
    ...
    $Self->_AddCommunicationLog( Message => 'Searching for header X-OFORK-Bounce.' );

    return if !$Param{GetParam}->{'X-OFORK-Bounce'};

    my $BounceMessageID = $Param{GetParam}->{'X-OFORK-Bounce-OriginalMessageID'};
...
sub _SetArticleTransmissionSendError {
    ...
    my $BounceError     = $Param{GetParam}->{'X-OFORK-Bounce-ErrorMessage'};
    my $BounceMessageID = $Param{GetParam}->{'X-OFORK-Bounce-OriginalMessageID'};
