# --
# Kernel/System/SupportDataCollector/PluginAsynchronous/OFORK/ConcurrentUsers.pm
# Modified version of the work:
# Copyright (C) 2010-2025 OFORK, https://o-fork.de
# based on the original work of:
# Copyright (C) 2001-2018 OTRS AG, http://otrs.com/
# --
# $Id: ConcurrentUsers.pm,v 1.1.1.1 2018/07/16 14:49:06 ud Exp $
# --
...
package Kernel::System::SupportDataCollector::PluginAsynchronous::OFORK::ConcurrentUsers;
...
sub GetDisplayPath {
    return
        'OFORK@Table:TimeStamp,UserSessionUnique|Unique agents,UserSession|Agent sessions,CustomerSessionUnique|Unique customers,CustomerSession|Customer sessions';
}
...
sub Run {
    ...
    for my $Column (@TableColumns) {
        ...
        $Self->AddResultInformation(
            DisplayPath => Translatable('OFORK') . '/' . Translatable('Concurrent Users'),
