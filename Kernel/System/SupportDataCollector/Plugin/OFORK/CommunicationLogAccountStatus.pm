# --
# Kernel/System/SupportDataCollector/Plugin/OFORK/CommunicationLogAccountStatus.pm
# Modified version of the work:
# Copyright (C) 2010-2025 OFORK, https://o-fork.de
# based on the original work of:
# Copyright (C) 2001-2018 OTRS AG, http://otrs.com/
# --
# $Id: CommunicationLogAccountStatus.pm,v 1.1.1.1 2018/07/16 14:49:06 ud Exp $
# --
...
package Kernel::System::SupportDataCollector::Plugin::OFORK::CommunicationLogAccountStatus;
...
sub GetDisplayPath {
    return Translatable('OFORK') . '/' . Translatable('Communication Log Account Status (last 24 hours)');
}
