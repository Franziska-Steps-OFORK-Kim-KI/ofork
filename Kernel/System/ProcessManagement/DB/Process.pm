...
# --
# $Id: Process.pm,v 1.1.1.1 2018/07/16 14:49:06 ud Exp $
# --
...
ActivityDialogs, Transitions and TransitionActions
    ...
    my $ProcessDump = $ProcessObject->ProcessDump(
        ...
        Location    => '/opt/ofork/var/myfile.txt'   # mandatory for ResultType = 'FILE'
        UserID      => 1,
    );
...
Returns:
    $ProcessDump = '/opt/ofork/var/myfile.txt';      # or undef if can't write the file
