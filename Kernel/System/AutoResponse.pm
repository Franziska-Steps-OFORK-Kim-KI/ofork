...
# --
# $Id: AutoResponse.pm,v 1.1.1.1 2018/07/16 14:49:06 ud Exp $
# --
...
Return example:
    ...
    %QueueAddressData(
        #Auto Response Data
        'Text'            => 'Your OFORK Team answered by a human asap.',
        'Subject'         => 'New ticket has been created! (RE: <OFORK_CUSTOMER_SUBJECT[24]>)',
        'ContentType'     => 'text/plain',
        'SystemAddressID' => '1',
        'AutoResponseID'  => '1'
        ...
        #System Address Data
        'ID'              => '1',
        'Name'            => 'ofork@localhost',
        'Address'         => 'ofork@localhost',
        'Realname'        => 'OFORK System',
