# --
# Kernel/System/UnitTest/Selenium/WebElement.pm
# Modified version of the work:
# Copyright (C) 2010-2025 OFORK, https://o-fork.de
# based on the original work of:
# Copyright (C) 2001-2018 OTRS AG, http://otrs.com/
# --
# $Id: WebElement.pm,v 1.1.1.1 2018/07/16 14:49:06 ud Exp $
# --
...
Submit a form element, and wait for the page to be fully loaded (works only in OFORK)
...
sub VerifiedSubmit {
    ...
    ) || die "OFORK API verification failed after element submit.";
...
sub VerifiedClick {    ## no critic
    ...
    $Self->driver()->WaitFor(
        JavaScript =>
            'return typeof(Core) == "object" && typeof(Core.App) == "object" && Core.App.PageLoadComplete'
    ) || die "OFORK API verification failed after element click.";
