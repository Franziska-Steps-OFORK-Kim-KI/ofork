...
# --
# $Id: Environment.pm,v 1.1.1.1 2018/07/16 14:49:06 ud Exp $
# --
...
returns:
    ...
    %OSInfo = (
        ...
        OS           => "Linux",
        OSName       => "debian 7.1",
        Path         => "/home/ofork/bin:/usr/local/bin:/usr/bin:/bin:/usr/local/games:/usr/games",
        POSIX        => [
                        "Linux",
                        "servername",
                        "3.2.0-4-686-pae",
...
collect OFORK information

    my %OFORKInfo = $EnvironmentObject->OFORKInfoGet();
