# --
# Kernel/System/SysConfig/ValueType/Date.pm
# Modified version of the work:
# Copyright (C) 2010-2024 OFORK, https://o-fork.de
# based on the original work of:
# Copyright (C) 2001-2018 OTRS AG, http://otrs.com/
# --
# $Id: Date.pm,v 1.1.1.1 2018/07/16 14:49:06 ud Exp $
# --
...
sub SettingEffectiveValueCheck {
    ...
    if ( !$Preferences{UserTimeZone} || $Preferences{UserTimeZone} eq $OFORKTimeZone ) {
        ...
        if ($Success) {
            ...
            $Kernel::OM->Get('Kernel::System::Log')->Log(
                Priority => 'error',
                Message  => "System was not able to calculate user Date in OFORKTimeZone!"
            );
        }
    }
