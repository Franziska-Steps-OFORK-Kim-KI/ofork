# --
# Kernel/System/SysConfig/XML.pm
# Modified version of the work:
# Copyright (C) 2010-2024 OFORK, https://o-fork.de
# based on the original work of:
# Copyright (C) 2001-2018 OTRS AG, http://otrs.com/
# --
# $Id: XML.pm,v 1.1.1.1 2018/07/16 14:49:06 ud Exp $
# --
...
Parses XML files into a list of perl structures and meta data.
    ...
    my $PerlStructure = $SysConfigXMLObject->SettingListParse(
        XMLInput => '
            ...
            <ofork_config version="2.0" init="Application">
...
sub SettingListParse {
    ...
    $XMLContent =~ m{ofork_config.*?version="(.*?)"};
    my $ConfigVersion = $1;
