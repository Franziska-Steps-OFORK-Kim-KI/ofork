# --
# Kernel/System/Console/Command/Admin/Package/RepositoryList.pm
# Modified version of the work:
# Copyright (C) 2010-2025 OFORK, https://o-fork.de
# based on the original work of:
# Copyright (C) 2001-2018 OTRS AG, http://otrs.com/
# --
# $Id: RepositoryList.pm,v 1.1.1.1 2018/07/16 14:49:06 ud Exp $
# --
...
sub Configure {
    ...
    $Self->Description('List all known OFORK package repsitories.');
...
sub Run {
    ...
    $Self->Print("<yellow>Listing OFORK package repositories...</yellow>\n");
    ...
    $Self->Print("<yellow>Listing OFORK package repository contents...</yellow>\n");
