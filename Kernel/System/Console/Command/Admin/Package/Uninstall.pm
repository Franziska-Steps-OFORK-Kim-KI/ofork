# --
# Kernel/System/Console/Command/Admin/Package/Uninstall.pm
# Modified version of the work:
# Copyright (C) 2010-2025 OFORK, https://o-fork.de
# based on the original work of:
# Copyright (C) 2001-2018 OTRS AG, http://otrs.com/
# --
# $Id: Uninstall.pm,v 1.1.1.1 2018/07/16 14:49:06 ud Exp $
# --
...
sub Configure {
    ...
    $Self->Description('Uninstall an OFORK package.');
    $Self->AddOption(
        Name        => 'force',
