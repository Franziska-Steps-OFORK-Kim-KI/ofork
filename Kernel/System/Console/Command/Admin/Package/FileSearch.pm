# --
# Kernel/System/Console/Command/Admin/Package/FileSearch.pm
# Modified version of the work:
# Copyright (C) 2010-2024 OFORK, https://o-fork.de
# based on the original work of:
# Copyright (C) 2001-2018 OTRS AG, http://otrs.com/
# --
# $Id: FileSearch.pm,v 1.1.1.1 2018/07/16 14:49:06 ud Exp $
# --
...
sub Configure {
    ...
    $Self->Description('Find a file in an installed OFORK package.');
    $Self->AddArgument(
        Name        => 'search-path',
...
sub Run {
    ...
    $Self->Print("<yellow>Searching in installed OFORK packages...</yellow>\n");
    ...
    $Self->PrintError("File $Filepath was not found in an installed OFORK package.\n");
