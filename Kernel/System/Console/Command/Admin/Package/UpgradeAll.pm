# --
# Kernel/System/Console/Command/Admin/Package/UpgradeAll.pm
# Modified version of the work:
# Copyright (C) 2010-2024 OFORK, https://o-fork.de
# based on the original work of:
# Copyright (C) 2001-2018 OTRS AG, http://otrs.com/
# --
# $Id: UpgradeAll.pm,v 1.1.1.1 2018/07/16 14:49:06 ud Exp $
# --
...
sub Configure {
    ...
    $Self->Description('Upgrade all OFORK packages to the latest versions from the on-line repositories.');
    $Self->AddOption(
        Name        => 'force',
