# --
# Kernel/System/Console/Command/Admin/Package/Export.pm
# Modified version of the work:
# Copyright (C) 2010-2025 OFORK, https://o-fork.de
# based on the original work of:
# Copyright (C) 2001-2018 OTRS AG, http://otrs.com/
# --
# $Id: Export.pm,v 1.1.1.1 2018/07/16 14:49:06 ud Exp $
# --
...
sub Configure {
    ...
    $Self->Description('Export the contents of an OFORK package to a directory.');
    $Self->AddOption(
    ...
    $Self->AddArgument(
        Name        => 'source-path',
        Description => "Specify the path to an OFORK package (opm) file that should be exported.",
        Required    => 1,
        ValueRegex  => qr/.*/smx,
    );
