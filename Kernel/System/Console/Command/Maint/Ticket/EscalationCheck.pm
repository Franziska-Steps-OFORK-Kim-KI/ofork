# --
# Kernel/System/Console/Command/Maint/Ticket/EscalationCheck.pm
# Modified version of the work:
# Copyright (C) 2010-2024 OFORK, https://o-fork.de
# based on the original work of:
# Copyright (C) 2001-2018 OTRS AG, http://otrs.com/
# --
# $Id: EscalationCheck.pm,v 1.1.1.1 2018/07/16 14:49:06 ud Exp $
# --
...
# base on the 'OFORKEscalationEvents::DecayTime'.
#
# =cut
...
sub Run {
    ...
    my $DecayTimeInSeconds = $Kernel::OM->Get('Kernel::Config')->Get('OFORKEscalationEvents::DecayTime') || 0;
