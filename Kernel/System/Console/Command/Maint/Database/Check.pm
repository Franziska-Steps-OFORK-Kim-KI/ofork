# --
# Kernel/System/Console/Command/Maint/Database/Check.pm
# Modified version of the work:
# Copyright (C) 2010-2024 OFORK, https://o-fork.de
# based on the original work of:
# Copyright (C) 2001-2018 OTRS AG, http://otrs.com/
# --
# $Id: Check.pm,v 1.1.1.1 2018/07/16 14:49:06 ud Exp $
# --
...
sub Configure {
    ...
    $Self->Description('Check OFORK database connectivity.');
    $Self->AddOption(
        Name        => 'repair',
...
sub _CheckMySQLInvalidDefaultValues {
    ...
    if ( $Param{Options}->{Repair} ) {
        ...
        $Error
            .= "\n\n *** Please correct these problems manually with the following SQL statements or use 'ofork.Console.pl $Self->{Name} --repair'. *** \n\n";
    }
