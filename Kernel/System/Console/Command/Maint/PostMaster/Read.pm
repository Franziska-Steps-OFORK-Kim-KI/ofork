# --
# Kernel/System/Console/Command/Maint/PostMaster/Read.pm
# Modified version of the work:
# Copyright (C) 2010-2025 OFORK, https://o-fork.de
# based on the original work of:
# Copyright (C) 2001-2018 OTRS AG, http://otrs.com/
# --
# $Id: Read.pm,v 1.1.1.1 2018/07/16 14:49:06 ud Exp $
# --
...
sub Configure {
    ...
    $Self->AddOption(
        Name        => 'untrusted',
        Description => "This will cause X-OFORK email headers to be ignored.",
        Required    => 0,
        HasValue    => 0,
    );
...
sub Run {
    ...
    my %ReturnCodeMap = (
        ...
        5 => 'Successful',    # ignored (because of X-OFORK-Ignore header)
    );
