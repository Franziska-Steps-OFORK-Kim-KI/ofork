# --
# Kernel/System/Console/Command/Maint/PostMaster/SpoolMailsReprocess.pm
# Modified version of the work:
# Copyright (C) 2010-2024 OFORK, https://o-fork.de
# based on the original work of:
# Copyright (C) 2001-2018 OTRS AG, http://otrs.com/
# --
# $Id: SpoolMailsReprocess.pm,v 1.1.1.1 2018/07/16 14:49:06 ud Exp $
# --
...
sub Run {
    ...
    for my $File (@Files) {
        ...
        my $Result = system("$^X $Home/bin/ofork.Console.pl Maint::PostMaster::Read <  $File ");
