# --
# Kernel/System/Console/Command/Maint/PostMaster/MailAccountFetch.pm
# Modified version of the work:
# Copyright (C) 2010-2024 OFORK, https://o-fork.de
# based on the original work of:
# Copyright (C) 2001-2018 OTRS AG, http://otrs.com/
# --
# $Id: MailAccountFetch.pm,v 1.1.1.1 2018/07/16 14:49:06 ud Exp $
# --
...
sub PreRun {
    ...
    if ($Debug) {
        $Kernel::OM->Get('Kernel::System::Log')->Log(
            Priority => 'debug',
            Message  => "OFORK email handle ($Name) started.",
        );
    }
...
sub PostRun {
    ...
    if ($Debug) {
        $Kernel::OM->Get('Kernel::System::Log')->Log(
            Priority => 'debug',
            Message  => "OFORK email handle ($Name) stopped.",
        );
    }
