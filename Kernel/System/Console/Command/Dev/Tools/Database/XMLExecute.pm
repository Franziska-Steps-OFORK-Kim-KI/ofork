# --
# Kernel/System/Console/Command/Dev/Tools/Database/XMLExecute.pm
# Modified version of the work:
# Copyright (C) 2010-2025 OFORK, https://o-fork.de
# based on the original work of:
# Copyright (C) 2001-2018 OTRS AG, http://otrs.com/
# --
# $Id: XMLExecute.pm,v 1.1.1.1 2018/07/16 14:49:06 ud Exp $
# --
...
sub Configure {
    ...
    $Self->Description('Convert an OFORK database XML file to SQL and execute it in the current database.');
    $Self->AddArgument(
        Name        => 'source-path',
