# --
# Kernel/System/Console/Command/Dev/Tools/ImportFakeEmails.pm
# Modified version of the work:
# Copyright (C) 2010-2024 OFORK, https://o-fork.de
# based on the original work of:
# Copyright (C) 2001-2018 OTRS AG, http://otrs.com/
# --
# $Id: ImportFakeEmails.pm,v 1.1.1.1 2018/07/16 14:49:06 ud Exp $
# --
...
sub _CleanSpoolFiles {
    ...
    my $OforkDir = __FILE__;
    $OforkDir =~ s/\/Kernel.*$//i;

    my @SpoolFilesFailedUnlink = ();
    my @SpoolFiles             = glob "${ OforkDir }/var/spool/problem-email-*";
