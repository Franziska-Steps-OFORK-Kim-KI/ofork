# --
# Kernel/System/Console/Command/Dev/Package/RepositoryIndex.pm
# Modified version of the work:
# Copyright (C) 2010-2025 OFORK, https://o-fork.de
# based on the original work of:
# Copyright (C) 2001-2018 OTRS AG, http://otrs.com/
# --
# $Id: RepositoryIndex.pm,v 1.1.1.1 2018/07/16 14:49:06 ud Exp $
# --
...
sub Configure {
    ...
    $Self->Description('Generate an index file (ofork.xml) for an OFORK package repository.');
    $Self->AddArgument(
        Name        => 'source-directory',
        Description => "Specify the directory containing the OFORK packages.",
        Required    => 1,
        ValueRegex  => qr/.*/smx,
    );
...
sub Run {
    ...
    $Result .= "<ofork_package_list version=\"1.0\">\n";
    my $SourceDirectory = $Self->GetArgument('source-directory');
