# --
# Kernel/System/Console/Command/Dev/Package/Build.pm
# Modified version of the work:
# Copyright (C) 2010-2025 OFORK, https://o-fork.de
# based on the original work of:
# Copyright (C) 2001-2018 OTRS AG, http://otrs.com/
# --
# $Id: Build.pm,v 1.1.1.1 2018/07/16 14:49:06 ud Exp $
# --
...
sub Configure {
    ...
    $Self->Description('Create an OFORK package (opm) file from an OFORK package source (sopm) file.');
    $Self->AddOption(
        Name        => 'version',
    ...
    $Self->AddOption(
        ...
        Description =>
            "Specify the directory containing the module sources (otherwise the OFORK home directory will be used).",
        Required   => 0,
        HasValue   => 1,
        ValueRegex => qr/.*/smx,
    );
    $Self->AddArgument(
        Name        => 'source-path',
        Description => "Specify the path to an OFORK package source (sopm) file that should be built.",
        Required    => 1,
        ValueRegex  => qr/.*/smx,
    );
    $Self->AddArgument(
...
sub Run {
    ...
    # build from given package directory, if any (otherwise default to OFORK home)
