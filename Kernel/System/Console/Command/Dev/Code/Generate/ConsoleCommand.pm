# --
# Kernel/System/Console/Command/Dev/Code/Generate/ConsoleCommand.pm
# Modified version of the work:
# Copyright (C) 2010-2024 OFORK, https://o-fork.de
# based on the original work of:
# Copyright (C) 2001-2018 OTRS AG, http://otrs.com/
# --
# $Id: ConsoleCommand.pm,v 1.1.1.1 2018/07/16 14:49:06 ud Exp $
# --
...
sub Configure {
    ...
    $Self->AddOption(
        ...
        Description =>
            "Specify the directory containing the module where the new command should be created (otherwise the OFORK home directory will be used).",
        Required   => 0,
        HasValue   => 1,
        ValueRegex => qr/.*/smx,
    );
