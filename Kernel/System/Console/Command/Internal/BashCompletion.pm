# --
# Kernel/System/Console/Command/Internal/BashCompletion.pm
# Modified version of the work:
# Copyright (C) 2010-2024 OFORK, https://o-fork.de
# based on the original work of:
# Copyright (C) 2001-2018 OTRS AG, http://otrs.com/
# --
# $Id: BashCompletion.pm,v 1.1.1.1 2018/07/16 14:49:06 ud Exp $
# --
...
sub Run {
    ...
    if ( $PreviousWord =~ m/ofork\.Console\.pl/xms ) {
    ...
    # We are looking for an option/argument
        ...
        if ( !$CompLine || !$CompLine =~ m/ofork\.Console\.pl/ ) {
            $Self->ExitCodeError();
        }
        $CompLine =~ s/.*ofork\.Console\.pl\s*//xms;
