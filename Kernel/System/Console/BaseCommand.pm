# --
# Kernel/System/Console/BaseCommand.pm
# Modified version of the work:
# Copyright (C) 2010-2025 OFORK, https://o-fork.de
# based on the original work of:
# Copyright (C) 2001-2018 OTRS AG, http://otrs.com/
# --
# $Id: BaseCommand.pm,v 1.1.1.1 2018/07/16 14:49:06 ud Exp $
# --
...
sub Execute {
    ...
    $Kernel::OM->ObjectParamAdd(
        'Kernel::System::Log' => {
            LogPrefix => 'OFORK-ofork.Console.pl-' . $Self->Name(),
        },
    );
    ...
    if ( !$ParsedGlobalOptions->{'allow-root'} && $> == 0 ) {    # $EFFECTIVE_USER_ID
        $Self->PrintError(
            "You cannot run ofork.Console.pl as root. Please run it as the 'ofork' user or with the help of su:"
        );
        $Self->Print("  <yellow>su -c \"bin/ofork.Console.pl MyCommand\" -s /bin/bash ofork</yellow>\n");
...
sub GetUsageHelp {
    ...
    $UsageText .= "\n<yellow>Usage:</yellow>\n";
    $UsageText .= " ofork.Console.pl $Self->{Name}";
