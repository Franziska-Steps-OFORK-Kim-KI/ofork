...
# --
# $Id: POP3.pm,v 1.1.1.1 2018/07/16 14:49:06 ud Exp $
# --
                ...
                if ( !$Lines ) {
                    ...
                    if ( !$Return[0] ) {
                        ...
                        my $ErrorMessage = "$AuthType: Can't process mail, mail saved ("
                            . "$File, report it on https://bugs.o-fork.de/)!";
                        ...
                        $CommunicationLogObject->ObjectLog(
                            ...
                            Key           => 'Kernel::System::MailAccount::POP3',
                            Value =>
                                "Could not process message. Raw mail saved ($File, report it on https://bugs.o-fork.de/)!",
                        );
