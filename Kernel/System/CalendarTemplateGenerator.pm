# --
# Kernel/System/CalendarTemplateGenerator.pm
# Modified version of the work:
# Copyright (C) 2010-2024 OFORK, https://o-fork.de
# based on the original work of:
# Copyright (C) 2001-2018 OTRS AG, http://otrs.com/
# --
# $Id: CalendarTemplateGenerator.pm,v 1.1.1.1 2018/07/16 14:49:06 ud Exp $
# --
...
sub _Replace {
    ...
    for my $SecretConfigOption (@SecretConfigOptions) {
        ...
        my $Tag = $Start . 'OFORK_CONFIG_' . $SecretConfigOption . $End;
