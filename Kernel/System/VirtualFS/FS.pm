# --
# Kernel/System/VirtualFS/FS.pm
# Modified version of the work:
# Copyright (C) 2010-2024 OFORK, https://o-fork.de
# based on the original work of:
# Copyright (C) 2001-2018 OTRS AG, http://otrs.com/
# --
# $Id: FS.pm,v 1.1.1.1 2018/07/16 14:49:06 ud Exp $
# --
...
sub new {
    ...
    if ( !-w $Self->{DataDir} ) {
        ...
        $Kernel::OM->Get('Kernel::System::Log')->Log(
            Priority => 'notice',
            Message  => "Can't write $Self->{DataDir}! try: \$OFORK_HOME/bin/ofork.SetPermissions.pl!",
        );
        die "Can't write $Self->{DataDir}! try: \$OFORK_HOME/bin/ofork.SetPermissions.pl!";
    }
