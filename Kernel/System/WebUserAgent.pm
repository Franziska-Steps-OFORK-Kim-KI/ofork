# --
# Kernel/System/WebUserAgent.pm
# Modified version of the work:
# Copyright (C) 2010-2025 OFORK, https://o-fork.de
# based on the original work of:
# Copyright (C) 2001-2018 OTRS AG, http://otrs.com/
# --
# $Id: WebUserAgent.pm,v 1.1.1.1 2018/07/16 14:49:06 ud Exp $
# --
...
If you need to set credentials
    ...
    my %Response = $WebUserAgentObject->Request(
        ...
        Credentials  => {
            User     => 'ofork_user',
            Password => 'ofork_password',
            Realm    => 'OFORK Unittests',
            Location => 'ftp.o-fork.de:443',
        },
        SkipSSLVerification => 1, # (optional)
        NoLog               => 1, # (optional)
    );
