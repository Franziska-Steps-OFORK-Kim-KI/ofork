# --
# Kernel/Language/en_GB.pm
# Modified version of the work:
# Copyright (C) 2010-2025 OFORK, https://o-fork.de
# Copyright (C) 2001-2018 OTRS AG, http://otrs.com/
# --
# $Id: en_GB.pm,v 1.1.1.1 2018/07/16 14:49:06 ud Exp $
# --
...
sub Data {
    ...
    $Self->{Completeness}        = 0.691870478815019;
    ...
    $Self->{Translation} = {
        ...
        'The full path and name of the certification authority certificate file that validates SSL certificate.' =>
            'The full path and name of the certification authority certificate file that validates SSL certificate.',
        'e.g. /opt/ofork/var/certificates/SOAP/CA/ca.pem' => 'e.g. /opt/ofork/var/certificates/SOAP/CA/ca.pem',
        'Certification Authority (CA) Directory' => 'Certification Authority (CA) Directory',
        'The full path of the certification authority directory where the CA certificates are stored in the file system.' =>
            'The full path of the certification authority directory where the CA certificates are stored in the file system.',
        'e.g. /opt/ofork/var/certificates/SOAP/CA' => 'e.g. /opt/ofork/var/certificates/SOAP/CA',
        ...
        'e.g urn:otrs-com:soap:functions or https://o-fork.dem/GenericInterface/actions' =>
        ...
        'A support bundle (including: a list of installed packages and all locally modified source code files) can be generated by pressing this button:' =>
            'A support bundle (including: support data, a list of installed packages and all locally modified source code files) can be generated by pressing this button:',
        ...
        'The support bundle will be sent to OFORK Team via email automatically.' =>
            'The support bundle will be sent to OFORK Team via email automatically.',
        'Download File' => 'Download File',
        'A file containing the support bundle will be downloaded to the local system. Please save the file and send it to the OTRS Team, using an alternate method.' =>
            'A file containing the support bundle will be downloaded to the local system. Please save the file and send it to the OTRS Team, using an alternate method.',
...
',
        ...
        'Sends registration information to OTRS.' => 'Sends registration information to OTRS.',
        ...
        'This module and its PreRun() function will be executed, if defined, for every request. This module is useful to check some user options or to display news about new applications.' =>
            'This module and its PreRun() function will be executed, if defined, for every request. This module is useful to check some user options or to display news about new applications.',
        'This module is part of the admin area of OFORK.' => 'This module is part of the admin area of OFORK.',
