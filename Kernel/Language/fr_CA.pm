...
# --
# $Id: fr_CA.pm,v 1.1.1.1 2018/07/16 14:49:06 ud Exp $
# --
...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'It is highly recommended to send this data to OFORK in order to get better support.' =>
            '',
        'Configuration' => '',
        'Send support data' => '',
        'This will allow the system to send additional support data information to OFORK.' =>
            '',
        'Update' => 'Mettre à jour',
        'System Registration' => '',
        'To enable data sending, please register your system with OFORK or update your system registration information (make sure to activate the \'send support data\' option.)' =>
            '',
        ...
        'System registration is a service of OFORK, which provides a lot of advantages!' =>
            '',
        'Please note that the use of OFORK cloud services requires the system to be registered.' =>
            '',
        'Register this system' => '',
        ...
        'This OFORK invoker backend module will be called to prepare the data to be sent to the remote system, and to process its response data.' =>
            'Le module de OFORK comprenant l\'arrière-plan du demandeur traitera les données envoyées au système distant ainsi que celles composant la réponse.',
        ...
        'The data from the invoker of OFORK will be processed by this mapping, to transform it to the kind of data the remote system expects.' =>
            'Les données du demandeur de OFORK seront traitées lors du mappage; elles seront converties pour le système distant.',
        ...
        'The response data will be processed by this mapping, to transform it to the kind of data the invoker of OFORK expects.' =>
            'Les données composant les réponses seront traitées lors du mappage; elles seront converties pour le demandeur de OFORK.',
        ...
        'This OFORK operation backend module will be called internally to process the request, generating data for the response.' =>
            'Ce module de l\'arrière-plan des opérations de OFORK sera appelé dans le programme afin de traiter la demande, générant ainsi des donnée permettant de répondre.',
        ...
        'The request data will be processed by this mapping, to transform it to the kind of data OFORK expects.' =>
            'La réquisition de données sera traitée par mappage afin de la transformer en données lisibles par OFORK.',
        ...
        'The full path and name of the SSL client certificate file (must be in PEM, DER or PKCS#12 format).' =>
            '',
        'e.g. /opt/ofork/var/certificates/SOAP/certificate.pem' => '',
        'Client Certificate Key' => '',
        'The full path and name of the SSL client certificate key file (if not already included in certificate file).' =>
            '',
        'e.g. /opt/ofork/var/certificates/SOAP/key.pem' => '',
        ...
        'e.g. /opt/ofork/var/certificates/SOAP/CA/ca.pem' => 'par ex. /opt/ofork/var/certificates/SOAP/CA/ca.pem',
        ...
        'e.g. /opt/ofork/var/certificates/SOAP/CA' => 'par ex. /opt/ofork/var/certificates/SOAP/CA',
        ...
        'e.g. https://local.o-fork.de:8000/Webservice/Example' => '',
        'Set SOAPAction' => '',
        ...
        'e.g urn:o-fork-de:soap:functions or https://o-fork.de/GenericInterface/actions' =>
            'par ex. urn:o-fork-de:soap:functions or https://o-fork.de/GenericInterface/actions',
        'Request name scheme' => '',
        ...
        'Here you can specify the maximum size (in bytes) of SOAP messages that OFORK will process.' =>
            'indiquez ici le poids maximal (en octets) des messages du protocole SOAP que OFORK traitera.',
        'Encoding' => 'codage',
        ...
        'In provider mode, OFORK offers web services which are used by remote systems.' =>
            'En mode « fournisseur », OFORK offre des services Web aux systèmes à distance.',
        'In requester mode, OFORK uses web services of remote systems.' =>
            'En mode « demandeur », OFORK utilise les services Web des systèmes à distance.',
        ...
        'To be able to use PGP in OFORK, you have to enable it first.' => '',
        'Enable PGP support' => '',
        ...
        'package information' => '',
        'Package installation requires a patch level update of OFORK.' => '',
        'Package update requires a patch level update of OFORK.' => '',
        'If you are a OFORK Business Solution™ customer, please visit our customer portal and file a request.' =>
            '',
        'Please note that your installed OFORK version is %s.' => '',
        ...
        'This package is verified by OFORKverify (tm)' => '',
        ...
        'This system is registered with OFORK.' => '',
        'System type' => '',
        'Unique ID' => '',
        'Last communication with registration server' => '',
        'System Registration not Possible' => '',
        'Please note that you can\'t register your system if OFORK Daemon is not running correctly!' =>
            '',
        'Instructions' => '',
        ...
        'OFORK-ID Login' => '',
        'Read more' => '',
        'You need to log in with your OFORK-ID to register your system.' =>
            '',
        'Your OFORK-ID is the email address you used to sign up on the OFORK.com webpage.' =>
            '',
        'Data Protection' => '',
        ...
        'We will inform you about our new services and offerings soon.' =>
            '',
        'Can I use OFORK without being registered?' => '',
        'System registration is optional.' => '',
        'You can download and use OFORK without being registered.' => '',
        'Is it possible to deregister?' => '',
        'You can deregister at any time.' => '',
        'Which data is transfered when registering?' => '',
        'A registered system sends the following data to OFORK:' => '',
        'Fully Qualified Domain Name (FQDN), OFORK version, Database, Operating System and Perl version.' =>
            '',
        'Why do I have to provide a description for my system?' => '',
        'The description of the system is optional.' => '',
        'The description and system type you specify help you to identify and manage the details of your registered systems.' =>
            '',
        'How often does my OFORK system send updates?' => '',
        'Your system will send updates to the registration server at regular intervals.' =>
            '',
        'Typically this would be around once every three days.' => '',
        'If you deregister your system, you will lose these benefits:' =>
            '',
        'You need to log in with your OFORK-ID to deregister your system.' =>
            '',
        'OFORK-ID' => '',
        'You don\'t have an OFORK-ID yet?' => '',
        'Sign up now' => 'Enregistrez-vous maintenant',
        'Forgot your password?' => '',
        'Retrieve a new one' => '',
        'Next' => 'Suivant',
        'This data will be frequently transferred to OFORK when you register this system.' =>
            '',
        'Attribute' => 'Attribut',
        'FQDN' => '',
        'OFORK Version' => '',
        ...
        'Register' => '',
        'Continuing with this step will deregister the system from OFORK.' =>
            '',
        'Deregister' => '',
        ...
        'Sending support data to OFORK is not possible!' => '',
        'Enable Cloud Services' => '',
        ...
        'The support bundle will be sent to OFORK Team via email automatically.' =>
            '',
        'Download File' => 'Télécharger le fichier',
        'A file containing the support bundle will be downloaded to the local system. Please save the file and send it to the OFORK, using an alternate method.' =>
            '',
        ...
        # Template: AgentOFORKBusinessBlockScreen
        'Unauthorized usage of %s detected' => '',
        'If you decide to downgrade to ((OFORK)) Community Edition, you will lose all database tables and data related to %s.' =>
            '',
        ...
        'This setting can currently not be saved' => '',
        'Save this setting' => '',
        'Did you know? You can help translating OFORK at %s.' => '',
        ...
        'Statistics Overview' => '',
        'Read more about statistics in OFORK' => '',
        'Add Statistics' => '',
        'Dynamic Matrix' => '',
        ...
        'View notifications' => '',
        'Notifications' => '',
        'Notifications (OFORK Business Solution™)' => '',
        'Logout' => 'Déconnexion',
        ...
        'Install Type' => '',
        'Create a new database for OFORK' => '',
        'Use an existing database for OFORK' => '',
        ...
        'A new database user with limited permissions will be created for this OFORK system.' =>
            'Un nouvel utilisateur de la base de données avec des droits limités sera créé pour ce système OFORK.',
        'Repeat Password' => '',
        'Generated password' => '',
        ...
        'To be able to use OFORK you have to enter the following line in your command line (Terminal/Shell) as root.' =>
            'Pour pouvoir utiliser OFORK, vous devez entrer les commandes suivantes (Terminal ou Shell) en tant que segment résident.',
        'Restart your webserver' => 'Redémarrer votre serveur Web',
        'After doing so your OFORK is up and running.' => 'Après cela votre OFORK sera opérationnel.',
        'Start page' => 'Page de démarrage',
        'Your OFORK Team' => 'Votre Équipe OFORK',
        ...
        # Template: OFORKBusinessTeaser
        'With %s, System Configuration supports versioning, rollback and user-specific configuration settings.' =>
            '',

        # Template: Test
        'OFORK Test Page' => 'Page de test de OFORK',
        ...
        'OFORK as provider' => 'OFORK, fournisseur',
        'Operations' => '',
        'OFORK as requester' => 'OFORK, demandeur',
        'Invokers' => '',
        ...
        # Perl Module: Kernel/Modules/AdminOFORKBusiness.pm
        ...
        'Package not verified due a communication issue with verification server!' =>
            '',
        'Can\'t connect to OFORK Feature Add-on list server!' => '',
        'Can\'t get OFORK Feature Add-on list from server!' => '',
        'Can\'t get OFORK Feature Add-on from server!' => '',
        ...
        'Contact us at support@o-fork.de' => '',
        'Get Help' => '',
        ...
        'Upgrade to OFORK Business Solution™' => '',
        'Re-install Package' => '',
        'Upgrade' => 'Mise à jour',
        'Re-install' => '',
        ...
        'Can\'t connect to OFORK News server!' => '',
        'Can\'t get OFORK News from server!' => '',
        ...
        'Enable cloud services to unleash all OFORK features!' => '',

        # Perl Module: Kernel/Output/HTML/Notification/AgentOFORKBusiness.pm
        ...
        'You have exceeded the number of concurrent agents - contact support@o-fork.de.' =>
            '',
        'Please note that the session limit is almost reached.' => '',
        'Login rejected! You have exceeded the maximum number of concurrent Agents! Contact support@o-fork.de immediately!' =>
            '',
        ...
        'OFORK Disk Partition' => '',

        # Perl Module: Kernel/System/SupportDataCollector/Plugin/OS/DiskSpace.pm
        'Disk Usage' => '',
        'The partition where OFORK is located is almost full.' => '',
        ...
        'The file system on your OFORK partition is not writable.' => '',
        ...
        'Spooled Emails' => '',
        'There are emails in var/spool that OFORK could not process.' => '',
        ...
        'Server time zone' => '',
        'OFORK time zone' => '',
        'OFORK time zone is not set.' => '',
        'User default time zone' => '',
        'User default time zone is not set.' => '',
        'OFORK time zone setting for calendar' => '',
        ...
        'System was not able to calculate user Date in OFORKTimeZone!' => '',
...
' => '',
        ...
        'Adds a suffix with the actual year and month to the OFORK log file. A logfile for every month will be created.' =>
            'Ajoute un suffixe comprenant l\'année et le mois en cours au fichier d\'enregistrement de OFORK. Un fichier d\'enregistrement est créé à chaque mois.',
        ...
        'All attachments (OFORK Business Solution™)' => '',
        ...
        'Checks the SystemID in ticket number detection for follow-ups. If not enabled, SystemID will be changed after using the system.' =>
            '',
        'Checks the availability of OFORK Business Solution™ for this system.' =>
            '',
        'Checks the entitlement status of OFORK Business Solution™.' => '',
        'Child' => 'Enfant',
        'Chinese (Simplified)' => '',
        'Chinese (Traditional)' => '',
        ...
        'Define a filter for html output to add links behind a defined string. The element Image allows two input kinds. At once the name of an image (e.g. faq.png). In this case the OFORK image path will be used. The second possiblity is to insert the link to the image.' =>
            'Détermine un filtre pour les html sortants afin d\'ajouter des liens aux chaînes sélectionnées. L\'élément Image permet de faire deux sortes d\'entrées. Tout d\'abord, le nom de l\'image (ex. faq.png). Dans ce cas, le chemin de l\'image dans OFORK sera utilisé. Il est aussi possible d\'insérer le lien vers l\'image.',
        ...
        'Defines a filter for html output to add links behind CVE numbers. The element Image allows two input kinds. At once the name of an image (e.g. faq.png). In this case the OFORK image path will be used. The second possiblity is to insert the link to the image.' =>
            'Détermine un filtre pour les html sortants afin d\'ajouter des liens aux nombres CVE. L\'élément Image permet de faire deux sortes d\'entrées. Tout d\'abord, le nom de l\'image (ex. faq.png). Dans ce cas, le chemin de l\'image dans OFORK sera utilisé. Il est aussi possible d\'insérer le lien vers l\'image.',
        'Defines a filter for html output to add links behind MSBulletin numbers. The element Image allows two input kinds. At once the name of an image (e.g. faq.png). In this case the OFORK image path will be used. The second possiblity is to insert the link to the image.' =>
            'Détermine un filtre pour les html sortants afin d\'ajouter des liens aux nombres MSBulletin. L\'élément Image permet de faire deux sortes d\'entrées. Tout d\'abord, le nom de l\'image (ex. faq.png). Dans ce cas, le chemin de l\'image dans OFORK sera utilisé. Il est aussi possible d\'insérer le lien vers l\'image.',
        'Defines a filter for html output to add links behind a defined string. The element Image allows two input kinds. At once the name of an image (e.g. faq.png). In this case the OFORK image path will be used. The second possiblity is to insert the link to the image.' =>
            'Détermine un filtre pour les html sortants afin d\'ajouter des liens à des chaînes sélectionnées. L\'élément Image permet de faire deux sortes d\'entrées. Tout d\'abord, le nom de l\'image (ex. faq.png). Dans ce cas, le chemin de l\'image dans OFORK sera utilisé. Il est aussi possible d\'insérer le lien vers l\'image.',
        'Defines a filter for html output to add links behind bugtraq numbers. The element Image allows two input kinds. At once the name of an image (e.g. faq.png). In this case the OFORK image path will be used. The second possiblity is to insert the link to the image.' =>
            'Détermine un filtre pour les html sortants afin d\'ajouter des liens aux nombres de retraçage des bogues. L\'élément Image permet de faire deux sortes d\'entrées. Tout d\'abord, le nom de l\'image (ex. faq.png). Dans ce cas, le chemin de l\'image dans OFORK sera utilisé. Il est aussi possible d\'insérer le lien vers l\'image.',
        ...
        'Defines if customers should be allowed to login if they have no shared secret stored in their preferences and therefore are not using two-factor authentication.' =>
            '',
        'Defines if the communication between this system and OFORK servers that provide cloud services is possible. If set to \'Disable cloud services\', some functionality will be lost such as system registration, support data sending, upgrading to and use of OFORK Business Solution™, OFORK Verify™, OFORK News and product News dashboard widgets, among others.' =>
            '',
        ...
        'Defines the fully qualified domain name of the system. This setting is used as a variable, OFORK_CONFIG_FQDN which is found in all forms of messaging used by the application, to build links to the tickets within your system.' =>
            'Détermine le nom de domaine complet du système. Le réglage est utilisé en tant que variable, OFORK_CONFIG_FQDN est trouvé sous toutes les formes de message utilisé par l\'application afin de créer des liens vers les demandes dans votre système.',
        ...
        'Defines the list of online repositories. Another installations can be used as repository, for example: Key="http://example.com/ofork/public.pl?Action=PublicRepository;File=" and Content="Some Name".' =>
            'Détermine la liste des référentiels en ligne. Une autre installation pourrait servir de référentiel, par exemple, clé=« http://exemple.com/ofork/public.pl?Action=Référentielpublic;Fichier= » et Contenu=« Nom ».',
        ...
        'Defines the module to display a notification if cloud services are disabled.' =>
            '',
        'Defines the module to display a notification in different interfaces on different occasions for OFORK Business Solution™.' =>
            '',
        ...
        'Defines the name of the session key. E.g. Session, SessionID or OFORK.' =>
            'Détermine le nom de la clé de session, par exemple, Session, SessionID ou OFORK.',
        ...
        'Delivers extended debugging information in the frontend in case any AJAX errors occur, if enabled.' =>
            '',
        'Deploy and manage OFORK Business Solution™.' => '',
        'Detached' => '',
        ...
        'Executes follow-up checks on In-Reply-To or References headers for mails that don\'t have a ticket number in the subject.' =>
            '',
        'Executes follow-up checks on OFORK Header \'X-OFORK-Bounce\'.' => '',
        ...
        'If enabled, OFORK will deliver all JavaScript files in minified form.' =>
            'OFORK livrera tous les fichiers JavaScript en format minimisé si vous activez cette option.',
        ...
        'Merged Ticket <OFORK_TICKET> to <OFORK_MERGE_TO_TICKET>.' => '',
        'Minute' => '',
        ...
        'New process ticket' => '',
        'News about OFORK releases!' => 'Nouvelles au sujet des versions de OFORK.',
        'News about OFORK.' => '',
        ...
        'Reports' => 'Rapports',
        'Reports (OFORK Business Solution™)' => '',
        ...
        'Resource Overview (OFORK Business Solution™)' => '',
        'Responsible Tickets' => '',
        'Responsible Tickets.' => '',
        ...
        'Select your preferred theme for OFORK.' => '',
        ...
        'Sends registration information to OFORK group.' => '',
        ...
        'Sets the prefix to the scripts folder on the server, as configured on the web server. This setting is used as a variable, OFORK_CONFIG_ScriptAlias which is found in all forms of messaging used by the application, to build links to the tickets within the system.' =>
            'Établit le préfix du fichier de script sur le serveur, compte tenu de sa configuration sur le serveur Web. Le réglage est utilisé en tant que variable, OFORK_CONFIG_ScriptAlias est trouvé sous toutes les formes de message utilisé par l\'application afin de créer des liens vers les demandes du système.',
        ...
        'Shows a teaser link in the menu for the ticket attachment view of OFORK Business Solution™.' =>
            '',
        ...
        'Shows information on how to start OFORK Daemon' => '',
        ...
        'Specify how many sub directory levels to use when creating cache files. This should prevent too many cache files being in one directory.' =>
            '',
        'Specify the channel to be used to fetch OFORK Business Solution™ updates. Warning: Development releases might not be complete, your system might experience unrecoverable errors and on extreme cases could become unresponsive!' =>
            '',
        ...
        'This module is part of the admin area of OFORK.' => '',
        ...
        'This setting is deprecated. Set OFORKTimeZone instead.' => '',
        ...
        'Toggles display of OFORK FeatureAddons list in PackageManager.' =>
            'Permet de basculer dans l\'affichage de la liste des fonctions des compagnons de OFORK dans le gestionnaire de paquets.',
        ...
        'Your email with ticket number "<OFORK_TICKET>" is merged to "<OFORK_MERGE_TO_TICKET>".' =>
            'Le courriel portant le numéro de demande « <OFORK_TICKET> » a été fusionné avec la demande numéro « <OFORK_MERGE_TO_TICKET> ».',
