...
# --
# $Id: de.pm,v 1.1.1.1 2018/07/16 14:49:06 ud Exp $
# --
...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'Ticket visible for customer' => 'Ticket sichtbar für Kunden',
        ...
        'Submit' => 'Übermitteln',
        'To use a sign key, PGP keys or S/MIME certificates need to be added with identifiers for selected queue system address.' => 'Um einen Schlüssel zum Signieren zu verwenden, müssen PGP-Schlüssel oder S/MIME-Zertifikate mit Identifikatioren für die ausgewählten Systemadressen der Queues hinzugefügt werden.',        
        ...
        'This OFORK error handling backend module will be called internally to process the error handling mechanism.' =>
        ...
        'This OFORK invoker backend module will be called to prepare the data to be sent to the remote system, and to process its response data.' =>
        ...
        'The data from the invoker of OFORK will be processed by this mapping, to transform it to the kind of data the remote system expects.' =>
            'Die Daten des Invokers von OFORK werden von diesem Mapping verarbeitet, um sie so umzuformen, wie das entfernte System die Daten benötigt.',
        'Mapping for incoming response data' => 'Mapping für eingehende Antwortdaten',
        'The response data will be processed by this mapping, to transform it to the kind of data the invoker of OFORK expects.' =>
            'Die Antwort-Daten des entfernten Systems werden von diesem Mapping verarbeitet, um sie so umzuformen, wie der Invoker von OFORK sie benötigt.',
        ...
        'Asynchronous event triggers are handled by the OFORK Scheduler Daemon in background (recommended).' =>
            'Asynchrone Ereignisauslöser werden vom OFORK Scheduler Daemon im Hintergrund verarbeitet (empfohlen).',
        ...
        'This OFORK operation backend module will be called internally to process the request, generating data for the response.' =>
        ...
        'The request data will be processed by this mapping, to transform it to the kind of data OFORK expects.' =>
            'Die Daten der eingehenden Anfrage werden von diesem Mapping verarbeitet, um sie so umzuformen, wie die OFORK-Operation sie benötigt.',
        ...
        'Here you can specify the maximum size (in bytes) of REST messages that OFORK will process.' =>
            'Bestimmen Sie die maximale Größe (in Bytes) für REST-Nachrichten, die OFORK akzeptieren soll.',
        ...
        'e.g https://o-fork.de:10745/api/v1.0 (without trailing backslash)' =>
            'z. B. https://o-fork.de:10745/api/v1.0 (ohne abschließenden Backslash)',
        'Timeout' => 'Timeout',
        ...
        'e.g. /opt/ofork/var/certificates/SOAP/certificate.pem' => 'z.B. /opt/ofork/var/certificates/SOAP/certificate.pem',
        ...
        'e.g. /opt/ofork/var/certificates/SOAP/key.pem' => 'z.B. /opt/ofork/var/certificates/SOAP/key.pem',
        ...
        'e.g. /opt/ofork/var/certificates/SOAP/CA/ca.pem' => 'z. B. /opt/ofork/var/certificates/SOAP/CA/ca.pem',
        ...
        'e.g. /opt/ofork/var/certificates/SOAP/CA' => 'z. B. /opt/ofork/var/certificates/SOAP/CA',
        ...
        'e.g. https://local.o-fork.de:8000/Webservice/Example' => 'z.B. https://local.o-fork.de:8000/Webservice/Example',
        ...
        'e.g urn:ofork-com:soap:functions or http://o-fork.de/GenericInterface/actions' =>
            'z. B. urn:ofork-com:soap:functions oder http://o-fork.de/GenericInterface/actions',
        ...
        'Here you can specify the maximum size (in bytes) of SOAP messages that OFORK will process.' =>
            'Hier können Sie eine Maximalgröße für SOAP-Nachrichten (in Bytes) angeben, die OFORK verarbeitet.',
        'Encoding' => 'Kodierung',
        ...
        'In provider mode, OFORK offers web services which are used by remote systems.' =>
            'Im Modus "Provider" bietet OFORK Webservices an, die von entfernten Systemen genutzt werden.',
        'In requester mode, OFORK uses web services of remote systems.' =>
            'Im Modus "Requester" nutzt OFORK selbst Webservices von entfernten Systemen.',
        'Network transport' => 'Netzwerk-Transport',
        ...
        'If your account is marked as trusted, the X-OFORK headers already existing at arrival time (for priority etc.) will be kept and used, for example in PostMaster filters.' =>
            'Wird dem Konto vertraut, bleiben die eingehenden X-OFORK-Header (für Priorität usw.) erhalten und werden benutzt, zum Beispiel in PostMaster-Filtern. ',
        ...
        'You can use OFORK-tags like <OFORK_TICKET_DynamicField_...> to insert values from the current ticket.' =>
            'Sie können OFORK-Tags wie <OFORK_TICKET_DynamicField_...> nutzen, um Werte des aktuellen Tickets einzufügen.',
        ...
        'To be able to use PGP in OFORK, you have to enable it first.' => 'Um PGP in OFORK verwenden zu können, müssen Sie es zuerst aktivieren.',
        ...
        'Package installation requires a patch level update of OFORK.' => ' Paketinstallation benötigt ein Patchlevel-Update von OFORK. ',
        'Package update requires a patch level update of OFORK.' => ' Paketupdate benötigt ein Patchlevel-Update von OFORK. ',
        'Please note that your installed OFORK version is %s.' => 'Bitte beachten Sie, dass Ihre installierte OFORK-Version %s ist.',
        'To install this package, you need to update OFORK to version %s or newer.' =>
            'Um dieses Paket zu installieren, müssen Sie zunächst OFORK auf Version %s oder neuer aktualisieren.',
        'This package can only be installed on OFORK version %s or older.' =>
            'Dieses Paket kann nur mit OFORK-Version %s oder älter verwendet werden.',
        'This package can only be installed on OFORK version %s or newer.' =>
            'Dieses Paket kann nur mit OFORK-Version %s oder neuer verwendet werden.',
        'You will receive updates for all other relevant OFORK issues.' =>
            'Sie erhalten Updates für alle anderen relevanten Probleme im Zusammenhang mit OFORK.',
        ...
        'OFORK Verify can not continue!' => 'OFORK Verify kann nicht fortgesetzt werden!',
        ...
        'This package is verified by OFORKverify' => 'Dieses Paket wurde von OFORKVerify geprüft',
        ...
        'To be able to use SMIME in OFORK, you have to enable it first.' =>
            'Um SMIME in OFORK zu verwenden, müssen Sie es zunächst aktivieren.',
        ...
        'Sending support data to OFORK is not possible!' => 'Das Senden von Support-Daten an die OFORK-Gruppe ist nicht möglich!',
        'Enable Cloud Services' => 'Cloud-Services aktivieren',
        'This data is sent to OFORK on a regular basis. To stop sending this data please update your system registration.' =>
            'Diese Daten werden regelmäßig an die OFORK Gruppe gesendet. Falls Sie das Senden der Daten beenden möchten, aktualisieren Sie bitte ihre Systemregistrierung.',
        ...
        'A support bundle (including: a list of installed packages and all locally modified source code files) can be generated by pressing this button:' =>
            'Ein Supportpaket (einschließlich: eine Liste der installierten Pakete und aller lokal geänderten Quellcode-Dateien) kann mit diesem Knopf erstellt werden:',
        ...
        'The support bundle will be sent to OFORK Team via email automatically.' =>
            'Das Supportpaket wird automatisch per E-Mail zum OFORK Team gesendet.',
        'Download File' => 'Datei herunterladen',
        'A file containing the support bundle will be downloaded to the local system. Please save the file and send it to the OFORK Team, using an alternate method.' =>
            'Das Supportpaket wird als Datei ins lokale Dateisystem heruntergeladen. Bitte speichern Sie die Datei und senden Sie diese auf anderen Wegen an das OFORK Team.',
        ...
        'There are currently no settings available. Please make sure to run \'ofork.Console.pl Maint::Config::Rebuild\' before using the software.' =>
            'Aktuell sind keine Einstellungen verfügbar. Bitte  führen Sie \'ofork.Console.pl Maint::Config::Rebuild\' aus, bevor Sie die Software nutzen.',
        ...
        'The OFORK Daemon is a daemon process that performs asynchronous tasks, e.g. ticket escalation triggering, email sending, etc.' =>
            'Der OFORK Daemon ist ein Daemon-Prozess, welcher asynchrone Aufgaben übernimmt, z.B. das Auslösen von Ticket-Eskalationen oder das Versenden von E-Mails.',
        'A running OFORK Daemon is mandatory for correct system operation.' =>
            'Ein laufender OFORK Daemon ist für die korrekte Funktion des Systems erforderlich.',
        'Starting the OFORK Daemon' => 'Den OFORK Daemon starten',
        'Make sure that the file \'%s\' exists (without .dist extension). This cron job will check every 5 minutes if the OFORK Daemon is running and start it if needed.' =>
            'Stellen Sie sicher, dass die Datei \'%s\' existiert (ohne die Endung .dist). Dieser Cronjob wird alle 5 Minuten prüfen, ob der OFORK Daemon läuft, und ihn ggf. starten.',
        'Execute \'%s start\' to make sure the cron jobs of the \'ofork\' user are active.' =>
            'Führen Sie \'%s start\' aus um sicherzustellen, dass die Cronjobs des \'ofork\'-Nutzers aktiv sind.',
        'After 5 minutes, check that the OFORK Daemon is running in the system (\'bin/ofork.Daemon.pl status\').' =>
            'Prüfen Sie nach 5 Minuten, ob der OFORK Daemon läuft  (\'bin/ofork.Daemon.pl status\').',
        ...
        'Ticket owner' => 'Tickets in meinem Besitz',
        ...
        'Did you know? You can help translating OFORK at %s.' => 'Haben Sie gewusst, dass Sie bei der Übersetzung von OFORK unter %s helfen können?',
        ...
        'Read more about statistics in OFORK' => 'Erfahren Sie mehr über Statistiken in OFORK',
        ...
        'Welcome!' => 'Willkommen!',
        'Please click the button below to create your first ticket.' => 'Bitte verwenden Sie den untenstehenden Button zur Erstellung Ihres ersten Tickets.',
        ...
        # Template: Error
        'Really a bug? 5 out of 10 bug reports result from a wrong or incomplete installation of OFORK.' =>
            'Wirklich ein Bug? 5 von 10 Bugmeldungen resultieren aus einer falschen oder unvollständigen Installation von OFORK.',
        ...
        'Create a new database for OFORK' => 'Neue Datenbank für OFORK erstellen',
        'Use an existing database for OFORK' => 'Bestehende Datenbank für OFORK nutzen',
        ...
        'New' => 'Neu',
        'A new database user with limited permissions will be created for this OFORK system.' =>
            'Ein neuer Datenbank-Benutzer mit beschränkten Rechten wird für dieses OFORK-System erstellt.',
        ...
        'To be able to use OFORK you have to enter the following line in your command line (Terminal/Shell) as root.' =>
            'Um OFORK nutzen zu können, müssen die die folgenden Zeilen als root in die Befehlszeile (Terminal/Shell) eingeben.',
        'Restart your webserver' => 'Starten Sie ihren Webserver neu.',
        'After doing so your OFORK is up and running.' => 'Danach ist OFORK startklar.',
        'Start page' => 'Startseite',
        'Your OFORK Team' => 'Ihr OFORK-Team',
        ...
        'Sorry, but this feature of OFORK is currently not available for mobile devices. If you\'d like to use it, you can either switch to desktop mode or use your regular desktop device.' =>
            'Entschuldigung, aber dieses Feature von OFORK ist derzeit nicht für Mobilgeräte verfügbar. Bitte wechseln sie in die Desktopansicht oder nutzen sie ein normales Desktopgerät, wenn Sie diese Funktion verwenden möchten.',
        ...
        'Welcome' => 'Willkommen',
        'This is the default public interface of OFORK! There was no action parameter given.' =>
            'Dies ist die öffentliche Standard-Benutzerschnittstelle von OFORK. Es wurde kein Action-Parameter übergeben.',
        'You could install a custom public module (via the package manager), for example the FAQ module, which has a public interface.' =>
            'Sie könnten (mithilfe des Paketmanagers) ein eigenes Modul für den öffentlichen Bereich von OFORK installieren, beispielsweise das FAQ-Modul.',
        ...
        # Template: Test
        'OFORK Test Page' => 'OFORK Testseite',
        'Unlock' => 'Freigeben',
        ...
        'ACLs could not be Imported due to a unknown error, please check OFORK logs for more information' =>
            'ACLs konnten aufgrund eines unbekannten Fehlers nicht importiert werden, bitte prüfen Sie das OFORK-Log für mehr Information.',
        ...
        'There where errors adding/updating the following ACLs: %s. Please check the log file for more information.' =>
            'Beim Hinzufügen/Aktualisieren der folgenden ACLs sind Fehler aufgetreten: %s. Bitte prüfen Sie das OFORK-Log für mehr Informationen.',
        'This field is required' => 'Dieses Feld wird benötigt',
        ...
        'Notifications could not be Imported due to a unknown error, please check OFORK logs for more information' =>
            'Benachrichtigungen konnten aufgrund eines unbekannten Fehlers nicht importiert werden. Bitte prüfen Sie das OFORK-Log für mehr Informationen.',
        ...
        'There where errors adding/updating the following Notifications: %s. Please check the log file for more information.' =>
            'Beim Hinzufügen/Aktualisieren der folgenden Benachrichtigungen sind Fehler aufgetreten: %s. Bitte prüfen Sie das OFORK-Log für mehr Informationen.',
        ...
        'The imported file has not valid YAML content! Please check OFORK log for details' =>
            'Die importierte Datei enthält ungültigen YAML-Inhalt. Bitte prüfen Sie das OFORK-Log für mehr Informationen.',
        'Web service "%s" deleted!' => 'Web Service "%s" gelöscht!',
        'OFORK as provider' => 'OFORK als Provider',
        'Operations' => 'Operationen',
        'OFORK as requester' => 'OFORK als Requester',
        'Invokers' => 'Invoker',
        ...
        'Sorry, Apache::Reload is needed as PerlModule and PerlInitHandler in Apache config file. See also scripts/apache2-httpd.include.conf. Alternatively, you can use the command line tool bin/ofork.Console.pl to install packages!' =>
            'Entschuldigung, Apache::Reload wird als Perl-Modul und PerlInitHandler in der Apache-Konfiguration benötigt (siehe auch scripts/apache2-httpd.include.conf). Alternativ können Sie Pakete auch mithilfe des Kommandozeilen-Tools bin/ofork.Console.pl installieren.',
        ...
        'Package not verified by the OFORK! It is recommended not to use this package.' =>
            'Paket wurde nicht von der OFORK verifiziert! Es wird empfohlen, dieses Paket nicht zu nutzen.',
        ...
        'Can\'t connect to OFORK Feature Add-on list server!' => 'Kann nicht zum OFORK Feature-Addon-Listenserver verbinden!',
        'Can\'t get OFORK Feature Add-on list from server!' => 'Kann OFORK Feature-Add-on-Listen nicht vom Server laden!',
        'Can\'t get OFORK Feature Add-on from server!' => 'Kann OFORK Feature-Add-on nicht vom Server laden!',
        ...
        'System Configuration could not be imported due to an unknown error, please check OFORK logs for more information.' =>
            '',
        'Category Search' => 'Kategorie-Suche',

        # Perl Module: Kernel/Modules/AdminSystemConfigurationDeployment.pm
        'Some imported settings are not present in the current state of the configuration or it was not possible to update them. Please check the OFORK log for more information.' =>
            'Einige importierte Einstellungen sind im derzeitigen Stand der Konfiguration entweder nicht vorhanden, oder sie konnten nicht aktualisiert werden. Bitte prüfen Sie das OFORK-Protokoll für weitere Informationen.',
        ...
        'Install OFORK' => 'OFORK installieren',
        'Intro' => 'Einführung',
        ...
        'Install OFORK - Error' => 'OFORK-Installation - Fehler',
        ...
        'Contact us at support@o-fork.de' => 'Kontaktieren Sie uns unter support@o-fork.de',
        'Get Help' => 'Hilfe',
        ...
        'Can\'t connect to OFORK News server!' => 'Kein Verbindungsaufbau zu den OFORK Neuigkeiten möglich!',
        'Can\'t get OFORK News from server!' => 'OFORK Neuigkeiten können nicht vom Server abgerufen werden!',
        ...
        'OFORK Daemon is not running.' => 'Der OFORK Daemon läuft nicht.',
        ...
        '<p>If you continue to install this package, the following issues may occur:</p><ul><li>Security problems</li><li>Stability problems</li><li>Performance problems</li></ul><p>Please note that issues that are caused by working with this package are not covered by OFORK service contracts.</p>' =>
            '<p>Falls Sie dieses Paket installieren, können folgende Probleme auftreten:</p><ul><li>Sicherheitsprobleme</li><li>Stabilitätsprobleme</li><li>Leistungsprobleme</li></ul><p>Bitte beachten Sie, dass von diesem Paket verursachte Probleme nicht durch OFORK-Serviceverträge abgedeckt sind.</p>',
        ...
        'Tables with invalid default values were found. In order to fix it automatically, please run: bin/ofork.Console.pl Maint::Database::Check --repair' =>
            'Tabellen mit ungültigen Standardwerten wurden gefunden. Um diese automatisch zu reparieren, bitte folgendes Kommando ausführen: bin/ofork.Console.pl Maint::Database::Check --repair',
        ...
        # Perl Module: Kernel/System/SupportDataCollector/Plugin/OS/DiskPartitionOFORK.pm
        'OFORK Disk Partition' => 'OFORK-Festplattenpartition',

        # Perl Module: Kernel/System/SupportDataCollector/Plugin/OS/DiskSpace.pm
        'Disk Usage' => 'Festplatten-Verwendung',
        'The partition where OFORK is located is almost full.' => 'Die Partition, auf der OFORK sich befindet, ist fast voll.',
        'The partition where OFORK is located has no disk space problems.' =>
            'Die Partition, auf der OFORK sich befindet, hat keine Platzprobleme.',
        ...
        # Perl Module: Kernel/System/SupportDataCollector/Plugin/ofork/ArticleSearchIndexStatus.pm
        'OFORK' => 'OFORK',
        'Article Search Index Status' => 'Ticket-Suchindex-Status',
        'Indexed Articles' => 'Indexierte Artikel',

        # Perl Module: Kernel/System/SupportDataCollector/Plugin/ofork/ArticlesPerCommunicationChannel.pm
        'Articles Per Communication Channel' => 'Artikel pro Kommunikationskanal',

        # Perl Module: Kernel/System/SupportDataCollector/Plugin/ofork/CommunicationLog.pm
        ...
        # Perl Module: Kernel/System/SupportDataCollector/Plugin/ofork/CommunicationLogAccountStatus.pm
        ...
        # Perl Module: Kernel/System/SupportDataCollector/Plugin/ofork/ConfigSettings.pm
        'Config Settings' => 'Konfigurationseinstellungen',
        'Could not determine value.' => 'Konnte Wert nicht ermitteln.',

        # Perl Module: Kernel/System/SupportDataCollector/Plugin/ofork/DaemonRunning.pm
        'Daemon' => 'Daemon',
        'Daemon is running.' => 'Daemon läuft.',
        'Daemon is not running.' => 'Daemon läuft nicht.',

        # Perl Module: Kernel/System/SupportDataCollector/Plugin/ofork/DatabaseRecords.pm
        ...
        # Perl Module: Kernel/System/SupportDataCollector/Plugin/ofork/DefaultSOAPUser.pm
        ...
        # Perl Module: Kernel/System/SupportDataCollector/Plugin/ofork/DefaultUser.pm
        ...
        # Perl Module: Kernel/System/SupportDataCollector/Plugin/ofork/FileSystemWritable.pm
        'File System Writable' => 'Schreibbarkeit Dateisystem',
        'The file system on your OFORK partition is not writable.' => 'Das Dateisystem auf Ihrer OFORK-Partition ist nicht schreibbar.',

        # Perl Module: Kernel/System/SupportDataCollector/Plugin/ofork/LegacyConfigBackups.pm
        ...
        # Perl Module: Kernel/System/SupportDataCollector/Plugin/ofork/PackageDeployment.pm
        ...
        'Some packages are not verified by the OFORK! It is recommended not to use this packages.' =>
            'Einige Pakete wurden nicht von der OFORK Gruppe verifiziert! Es wird empfohlen, diese Pakete nicht zu nutzen.',
        ...
        # Perl Module: Kernel/System/SupportDataCollector/Plugin/ofork/PackageList.pm
        'Package List' => 'Paketliste',

        # Perl Module: Kernel/System/SupportDataCollector/Plugin/ofork/SessionConfigSettings.pm
        'Session Config Settings' => 'Sitzungskonfigurationseinstellungen',

        # Perl Module: Kernel/System/SupportDataCollector/Plugin/ofork/SpoolMails.pm
        'Spooled Emails' => 'Zum Senden anstehende E-Mails',
        'There are emails in var/spool that OFORK could not process.' => 'In var/spool befinden sich Emails, die OFORK nicht verarbeiten konnte.',

        # Perl Module: Kernel/System/SupportDataCollector/Plugin/ofork/SystemID.pm
        'Your SystemID setting is invalid, it should only contain digits.' =>
            'Ihre Einstellung SystemID ist ungültig, sie sollte nur Ziffern enthalten.',

        # Perl Module: Kernel/System/SupportDataCollector/Plugin/ofork/Ticket/DefaultType.pm
        ...
        # Perl Module: Kernel/System/SupportDataCollector/Plugin/ofork/Ticket/IndexModule.pm
        ...
        # Perl Module: Kernel/System/SupportDataCollector/Plugin/ofork/Ticket/InvalidUsersWithLockedTickets.pm
        ...
        # Perl Module: Kernel/System/SupportDataCollector/Plugin/ofork/Ticket/OpenTickets.pm
        'You should not have more than 8,000 open tickets in your system.' =>
            'Sie sollten nicht mehr als 8.000 offene Tickets im System haben.',

        # Perl Module: Kernel/System/SupportDataCollector/Plugin/ofork/Ticket/SearchIndexModule.pm
        ...
        # Perl Module: Kernel/System/SupportDataCollector/Plugin/ofork/Ticket/StaticDBOrphanedRecords.pm
        'Orphaned Records In ticket_lock_index Table' => 'Verwaiste Einträge in der Tabelle ticket_lock_index',
        'Table ticket_lock_index contains orphaned records. Please run bin/ofork.Console.pl "Maint::Ticket::QueueIndexCleanup" to clean the StaticDB index.' =>
            'Die Tabelle ticket_lock_index enthält verwaiste Einträge. Bitte führen Sie bin/ofork.Console.pl "Maint::Ticket::QueueIndexCleanup" aus, um den StaticDB-Index zu bereinigen.',
        'Orphaned Records In ticket_index Table' => 'Verwaiste Einträge in der Tabelle ticket_index.',
        'Table ticket_index contains orphaned records. Please run bin/ofork.Console.pl "Maint::Ticket::QueueIndexCleanup" to clean the StaticDB index.' =>
        ...
        # Perl Module: Kernel/System/SupportDataCollector/Plugin/ofork/TimeSettings.pm
        'Time Settings' => 'Zeiteinstellungen',
        'Server time zone' => 'Serverzeitzone',
        'OFORK time zone' => 'OFORK-Zeitzone',
        'OFORK time zone is not set.' => 'OFORK-Zeitzone ist nicht gesetzt.',
        ...
        'OFORK time zone setting for calendar' => 'OFORK-Zeitzoneneinstellung für Kalender',
        'Calendar time zone is not set.' => 'Kalender-Zeitzone ist nicht gesetzt.',

        # Perl Module: Kernel/System/SupportDataCollector/Plugin/ofork/UI/AgentSkinUsage.pm
        'UI - Agent Skin Usage' => 'UI - Nutzung Agenten-Skins',

        # Perl Module: Kernel/System/SupportDataCollector/Plugin/ofork/UI/AgentThemeUsage.pm
        'UI - Agent Theme Usage' => 'UI - Nutzung Agenten-Themes',

        # Perl Module: Kernel/System/SupportDataCollector/Plugin/ofork/UI/SpecialStats.pm
        ...
        'OFORK requires apache to be run with the \'prefork\' MPM model.' =>
            'OFORK benötigt das Apache \'prefork\' MPM Modul',
        ...
        # Perl Module: Kernel/System/SupportDataCollector/PluginAsynchronous/ofork/ConcurrentUsers.pm
        ...
        'System was not able to calculate user Date in OFORKTimeZone!' => 'Das Datum des Benutzers konnte in der OFORK-Zeitzone nicht berechnet werden!',

        # Perl Module: Kernel/System/SysConfig/ValueType/DateTime.pm
        'System was not able to calculate user DateTime in OFORKTimeZone!' =>
            'Das Datum und die Uhrzeit des Benutzers konnte in der OFORK-Zeitzone nicht berechnet werden!',
        ...
        # Database XML Definition: scripts/database/ofork-initial_insert.xml
        ...
        'This option is currently disabled because the OFORK Daemon is not running.' =>
            'Diese Option ist derzeit deaktiviert weil der OFORK Daemon nicht läuft.',
        ...
        'Information about the OFORK Daemon' => 'Informationen über den OFORK Daemon',
        ...
        # JS File: OFORKLineChart
        'No Data Available.' => 'Keine Daten verfügbar',

        # JS File: OFORKMultiBarChart
        'Grouped' => 'Gruppiert',
        'Stacked' => 'Gestapelt',

        # JS File: OFORKStackedAreaChart
        'Stream' => 'Fließend',
        'Expanded' => 'Ausgedehnt',
...
',
        ...
        'Adds a suffix with the actual year and month to the OFORK log file. A logfile for every month will be created.' =>
            'Fügt einen Suffix mit dem aktuellen Jahr und Monat in die OFORK-Protokolldatei hinzu. Für jeden Monat wird eine eigene Log-Datei erstellt.',
        ...
        'Basic fulltext index settings. Execute "bin/ofork.Console.pl Maint::Ticket::FulltextIndexRebuild" in order to generate a new index.' =>
            'Basis-Einstellungen für den Volltext-Index. Führen Sie "bin/ofork.Console.pl Maint::Ticket::FulltextIndexRebuild" aus, um den Index neu zu erstellen.',
        ...
        'Configure sending of support data to OFORK for improved support.' =>
            'Konfigurieren Sie das Senden von Support Daten an die OFORK-Group für eine bessere Unterstützung.',
        ...
        'Configures a default TicketDynamicField setting. "Name" defines the dynamic field which should be used, "Value" is the data that will be set, and "Event" defines the trigger event. Please check the developer manual (https://o-fork.de/doc/), chapter "Ticket Event Module".' =>
            'Konfiguriert eine Standardeinstellung für ein dynamisches Ticketfeld. "Name" beschreibt das dynamische Feld, das genutzt werden soll, "Value" die Daten, mit denen das Feld befüllt werden soll. "Event" enthält das auslösende Ereignis. Weitere Informationen finden Sie im Entwicklerhandbuch (https://o-fork.de/doc/) im Kapitel "Ticket-Eventmodule".',
        ...
        'Default queue ID used by the system in the agent interface.' => 'Standard-Queue-ID welche von OFORK in der Agentenoberfläche verwendet wird.',
        ...
        'Default ticket ID used by the system in the agent interface.' =>
            'Standard-Ticket-ID welche von OFORK in der Agentenoberfläche verwendet wird.',
        'Default ticket ID used by the system in the customer interface.' =>
            'Standard-Ticket-ID welche von OFORK in der Kundenoberfläche verwendet wird.',
        ...
        'Define a filter for html output to add links behind a defined string. The element Image allows two input kinds. At once the name of an image (e.g. faq.png). In this case the OFORK image path will be used. The second possiblity is to insert the link to the image.' =>
            'Definiert einen Filter für die HTML-Ausgabe um Links hinter einer bestimmten Zeichenfolge hinzufügen. Dieses Element erlaubt zwei Eingabearten. Zum einem den Namen eines Bildes (Beispielsweise faq.png). In diesem Fall wird der OFORK-Bildpfad verwendet. Die zweite Möglichkeit ist, den Link zu dem Bild einzufügen.',
        ...
        'Defines a filter for html output to add links behind CVE numbers. The element Image allows two input kinds. At once the name of an image (e.g. faq.png). In this case the OFORK image path will be used. The second possiblity is to insert the link to the image.' =>
            'Definiert einen Filter für die HTML-Ausgabe um Links hinter CVE-Nummern hinzufügen. Das Element Bild erlaubt zwei Eingabearten. Zum einem den Namen eines Bildes (Beispielsweise faq.png). In diesem Fall wird der OFORK-Bildpfad verwendet. Die zweite Möglichkeit ist, den Link zu dem Bild einzufügen.',
        'Defines a filter for html output to add links behind MSBulletin numbers. The element Image allows two input kinds. At once the name of an image (e.g. faq.png). In this case the OFORK image path will be used. The second possiblity is to insert the link to the image.' =>
        ...
        'Defines a filter for html output to add links behind a defined string. The element Image allows two input kinds. At once the name of an image (e.g. faq.png). In this case the OFORK image path will be used. The second possiblity is to insert the link to the image.' =>
        ...
        'Defines a filter for html output to add links behind bugtraq numbers. The element Image allows two input kinds. At once the name of an image (e.g. faq.png). In this case the OFORK image path will be used. The second possiblity is to insert the link to the image.' =>
            'Definiert einen Filter für die HTML-Ausgabe um Links hinter Bugtraq-Nummern hinzufügen. Das Element Bild erlaubt zwei Eingabearten. Zum einem den Namen eines Bildes (Beispielsweise faq.png). In diesem Fall wird der OFORK-Bildpfad verwendet. Die zweite Möglichkeit ist, den Link zu dem Bild einzufügen.',
        ...
        'Defines the HTTP hostname for the support data collection with the public module \'PublicSupportDataCollector\' (e.g. used from the OFORK Daemon).' =>
            'Legt den HTTP-Hostnamen fest, der für die Sammlung von Supportdaten über das freie Modul \'PublicSupportDataCollector\' genutzt wird (z. B. durch den OFORK-Daemon).',
        ...
        'Defines the default front-end (HTML) theme to be used by the agents and customers. If you like, you can add your own theme. Please refer the administrator manual located at https://o-fork.de/doc/.' =>
            'Steuert das standardmäßig verwendete Theme (HTML) für das Frontend für Agenten und Kunden. Hinweis: Sie können Ihre eigenen Themes hinzufügen und verwenden (siehe https://o-fork.de/doc/).',
        ...
        'Defines the fully qualified domain name of the system. This setting is used as a variable, OFORK_CONFIG_FQDN which is found in all forms of messaging used by the application, to build links to the tickets within your system.' =>
            'Definiert den Full Qualified Domain Name des OFORK Systems. Diese Einstellung wird als Variable OFORK_CONFIG_FQDN genutzt, welche in allen Nachrichten-Formularen zu finden ist oder um Links zu Tickets in Ihrem OFORK System zu generieren.',
        ...
        'Defines the list of online repositories. Another installations can be used as repository, for example: Key="http://example.com/ofork/public.pl?Action=PublicRepository;File=" and Content="Some Name".' =>
            'Definiert eine Liste von Online-Quellen. Andere Installationen können als Quelle genutzt werden z.B. Key="http://example.com/ofork/public.pl?Action=PublicRepository;File=" and Content="Irgendein Name". ',
        ...
        'Defines the maximal size (in bytes) for file uploads via the browser. Warning: Setting this option to a value which is too low could cause many masks in your OFORK instance to stop working (probably any mask which takes input from the user).' =>
            'Definiert die maximale Größe (in Bytes) für das Hochladen von Dateien mit dem Browser. Achtung: Wenn man die Größe zu klein wählt können viele Eingabemasken in ihrer OFORK-Instanz nicht mehr funktionieren (vermutlich jede Maske die Benutzereingaben erwartet).',
        ...
        'Defines the module to display a notification in the agent interface if the OFORK Daemon is not running.' =>
            'Definiert das Modul, dass eine Benachrichtigung im Agentenbereich anzeigt, wenn der OFORK Daemon nicht läuft.',
        ...
        'Defines the name of the session key. E.g. Session, SessionID or OFORK.' =>
            'Definiert den Namen des Session-Schlüssels. Zum Beispiel: Session, SessionID oder OFORK',
        ...
        'Defines the system identifier. Every ticket number and http session string contains this ID. This ensures that only tickets which belong to your system will be processed as follow-ups (useful when communicating between two instances of OFORK).' =>
            'Definiert die System ID. Jede Ticketnummer und HTTP Sitzung enthält diese ID. Das stellt sicher, dass nur Tickets in das Ticketsystem aufgenommen werden, welche zum eigenen Ticketsystem gehören (nützlich, wenn zwischen zwei Instanzen von OFORK kommuniziert wird).',
        ...
        'Defines the timeout (in seconds, minimum is 20 seconds) for the support data collection with the public module \'PublicSupportDataCollector\' (e.g. used from the OFORK Daemon).' =>
            'Legt den Timeout in Sekunden für die Sammlung von Supportdaten des öffentlichen Moduls \'PublicSupportDataCollector\' fest, das z. B. vom OFORK Daemon genutzt wird (min. 20 Sekunden).',
        ...
        'Defines the type of protocol, used by the web server, to serve the application. If https protocol will be used instead of plain http, it must be specified here. Since this has no affect on the web server\'s settings or behavior, it will not change the method of access to the application and, if it is wrong, it will not prevent you from logging into the application. This setting is only used as a variable, OFORK_CONFIG_HttpType which is found in all forms of messaging used by the application, to build links to the tickets within your system.' =>
            'Legt das Protokoll fest, das zur Auslieferung der Applikation durch den Webserver genutzt werden soll. Wenn https anstelle von http genutzt werden soll, muss dies hier festgelegt werden. Die Einstellung hat keine Auswirkungen auf die Konfiguration des Webservers und verändert nicht, wie auf die Applikation zugegriffen wird. Bei fehlerhafter Konfiguration verhindert die Einstellung nicht die Anmeldung am System. Diese Einstellung wird nur als Variable verwendet (OFORK_CONFIG_HttpType), die in allen Nachrichten-Formularen zur Verfügung steht, um Links auf Tickets in Ihr System zu generieren.',
        ...
        'Defines the valid states for unlocked tickets. To unlock tickets the script "bin/ofork.Console.pl Maint::Ticket::UnlockTimeout" can be used.' =>
            'Bestimmt gültige Status für entsperrte Tickets. Um Tickets zu entsperren, kann das Script "bin/ofork.Console.pl Maint::Ticket::UnlockTimeout" genutzt werden.',
        ...
        'Disable HTTP header "X-Frame-Options: SAMEORIGIN" to allow OFORK to be included as an IFrame in other websites. Disabling this HTTP header can be a security issue! Only disable it, if you know what you are doing!' =>
            'Wenn der HTTP-Header "X-Frame-Options: SAMEORIGIN" ausgeschaltet ist, kann OFORK als IFrame in andere Websites integriert werden. Dies stellt eine Sicherheitslücke dar! Daher sollte diese Einstellung nur deaktivieren werden, wenn Sie sich über die Konsequenzen im Klaren sind.',
        ...
        'Disables the web installer (http://yourhost.example.com/ofork/installer.pl), to prevent the system from being hijacked. If not enabled, the system can be reinstalled and the current basic configuration will be used to pre-populate the questions within the installer script. If enabled, it also disables the GenericAgent, PackageManager and SQL Box.' =>
            '',
        ...
        'Enables PGP support. When PGP support is enabled for signing and encrypting mail, it is HIGHLY recommended that the web server runs as the OFORK user. Otherwise, there will be problems with the privileges when accessing .gnupg folder.' =>
            'Aktiviert PGP-Support. Wenn PGP-Support für das signieren und verschlüsseln von Mails eingeschaltet ist, wird dringend empfohlen, den Webserver unter dem OFORK-Benutzer zu betreiben. Andernfalls werden Probleme mit den Berechtigungen auftreten, wenn auf das .gnupg-Verzeichnis zugegriffen wird.',
        ...
        'Executes follow-up checks on OFORK Header \'X-OFORK-Bounce\'.' => 'Führt Follow-Up-Checks auf dem OFORK-Header \'X-OFORK-Bounce\' aus.',
        ...
        'Filter for debugging ACLs. Note: More ticket attributes can be added in the format <OFORK_TICKET_Attribute> e.g. <OFORK_TICKET_Priority>.' =>
            'Filter zum Debuggen von ACLs. Hinweis: Weitere Ticket-Attribute können im Format <OFORK_TICKET_Attribute> (z. B. <OFORK_TICKET_Priority>) hinzugefügt werden.',
        'Filter for debugging Transitions. Note: More filters can be added in the format <OFORK_TICKET_Attribute> e.g. <OFORK_TICKET_Priority>.' =>
            'Filter zum Debuggen von Transitions. Hinweis: Weitere Filter können im Format <OFORK_TICKET_Attribute> (z. B. <OFORK_TICKET_Priority>) hinzugefügt werden.',
        ...
        'If "LDAP" was selected for Customer::Authmodule, you can check if the user is allowed to authenticate because he is in a posixGroup, e.g. user needs to be in a group xyz to use OFORK. Specify the group, who may access the system.' =>
            'Wenn "LDAP" als Customer::AuthModule ausgewählt ist, können Sie prüfen, ob der Benutzer aufgrund seiner Mitgliedschaft in einer posixGroup Authentifizierungsberechtigt (z.B. wenn ein Nutzer Mitglied der Gruppe xyz sein muss, um OFORK nutzen zu dürfen). Legen Sie diese Gruppe hier fest.',
        ...
        'If enabled the daemon will use this directory to create its PID files. Note: Please stop the daemon before any change and use this setting only if <$OFORKHome>/var/run/ can not be used.' =>
            'Wenn aktiviert, verwendet der Daemon dieses Verzeichnis, um seine PID-Dateien zu erzeugen. Hinweis: Bitte stoppen Sie den Daemon vor der Änderung und nutzen Sie diese Einstellung nur, wenn <$OFORKHome>/var/run/ nicht benutzt werden kann.',
        'If enabled, OFORK will deliver all CSS files in minified form.' =>
            'Wenn aktiviert, liefert OFORK CSS-Dateien in minifizierter Form aus.',
        'If enabled, OFORK will deliver all JavaScript files in minified form.' =>
            'Wenn aktiviert, liefert OFORK JavaScript-Dateien in minifizierter Form aus.',
        'If enabled, TicketPhone and TicketEmail will be open in new windows.' =>
            'Wenn aktiviert, werden TicketPhone und TicketEmail in neuen Fenstern geöffnet.',
        'If enabled, the OFORK version tag will be removed from the Webinterface, the HTTP headers and the X-Headers of outgoing mails. NOTE: If you change this option, please make sure to delete the cache.' =>
            'Wenn aktiviert, werden OFORK-Versionsinformationen aus der Oberfläche und HTTP-Headern und X-Headern entfernt. Hinweis: Nach Änderung dieser Option muss der Cache gelöscht werden.',
        ...
        'If enabled, users that haven\'t selected a time zone yet will be notified to do so. Note: Notification will not be shown if (1) user has not yet selected a time zone and (2) OFORKTimeZone and UserDefaultTimeZone do match and (3) are not set to UTC.' =>
            'Wenn aktiviert, werden Benutzer, die bislang noch keine Zeitzone ausgewählt haben, benachrichtigt dies zu tun. Hinweis: Die Benachrichtigung wird nicht angezeigt, wenn (1) der Benutzer noch keine Zeitzone ausgewählt hat und (2) OFORKTimeZone und UserDefaultTimeZone identisch sind und (3) nicht auf UTC gesetzt sind.',
        ...
        'Malay' => 'Malaysisch',
        'Manage OFORK cloud services.' => 'Verwaltet die Cloud-Services der OFORK Gruppe.',
        ...
        'Merged Ticket <OFORK_TICKET> to <OFORK_MERGE_TO_TICKET>.' => 'Ticket <OFORK_TICKET> wurde mit <OFORK_MERGE_TO_TICKET> zusammengefasst.',
        'Minute' => 'Minute',
        ...
        'Module to filter and manipulate incoming messages. Get a 4 digit number to ticket free text, use regex in Match e. g. From => \'(.+?)@.+?\', and use () as [***] in Set =>.' =>
            'Modul zum Filtern und Verändern eingehender Nachrichten. Extrahieren Sie beispielsweise eine vierstellige Zahl aus dem Betreff (SomeNumber:1234) und speichern Sie sie in einem dynamischen Feld, indem Sie in "Match" einen Schlüssel "Subject" mit dem regulären Ausdruck "SomeNumber:(\d\d\d\d)" und in "Set" einen Schlüssel "X-OFORK-DynamicField-Name" mit dem Wert "[***]" anlegen.',
        ...
        'News about OFORK releases!' => 'Neuigkeiten zu OFORK-Releases!',
        'News about OFORK.' => 'Neuigkeiten über OFORK.',
        ...
        'OFORK Services' => 'Dienstleistungen der OFORK Gruppe',
        'OFORK News' => 'OFORK-Neuigkeiten',
        'OFORK can use one or more readonly mirror databases for expensive operations like fulltext search or statistics generation. Here you can specify the DSN for the first mirror database.' =>
            'OFORK kann eine oder mehrere Spiegeldatenbanken für aufwändige Operationen wie Volltextsuchen oder Statistikgenerierungen nutzen. Hier können Sie die DSN für die erste Spiegeldatenbank hinterlegen.',
        'OFORK doesn\'t support recurring Appointments without end date or number of iterations. During import process, it might happen that ICS file contains such Appointments. Instead, system creates all Appointments in the past, plus Appointments for the next N months (120 months/10 years by default).' =>
            '',
        ...
        'Saves the attachments of articles. "DB" stores all data in the database (not recommended for storing big attachments). "FS" stores the data on the filesystem; this is faster but the webserver should run under the OFORK user. You can switch between the modules even on a system that is already in production without any loss of data. Note: Searching for attachment names is not supported when "FS" is used.' =>
            'Speicherung von Artikel-Anlagen. "DB" legt alle Daten in der Datenbank ab (nicht empfohlen für große Anlagen). "FS" legt alle Daten im Dateisystem ab; dies ist schneller, jedoch sollte der Webserver mit dem OFORK-Benutzer betrieben werden. Sie können im laufenden Betrieb ohne Datenverlust zwischen den Modulen wechseln. Bitte beachten Sie, dass das Suchen nach Anlagen für "FS" nicht unterstützt wird.',
        ...
        'Select your preferred theme for OFORK.' => 'Wählen Sie Ihr bevorzugtes Design für OFORK.',
        ...
        'Sends registration information to OFORK.' => 'Übermitteln der Registrierungsinformationen an OFORK.',
        ...
        'Sets the prefix to the scripts folder on the server, as configured on the web server. This setting is used as a variable, OFORK_CONFIG_ScriptAlias which is found in all forms of messaging used by the application, to build links to the tickets within the system.' =>
            'Legt den Prefix zum Skripte-Verzeichnis auf dem Server fest, analog zur Konfiguration des Webservers. Diese Einstellung wird als Variable OFORK_CONFIG_ScriptAlias in allen Nachrichten-Formularen innerhalb der Applikation genutzt, um Links zu Tickets in Ihrem System zu generieren.',
        ...
        'Sets the ticket type in the ticket responsible screen of the agent interface (Ticket::Type needs to be enabled).' =>
            '',
        'Sets the time zone being used internally by OFORK to e. g. store dates and times in the database. WARNING: This setting must not be changed once set and tickets or any other data containing date/time have been created.' =>
            'Legt die Zeitzone fest, die intern von OFORK genutzt werden soll (z. B. um Datumsangaben und Zeiten in der Datenbank zu speichern). ACHTUNG: Diese Einstellung darf nicht mehr geändert werden, sobald Tickets und/oder andere Objekte erstellt wurden, die Datumsangaben enthalten.',
        'Sets the time zone that will be assigned to newly created users and will be used for users that haven\'t yet set a time zone. This is the time zone being used as default to convert date and time between the OFORK time zone and the user\'s time zone.' =>
            'Legt die Zeitzone fest, die als Voreinstellung für neu angelegte Nutzer gelten soll. Diese Zeitzone wird dazu verwendet, um Datumsangaben und Uhrzeiten zwischen der OFORK-Zeitzone und der Nutzer-Zeitzone korrekt zu konvertieren.',
        ...
        'Shows information on how to start OFORK Daemon' => 'Informationen über das Starten des OFORK Daemons anzeigen',
        ...
        'Specifies the name that should be used by the application when sending notifications. The sender name is used to build the complete display name for the notification master (i.e. "OFORK Notifications" ofork@your.example.com).' =>
            'Legt den Namen fest, der beim Versenden von Benachrichtigungen durch die Applikation verwendet werden soll. Der Absendername wird genutzt, um den vollständigen Anzeigenamen des Benachrichtigungs-Masters zu bilden (z. B. "OFORK Notifications ofork@your.example.com).',
        ...
        'This module is part of the admin area of OFORK.' => 'Dieses Modul ist ein teil des Admin-Bereiches von OFORK.',
        ...
        'This setting is deprecated. Set OFORKTimeZone instead.' => 'Diese Einstellung ist veraltet. Bitte nutzen Sie stattdessen die Einstellung OFORKTimeZone.',
        ...
        'Toggles display of OFORK FeatureAddons list in PackageManager.' =>
            'Schaltet die Anzeige der OFORK FeatureAddon-Liste in der Paket-Verwaltung um.',
        ...
        'Type of daemon log rotation to use: Choose \'OFORK\' to let OFORK system to handle the file rotation, or choose \'External\' to use a 3rd party rotation mechanism (i.e. logrotate). Note: External rotation mechanism requires its own and independent configuration.' =>
            'Art der Logrotation, die vom Daemon genutzt werden soll. Wählen Sie "OFORK", um das System die Rotation verwalten zu lassen oder "extern", um eine Drittapplikation dafür zu nutzen (z. B. logrotate). Hinweis: externe Mechanismen erfordern weiterhin eine eigene Konfiguration.',
        ...
        'Your email with ticket number "<OFORK_TICKET>" is bounced to "<OFORK_BOUNCE_TO>". Contact this address for further information.' =>
            'Ihre E-Mail mit Ticket-Nummer "<OFORK_TICKET>" wurde an "<OFORK_BOUNCE_TO>" umgeleitet. Kontaktieren Sie diese Adresse für weitere Informationen.',
        'Your email with ticket number "<OFORK_TICKET>" is merged to "<OFORK_MERGE_TO_TICKET>".' =>
            'Ihre E-Mail mit Ticket-Nummer "<OFORK_TICKET>" wurde zu Ticket-Nummer "<OFORK_MERGE_TO_TICKET>" zusammengefasst!',
    ...
    $Self->{JavaScriptStrings} = [
        ...
        'If you now leave this page, all open popup windows will be closed, too!',
        'Import web service',
        'Information about the OFORK Daemon',
