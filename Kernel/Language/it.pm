...
# --
# $Id: it.pm,v 1.1.1.1 2018/07/16 14:49:06 ud Exp $
# --
...
sub Data {
    ...
    $Self->{Completeness}        = 0.481054081984154;
    ...
    $Self->{Translation} = {
        ...
        'It is highly recommended to send this data to OFORK in order to get better support.' =>
            'Consigliamo vivamente di inviare questi dati a OFORK per ottenere un supporto migliore.',
        ...
        'This will allow the system to send additional support data information to OFORK.' =>
            'Ciò consentirà al sistema di inviare dati di supporto aggiuntivi a OFORK.',
        'Update' => 'Aggiorna',
        ...
        'System registration is a service of OFORK, which provides a lot of advantages!' =>
            'La registrazione del sistema è un servizio di OFORK, che fornisce molti vantaggi!',
        ...
        'e.g https://o-fork.de:10745/api/v1.0 (without trailing backslash)' =>
            'ad es. https://o-fork.de:10745/api/v1.0 (senza barra finale)',
        'Timeout' => '',
        ...
        'The full path and name of the SSL client certificate key file (if not already included in certificate file).' =>
            '',
        'e.g. /opt/ofork/var/certificates/SOAP/key.pem' => 'ad es. /opt/ofork/var/certificates/SOAP/key.pem',
        ...
        'e.g. /opt/ofork/var/certificates/SOAP/CA/ca.pem' => 'es. /opt/ofork/var/certificates/SOAP/CA/ca.pem',
        ...
        'e.g. /opt/ofork/var/certificates/SOAP/CA' => 'es. /opt/ofork/var/certificates/SOAP/CA',
        ...
        'e.g. https://local.o-fork.de:8000/Webservice/Example' => 'ad es. https://local.o-fork.de:8000/Webservice/Example',
        'Set SOAPAction' => '',
        ...
        'e.g urn:o-fork-de:soap:functions or https://o-fork.de/GenericInterface/actions' =>
            'es. rn:o-fork-de:soap:functions o https://o-fork.de/GenericInterface/actions',
        ...
        'This system is registered with OFORK.' => 'Questo sistema è registrato con OFORK.',
        ...
        'A registered system sends the following data to OFORK:' => 'Un sistema registrato invia i dati seguenti a OFORK:',
        ...
        'This data will be frequently transferred to OFORK when you register this system.' =>
            'Questi dati saranno trasferiti frequentemente a OFORK quando registri questo sistema.',
        'Attribute' => 'Attributo',
        'FQDN' => 'FQDN',
        ...
        'Continuing with this step will deregister the system from OFORK.' =>
            'Se si prosegue con questo passaggio, la registrazione del sistema sarà cancellata da OFORK.',
        ...
        'This data is sent to OFORK on a regular basis. To stop sending this data please update your system registration.' =>
            'Questi dati sono inviati a OFORK con regolarità. Per fermare l\'invio di questi dati, aggiorna la tua registrazione di sistema.',
        ...
        'After 5 minutes, check that the OTRS Daemon is running in the system (\'bin/ofork.Daemon.pl status\').' =>
            'Dopo 5 minuti, controlla che OTRS Daemon sia in esecuzione nel sistema (\'bin/ofork.Daemon.pl status\').',
...
' => '',
        ...
        'Sends registration information to OTRS group.' => 'Invia le informazioni di registrazione a OFORK.',
        ...
        'Shows existing parent/child queue lists in the system in the form of a tree or a list.' =>
            '',
        'Shows information on how to start OFORK Daemon' => 'Mostra informazioni su come avviare OFORK Daemon',
        ...
        'Toggles display of OFORK FeatureAddons list in PackageManager.' =>
            'Abilita o disabilita la visualizzazione di "OFORK FeatureAddons" nella lista della Gestione dei Pacchetti.',
...
- Scegli "OFORK" per lasciare che sia il sistema a gestire questa rotazione;
...
NOTA: i sistemi di terze parti richiedono una configurazione a se.',
        ...
        'Your email with ticket number "<OFORK_TICKET>" is bounced to "<OFORK_BOUNCE_TO>". Contact this address for further information.' =>
            'La tua email con la richiesta numero "<OFORK_TICKET>" è stata reinviata a "<OFORK_BOUNCE_TO>". Contatta questo indirizzo per ulteriori informazioni.',
        'Your email with ticket number "<OFORK_TICKET>" is merged to "<OFORK_MERGE_TO_TICKET>".' =>
            'La tua email con il numero di ticket "<OFORK_TICKET>" è stata unita a "<OFORK_MERGE_TO_TICKET>".',
