...
# --
# $Id: es.pm,v 1.1.1.1 2018/07/16 14:49:06 ud Exp $
# --
...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'e.g https://o-fork.de:10745/api/v1.0 (without trailing backslash)' =>
            'ej. https://o-fork.de:10745/api/v1.0 (sin la barra invertida)',
        ...
        'e.g. /opt/ofork/var/certificates/SOAP/CA/ca.pem' => 'ej.  /opt/ofork/var/certificates/SOAP/CA/ca.pem',
        ...
        'e.g. /opt/ofork/var/certificates/SOAP/CA' => 'ej. /opt/ofork/var/certificates/SOAP/CA',
        ...
        'e.g urn:otrs-com:soap:functions or https://o-fork.de/GenericInterface/actions' =>
            'ej. urn:otrs-com:soap:functions or https://o-fork.de/GenericInterface/actions',
        ...
        'The support bundle will be sent to OFORK Team via email automatically.' =>
            'El paquete de soporte será enviado a OFORK a través de correo electrónico de forma automática.',
...
El control del acceso adicional para demostrar o no demostrar éste enlace puede ser hecha por usar el "Grupo" Clave y el Contenido como "rw:group1;move_into:group2". ',
        ...
        'Configures a default TicketDynamicField setting. "Name" defines the dynamic field which should be used, "Value" is the data that will be set, and "Event" defines the trigger event. Please check the developer manual (https://o-fork.de/doc/), chapter "Ticket Event Module".' =>
            'Configura un ajuste por defecto de CampoDinamicoTicket. "Nombre" define el campo dinámico que debe ser usado, "Valor" es el dato que será establecido, y "Evento" define el disparador del evento. Por favor compruebe el manual del desarrollador (https://o-fork.de/doc/), capítulo "Módulo Evento Ticket".',
        ...
        'Sends registration information to OTRS.' => 'Envía la información de registro a OTRS.',
        ...
        'Specifies the directory where private SSL certificates are stored.' =>
            '',
        'Specifies the email address that should be used by the application when sending notifications. The email address is used to build the complete display name for the notification master (i.e. "OTRS Notifications" ofork@your.example.com). You can use the OTRS_CONFIG_FQDN variable as set in your configuation, or choose another email address.' =>
            '',
        ...
        'Specifies the group where the user needs rw permissions so that they can edit other users preferences.' =>
            '',
        'Specifies the name that should be used by the application when sending notifications. The sender name is used to build the complete display name for the notification master (i.e. "OTRS Notifications" ofork@your.example.com).' =>
            '',
        ...
        'This module and its PreRun() function will be executed, if defined, for every request. This module is useful to check some user options or to display news about new applications.' =>
            '',
        'This module is part of the admin area of OFORK.' => 'Este módulo es parte del área de administración del OFORK.',
        ...
        'Your email with ticket number "<OFORK_TICKET>" is bounced to "<OFORK_BOUNCE_TO>". Contact this address for further information.' =>
            'Su correo con el número de ticket "<OFORK_TICKET>" ha sido rebotado a "<OFORK_BOUNCE_TO>". Póngase en contacto con esa dirección para obtener más información.',
        'Your email with ticket number "<OFORK_TICKET>" is merged to "<OFORK_MERGE_TO_TICKET>".' =>
            'Su correo con el número de ticket "<OFORK_TICKET>" se fusionó con "<OFORK_MERGE_TO_TICKET>".',
