...
# --
# $Id: fr.pm,v 1.1.1.1 2018/07/16 14:49:06 ud Exp $
# --
...
sub Data {
    ...
    $Self->{Completeness}        = 0.385980020668274;
    ...
    $Self->{Translation} = {
        ...
        'It is highly recommended to send this data to OFORK in order to get better support.' =>
            'Il est hautement recommandé d\'envoyer ces données à OFORK pour obtenir un meilleur support.',
        ...
        'This will allow the system to send additional support data information to OFORK.' =>
            'Cela va autoriser le système à envoyer les données additionnels de support à OFORK.',
        ...
        'To enable data sending, please register your system with OFORK or update your system registration information (make sure to activate the \'send support data\' option.)' =>
            'Pour activer l\'envoi de données, merci d\'enregistrer votre système avec OFORK ou mettez à jour vos informations d\'enregistrement (vérifiez que l\'option \'envoyer les données de support\' est activée).',
        ...
        'System registration is a service of OFORK, which provides a lot of advantages!' =>
            'L\'enregistrement système est un service d\'OFORK, qui fourni un maximum d\'avantages.',
        ...
        'Manage Customer User-Services Relations' => 'Gestion des relations entre utilisateurs client et services',
...
' => '',
        ...
        'OFORK Services' => 'Services du groupe OFORK',
        'OFORK News' => 'Nouvelles d\'OFORK',
        ...
        'Replaces the original sender with current customer\'s email address on compose answer in the ticket compose screen of the agent interface.' =>
            '',
        'Reports' => 'Rapports',
        'Reports (OFORK Business Solution™)' => 'Rapports (OFORK Business Solution™)',
        ...
        'Resets and unlocks the owner of a ticket if it was moved to another queue.' =>
            '',
        'Resource Overview (OFORK Business Solution™)' => 'Vue d\'ensemble des ressources (OFORK Business Solution™)',
        'Responsible Tickets' => '',
        'Responsible Tickets.' => '',
        ...
        'Select your personal time zone. All times will be displayed relative to this time zone.' =>
            'Sélectionnez votre fuseau horaire personnel. L\'horaire du système OFORK sera relatif à cette heure.',
        'Select your preferred layout for the software.' => 'Sélectionnez votre skin préféré pour le système.',
        'Select your preferred theme for OFORK.' => 'Sélectionnez votre thème préféré pour OFORK.',
        ...
        'Toggles display of OFORK FeatureAddons list in PackageManager.' =>
            'Déclenche l\'affichage de la liste des modules complémentaires d\'OFORK dans le gestionnaire de paquets.',
        ...
        'Your email with ticket number "<OFORK_TICKET>" is merged to "<OFORK_MERGE_TO_TICKET>".' =>
            'Votre e-mail avec le numéro de ticket "<OFORK_TICKET>" a été fusionné avec le ticket numéro "<OFORK_MERGE_TO_TICKET>".',
