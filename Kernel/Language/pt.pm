...
sub Data {
    ...
    $Self->{Completeness}        = 0.32490604714725;
    ...
    $Self->{Translation} = {
        ...
        'The full path and name of the certification authority certificate file that validates SSL certificate.' =>
            '',
        'e.g. /opt/ofork/var/certificates/SOAP/CA/ca.pem' => '',
        'Certification Authority (CA) Directory' => '',
        'The full path of the certification authority directory where the CA certificates are stored in the file system.' =>
            '',
        'e.g. /opt/ofork/var/certificates/SOAP/CA' => '',
        ...
        'e.g. https://local.ofork.com:8000/Webservice/Example' => '',
        'Set SOAPAction' => '',
        ...
        'e.g urn:ofork-com:soap:functions' =>
            '',
        'Request name scheme' => '',
        ...
        'You need to log in with your OFORK-ID to register your system.' =>
            '',
        'Your OFORK-ID is the email address you used to sign up on the OFORK.de webpage.' =>
            '',
        'Data Protection' => '',
        ...
        'The email address for this user is invalid, this option has been disabled.' =>
            '',
        'Sending' => 'Remetente',
        'The support bundle will be sent to OFORK via email automatically.' =>
            '',
        'Download File' => '',
        ...
        'A new database user with limited permissions will be created for this OFORK system.' =>
            'Vai ser criado um novo utilizador de base de dados com permissões limitadas para o OFORK',
        'Repeat Password' => '',
        'Generated password' => '',
        ...
        'To be able to use OFORK you have to enter the following line in your command line (Terminal/Shell) as root.' =>
            'Para usar o OFORK tem de executar o seguinte comando na consola, (Terminal/Shell) como root.',
        'Restart your webserver' => 'Reinicie o servidor Web',
        'After doing so your OFORK is up and running.' => 'Depois de o fazer, o OFORK estará funcional.',
        'Start page' => 'Página inicial',
        'Your OFORK Team' => 'A equipa OFORK',
        ...
        # Template: Test
        'OFORK Test Page' => 'Página de Teste do OFORK',
        'Unlock' => 'Desbloquear',
        'Welcome %s %s' => '',
        'Counter' => 'Contador',
        ...
        'OFORK as provider' => 'OFORK como prestador',
        'Operations' => 'Operações',
        'OFORK as requester' => 'OFORK como requisitante.',
        'Invokers' => '',
        ...
        'Package not verified by the OFORK! It is recommended not to use this package.' =>
            'O Pacote não foi verificado pelo OFORK! Não é recomendado utilizar o Pacote.',
        'Not Started' => '',
        'Updated' => '',
        'Already up-to-date' => '',
        'Installed' => '',
        ...
        'Can\'t connect to OFORK News server!' => 'Sem ligação ao servidor de Notícias!',
        'Can\'t get OFORK News from server!' => 'Impossível obter Notícias do servidor!',
        ...
        'Enable cloud services to unleash all OFORK features!' => 'Active os serviços cloud para desbloquear todas as funcionalidades OFORK!',
        ...
        'OFORK Daemon is not running.' => 'O Daemon OFORK não está em execução.',
        ...
        'The installation of packages which are not verified by the OFORK is activated. These packages could threaten your whole system! It is recommended not to use unverified packages.' =>
            '',
        ...
        '<p>If you continue to install this package, the following issues may occur:</p><ul><li>Security problems</li><li>Stability problems</li><li>Performance problems</li></ul><p>Please note that issues that are caused by working with this package are not covered by OFORK service contracts.</p>' =>
            '',
        '<p>The installation of packages which are not verified by the OFORK is not possible by default. You can activate the installation of not verified packages via the "AllowNotVerifiedPackages" system configuration setting.</p>' =>
            '',
...
' => '',
        ...
        'Adds a suffix with the actual year and month to the OFORK log file. A logfile for every month will be created.' =>
            'Adiciona um sufixo com o ano e mês atual ao ficheiro de log do OFORK. Vai ser criado um ficheiro mensal.',
        ...
        'Basic fulltext index settings. Execute "bin/ofork.Console.pl Maint::Ticket::FulltextIndex --rebuild" in order to generate a new index.' =>
            '',
        ...
        'Defines the shown columns and the position in the AgentCustomerUserAddressBook result screen.' =>
            '',
        'Defines the shown links in the footer area of the customer and public interface of this OFORK system. The value in "Key" is the external URL, the value in "Content" is the shown label.' =>
            '',
        ...
        'Executes follow-up checks on In-Reply-To or References headers for mails that don\'t have a ticket number in the subject.' =>
            '',
        'Executes follow-up checks on OFORK Header \'X-OOFORK-Bounce\'.' => '',
        ...
        'Greek' => '',
        'Hebrew' => '',
        'Helps to extend your articles full-text search (From, To, Cc, Subject and Body search). It will strip all articles and will build an index after article creation, increasing fulltext searches about 50%. To create an initial index use "bin/ofork.Console.pl Maint::Ticket::FulltextIndex --rebuild".' =>
            '',
        'High Contrast' => '',
        ...
        'If this regex matches, no message will be send by the autoresponder.' =>
            '',
        'If this setting is enabled, it is possible to install packages which are not verified by OFORK. These packages could threaten your whole system!' =>
            '',
        ...
        'New process ticket' => '',
        'News about OFORK releases!' => 'Notícias acerca dos lançamentos OFORK!',
        'News about OFORK.' => '',
        ...
        'OFORK Group Services' => '',
        'OFORK News' => 'Notícias OFORK',
        ...
        'Sends registration information to OFORK.' => '',
...
Devemos voltar a estar online dentro de momentos.',
        ...
        'Your email with ticket number "<OFORK_TICKET>" is bounced to "<OFORK_BOUNCE_TO>". Contact this address for further information.' =>
            '',
        'Your email with ticket number "<OFORK_TICKET>" is merged to "<OFORKS_MERGE_TO_TICKET>".' =>
            'O ticket com o número  "<OFORK_TICKET>" foi fundido com o ticket "<OFORK_MERGE_TO_TICKET>".',
