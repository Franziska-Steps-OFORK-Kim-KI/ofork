...
# --
# $Id: da.pm,v 1.1.1.1 2018/07/16 14:49:06 ud Exp $
# --
...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'Here you can specify the maximum size (in bytes) of REST messages that OFORK will process.' =>
            'Her kan du angive den maksimale længde (i bytes) af REST-beskeder, som OFORK vil behandle.',
        ...
        'e.g https://o-fork.de:10745/api/v1.0 (without trailing backslash)' =>
            'f.eks. https://o-fork.de:10745/api/v1.0 (uden efterfølgende backslash)',
        'Timeout' => '',
        ...
        'e.g. /opt/ofork/var/certificates/SOAP/CA/ca.pem' => 'f.eks. /opt/ofork/var/certificates/SOAP/CA/ca.pem',
        ...
        'e.g. /opt/ofork/var/certificates/SOAP/CA' => 'f.eks. /opt/ofork/var/certificates/SOAP/CA',
        ...
        'e.g urn:o-fork-de:soap:functions or http://o-fork.de/GenericInterface/actions' =>
            '',
        'Request name scheme' => '',
        ...
        'This package is verified by OFORKverify' => 'Denne pakke er verificeret af OFORKverify',
        ...
        'The support bundle will be sent to OFORK Team via email automatically.' =>
            'Support Pakken sendes automatisk via email til OFORK',
        ...
        'A file containing the support bundle will be downloaded to the local system. Please save the file and send it to the OFORK Team, using an alternate method.' =>
            'Supportpakken downloades på det lokale system. Gem venligst filen og send den til OFORK.',
        ...
        'The OFORK Daemon is a daemon process that performs asynchronous tasks, e.g. ticket escalation triggering, email sending, etc.' =>
            'OFORK tjenesten er en tjeneste der udfører asynkrone opgaver, f.eks. sags eskalering, afsendelse af email, osv.',
        'A running OFORK Daemon is mandatory for correct system operation.' =>
            'En kørende OFORK tjeneste er påkrævet for korrekt system operation.',
        'Starting the OFORK Daemon' => 'Starter OFORK tjeneste',
        'Make sure that the file \'%s\' exists (without .dist extension). This cron job will check every 5 minutes if the OFORK Daemon is running and start it if needed.' =>
            'Kontroller at filen \'%s\' eksisterer (uden .dist filendelsen). Dette cron job  checker hvert 5. minut om OFORK tjenesten kører og starter den om nødvendigt.',
        'Execute \'%s start\' to make sure the cron jobs of the \'ofork\' user are active.' =>
            'Kør \'%s start\' for at sikre at \'ofork\' brugerens cron job er aktive.',
        'After 5 minutes, check that the OFORK Daemon is running in the system (\'bin/ofork.Daemon.pl status\').' =>
            'Check at OFORK tjenesten kører efter 5 minutter (\'bin/ofork.Daemon.pl status\').',
        ...
        'This setting can currently not be saved' => '',
        'Save this setting' => '',
        'Did you know? You can help translating OFORK at %s.' => 'Vidste du det? Du kan hjælpe med at oversætte OFORK på %s.',
        ...
        'Create a new database for OFORK' => 'Opret ny database til OFORK',
        'Use an existing database for OFORK' => 'Brug en eksisterende database til OFORK',
        ...
        'A new database user with limited permissions will be created for this OFORK system.' =>
            'En ny database-bruger med begrænsede rettigheder vil blive oprettet til dette OFORK-system.',
        ...
        'To be able to use OFORK you have to enter the following line in your command line (Terminal/Shell) as root.' =>
            'For at kunne anvende OFORK, er du nødt til at indtaste følgende linje i din kommandolinje (Terminal/Shell) som root.',
        'Restart your webserver' => 'Genstart webserveren',
        'After doing so your OFORK is up and running.' => 'Når det er gjort, er din OFORK sat i gang og fungerer.',
        'Start page' => 'Startside',
        'Your OFORK Team' => 'Dit OFORK Team',
        ...
        'Sorry, but this feature of OFORK is currently not available for mobile devices. If you\'d like to use it, you can either switch to desktop mode or use your regular desktop device.' =>
            'Beklager, men denne funktion i OFORK er ikke tilgængelig for mobile enheder. Hvis du gerne vil bruge den, kan du enten skifte til desktop-visning eller bruge din almindelige desktop-pc.',
        ...
        # Template: Test
        'OFORK Test Page' => 'OFORK prøveside',
        'Unlock' => 'Frigiv',
        ...
        'Notifications could not be Imported due to a unknown error, please check OFORK logs for more information' =>
            'Beskeder kunne ikke importeres grundet en ukendt fejl. Tjek OFORK-loggen for mere information.',
        ...
        'OFORK as provider' => 'OFORK som provider',
        'Operations' => '',
        'OFORK as requester' => 'OFORK som requester',
        'Invokers' => '',
        ...
        'Package not verified by OFORK! It is recommended not to use this package.' =>
            'Pakken er ikke godtkendt OFORK! Det anbefales ikke af bruge denne pakke.',
        'Not Started' => '',
        'Updated' => '',
        'Already up-to-date' => '',
        'Installed' => '',
        ...
        'Enable cloud services to unleash all OFORK features!' => 'Aktiver cloud service for at få adgang til alle OFORK muligheder!',
...
Opdater venligst dit framework først!',
        ...
        'OFORK Daemon is not running.' => 'OFORK-dæmonen kører ikke.',
        ...
        'OFORK Disk Partition' => 'OFORK Disk Partition',

        # Perl Module: Kernel/System/SupportDataCollector/Plugin/OS/DiskSpace.pm
        'Disk Usage' => 'Diskforbrug',
        'The partition where OFORK is located is almost full.' => 'Den partition OFORK befinder sig på er næsten fuld.',
        'The partition where OFORK is located has no disk space problems.' =>
            'Den partition OFORK befinder sig på har ingen pladsproblemer.',
        ...
        'The file system on your OFORK partition is not writable.' => 'Filsystemet på din OFORK-partition er ikke skrivbart.',
        ...
        'Some packages are not verified by the OFORK Group! It is recommended not to use this packages.' =>
            '',
        ...
        'OFORK requires apache to be run with the \'prefork\' MPM model.' =>
            'OFORK kræver, at apache kører med MPM-modellen \'prefork\'.',
        ...
        'Information about the OFORK Daemon' => 'Information om OFORK tjenesten',
...
' => '',
        ...
        'If "LDAP" was selected for Customer::Authmodule, you can check if the user is allowed to authenticate because he is in a posixGroup, e.g. user needs to be in a group xyz to use OFORK. Specify the group, who may access the system.' =>
            'Hvis "LDAP" er valgt for Customer::Authmodule kan du bestemme om en bruger må logge ind ved at gøre dem til medlem af en possixGroup, f.eks. brugeren skal være medlem af gruppe xyz for at benytte OFORK. Angiv gruppen der skal have adgang til systemet.',
        ...
        'Merged Ticket <OFORK_TICKET> to <OFORK_MERGE_TO_TICKET>.' => 'Samlet sag <OFORK_TICKET> med <OFORK_MERGE_TO_TICKET>.',
        'Minute' => '',
        ...
        'New process ticket' => '',
        'News about OFORK releases!' => 'Nyheder om OFORK-udgivelser.',
        'News about OFORK.' => '',
        ...
        'Your email with ticket number "<OFORK_TICKET>" is bounced to "<OFORK_BOUNCE_TO>". Contact this address for further information.' =>
            'Din e-mail med sagsnummer "<OFORK_TICKET>" er overgivet til "<OFORK_BOUNCE_TO>". Kontakt denne adresse for yderligere information.',
        'Your email with ticket number "<OFORK_TICKET>" is merged to "<OFORK_MERGE_TO_TICKET>".' =>
            'Din sag nummer "<OFORK_TICKET>" er blevet samlet med sag nummer "<OFORK_MERGE_TO_TICKET>".',
