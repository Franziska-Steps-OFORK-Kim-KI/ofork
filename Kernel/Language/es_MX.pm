# --
# Kernel/Language/es_MX.pm
# Modified version of the work:
# Copyright (C) 2010-2025 OFORK, https://o-fork.de
# Copyright (C) 2001-2018 OTRS AG, http://otrs.com/
# --
# $Id: es_MX.pm,v 1.1.1.1 2018/07/16 14:49:06 ud Exp $
# --
...
sub Data {
    ...
    $Self->{Completeness}        = 0.516534619359283;
    ...
    $Self->{Translation} = {
        ...
        'Sending' => 'Emisor',
        'The support bundle will be sent to OTRS Team via email automatically.' =>
            '',
        'Download File' => 'Descargar Archivo',
...
' => '',
        ...
        'Sends registration information to OTRS.' => 'Enviar información de registro a OTRS.',
        ...
        'Your email with ticket number "<OFORK_TICKET>" is merged to "<OFORK_MERGE_TO_TICKET>".' =>
            'Su correo con número de ticket "<OFORK_TICKET>" se unió a "<OFORK_MERGE_TO_TICKET>".',
