...
# --
# $Id: nl.pm,v 1.1.1.1 2018/07/16 14:49:06 ud Exp $
# --
...
sub Data {
    ...
    $Self->{Completeness}        = 0.476059249052704;
    ...
    $Self->{Translation} = {
        ...
        'It is highly recommended to send this data to OFORK in order to get better support.' =>
            'Het is aangeraden om deze gegevens naar de OFORK te versturen om een betere ondersteuning te bekomen.',
        ...
        'e.g https://o-fork.de:10745/api/v1.0 (without trailing backslash)' =>
            'e.g https://o-fork.de:10745/api/v1.0 (zonder trailing backslash)',
        'Timeout' => '',
        ...
        'e.g. /opt/ofork/var/certificates/SOAP/CA/ca.pem' => 'Bijvoorbeeld /opt/ofork/var/certificates/SOAP/CA/ca.pem',
        ...
        'e.g. /opt/ofork/var/certificates/SOAP/CA' => 'bijvoorbeeld /opt/ofork/var/certificates/SOAP/CA',
        ...
        'e.g urn:o-fork-de:soap:functions or https://o-fork.de/GenericInterface/actions' =>
            'bijv. urn:o-fork-de:soap:functions of https://o-fork.de/GenericInterface/actions',
        ...
        'This system is registered with OFORK.' => 'Dit systeem is geregistreerd bij de OTRS Groep.',
        ...
        'A registered system sends the following data to OFORK:' => 'Een geregistreerd systeem verstuurt de volgende gegevens naar de OTRS Groep:',
        ...
        'Sending support data to OFORK is not possible!' => 'Het versturen van support gegevens naar OFORK is niet mogelijk!',
        'Enable Cloud Services' => 'Schakel Cloud Diensten in',
        'This data is sent to OFORK on a regular basis. To stop sending this data please update your system registration.' =>
            'Deze gegevens worden regelmatig verstuurd naar OFORK. Om te stoppen met het versturen van deze gegevens moet je je systeem registatie aanpassen.',
        ...
        'A support bundle (including:  a list of installed packages and all locally modified source code files) can be generated by pressing this button:' =>
            'Een support bundel kan gegenereerd worden door op deze knop te drukken (inclusief: een lijst met geïnstalleerde pakketen en alle lokaal aanepaste bronconde bestanden).',
        ...
        'The support bundle will be sent to OFORK Team via email automatically.' =>
            'De support bundel wordt automatisch verzonden naar OFORK via e-mail.',
        ...
        'A file containing the support bundle will be downloaded to the local system. Please save the file and send it to the OFORK Team, using an alternate method.' =>
            'Een bestand met de support bundel wordt gedownload naar het lokale systeem. Je kunt het opslaan en versturen naar OFORK via een alternatieve methode.',
        ...
        'Execute \'%s start\' to make sure the cron jobs of the \'ofork\' user are active.' =>
            'Voer \'%s start\' uit om ervoor te zorgen dat de cron jobs van de gebruiker \'ofork\' actief zijn.',
        'After 5 minutes, check that the OTRS Daemon is running in the system (\'bin/ofork.Daemon.pl status\').' =>
            'Controleer na 5 minuten of de OTRS Daemon draait in het systeem (\'bin/ofork.Daemon.pl status\').',
        ...
        'Table ticket_lock_index contains orphaned records. Please run bin/ofork.Console.pl "Maint::Ticket::QueueIndexCleanup" to clean the StaticDB index.' =>
            'De tabel ticket_lock_index bevat weesreckords. Om sw StaticDB te schonen voert u het volgende script: uit bin/ofork.Console.pl "Maint::Ticket::QueueIndexCleanup".',
...
',
        ...
        'Your email with ticket number "<OFORK_TICKET>" is merged to "<OFORK_MERGE_TO_TICKET>".' =>
            'Uw e-mail met ticketnummer "<OFORK_TICKET>" is samengevoegd met "<OFORK_MERGE_TO_TICKET>".',
