# --
# Kernel/Modules/AdminSelfServiceCategoriesIcon.pm
# Copyright (C) 2010-2025 OFORK, https://o-fork.de
# --
# $Id: AdminSelfServiceCategoriesIcon.pm,v 1.1.1.1 2018/07/16 14:49:06 ud Exp $
# --
...
package Kernel::Modules::AdminSelfServiceCategoriesIcon;
...
sub Run {
    ...
    if ( $Self->{Subaction} eq 'Change' ) {
        ...
        $Output .= $LayoutObject->Output(
            TemplateFile => 'AdminSelfServiceCategoriesIcon',
            Data         => \%Param,
        );
    ...
    # ------------------------------------------------------------ #
        ...
        if ( !%Errors ) {
            ...
            # update attachment
            my $Update = $SelfServiceCategoriesIconObject->SelfServiceCategoriesIconUpdate(
                %GetParam,
                %UploadStuff,
                UserID => $Self->{UserID},
            );
    ...
    # ------------------------------------------------------------ #
        ...
        if ( !%Errors ) {
            ...
            # add state
            my $SelfServiceCategoriesIconID = $SelfServiceCategoriesIconObject->SelfServiceCategoriesIconAdd(
                %GetParam,
                %UploadStuff,
                UserID => $Self->{UserID},
            );
            if ($SelfServiceCategoriesIconID) {
                $Self->_Overview();
                my $Output = $LayoutObject->Header();
                $Output .= $LayoutObject->NavigationBar();
    ...
    # ------------------------------------------------------------ #
        ...
        my $ID = $ParamObject->GetParam( Param => 'ID' );
        my $Delete = $SelfServiceCategoriesIconObject->SelfServiceCategoriesIconDelete(
            ID => $ID,
        );
