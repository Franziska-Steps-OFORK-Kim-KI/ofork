# --
# Kernel/Modules/AgentTicketBounce.pm
# Modified version of the work:
# Copyright (C) 2010-2024 OFORK, https://o-fork.de
# based on the original work of:
# Copyright (C) 2001-2018 OTRS AG, http://otrs.com/
# --
# $Id: AgentTicketBounce.pm,v 1.1.1.1 2018/07/16 14:49:06 ud Exp $
# --
...
sub Run {
    ...
    if ( !$Self->{Subaction} ) {
        ...
        if ( $LayoutObject->{BrowserRichText} ) {
            ...
            # prepare bounce tags
            $Param{BounceText} =~ s/<OFORK_TICKET>/&lt;OFORK_TICKET&gt;/g;
            $Param{BounceText} =~ s/<OFORK_BOUNCE_TO>/&lt;OFORK_BOUNCE_TO&gt;/g;
    ...
    # ------------------------------------------------------------ #
        ...
        if (%Error) {
            ...
            if ( $LayoutObject->{BrowserRichText} ) {
                ...
                # prepare bounce tags
                $Param{Body} =~ s/&lt;OFORK_TICKET&gt;/&amp;lt;OFORK_TICKET&amp;gt;/gi;
                $Param{Body} =~ s/&lt;OFORK_BOUNCE_TO&gt;/&amp;lt;OFORK_BOUNCE_TO&amp;gt;/gi;
            }
        ...
        if ( $Param{InformSender} ) {
            ...
            $Param{Body} =~ s/(&lt;|<)OFORK_TICKET(&gt;|>)/$Ticket{TicketNumber}/g;
            $Param{Body} =~ s/(&lt;|<)OFORK_BOUNCE_TO(&gt;|>)/$Param{BounceTo}/g;
