# --
# Kernel/Modules/AdminRoomIcon.pm
# Modified version of the work:
# Copyright (C) 2010-2025 OFORK, https://o-fork.de
# based on the original work of:
# Copyright (C) 2001-2018 OTRS AG, http://otrs.com/
# --
# $Id: AdminRoomIcon.pm,v 1.1.1.1 2018/07/16 14:49:06 ud Exp $
# --
...
package Kernel::Modules::AdminRoomIcon;
...
sub Run {
    ...
    # ------------------------------------------------------------ #
        ...
        if ( !%Errors ) {
            ...
            # update attachment
            my $Update = $RoomIconObject->RoomIconUpdate(
                %GetParam,
                %UploadStuff,
                UserID => $Self->{UserID},
            );
    ...
    # ------------------------------------------------------------ #
        ...
        if ( !%Errors ) {
            ...
            # add state
            my $RoomIconID = $RoomIconObject->RoomIconAdd(
                %GetParam,
                %UploadStuff,
                UserID => $Self->{UserID},
            );
    ...
    # ------------------------------------------------------------ #
        ...
        my $ID = $ParamObject->GetParam( Param => 'ID' );
        my $Delete = $RoomIconObject->RoomIconDelete(
            ID => $ID,
        );
