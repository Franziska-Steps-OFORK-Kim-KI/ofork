# --
# Kernel/Modules/AdminRequestCategoriesIcon.pm
# Copyright (C) 2010-2024 OFORK, https://o-fork.de
# --
# $Id: AdminRequestCategoriesIcon.pm,v 1.1.1.1 2018/07/16 14:49:06 ud Exp $
# --
...
package Kernel::Modules::AdminRequestCategoriesIcon;
...
sub Run {
    ...
    if ( $Self->{Subaction} eq 'Change' ) {
        ...
        $Output .= $LayoutObject->Output(
            TemplateFile => 'AdminRequestCategoriesIcon',
            Data         => \%Param,
        );
    ...
    # ------------------------------------------------------------ #
        ...
        if ( !%Errors ) {
            ...
            # update attachment
            my $Update = $RequestCategoriesIconObject->RequestCategoriesIconUpdate(
                %GetParam,
                %UploadStuff,
                UserID => $Self->{UserID},
            );
    ...
    # ------------------------------------------------------------ #
        ...
        if ( !%Errors ) {
            ...
            # add state
            my $RequestCategoriesIconID = $RequestCategoriesIconObject->RequestCategoriesIconAdd(
                %GetParam,
                %UploadStuff,
                UserID => $Self->{UserID},
            );
            if ($RequestCategoriesIconID) {
                $Self->_Overview();
                my $Output = $LayoutObject->Header();
                $Output .= $LayoutObject->NavigationBar();
    ...
    # ------------------------------------------------------------ #
        ...
        my $ID = $ParamObject->GetParam( Param => 'ID' );
        my $Delete = $RequestCategoriesIconObject->RequestCategoriesIconDelete(
            ID => $ID,
        );
