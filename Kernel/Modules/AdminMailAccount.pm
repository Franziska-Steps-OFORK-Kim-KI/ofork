# --
# Kernel/Modules/AdminMailAccount.pm
# Modified version of the work:
# Copyright (C) 2010-2025 OFORK, https://o-fork.de
# based on the original work of:
# Copyright (C) 2001-2018 OTRS AG, http://otrs.com/
# --
# $Id: AdminMailAccount.pm,v 1.1.1.1 2018/07/16 14:49:06 ud Exp $
# --
...
sub Run {
    ...
    if ( $Self->{Subaction} eq 'Run' ) {
        ...
        # Maint::PostMaster::MailAccountFetch executed by the OFORK daemon or manually.
