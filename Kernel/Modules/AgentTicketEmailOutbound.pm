# --
# Kernel/Modules/AgentTicketEmailOutbound.pm
# Modified version of the work:
# Copyright (C) 2010-2025 OFORK, https://o-fork.de
# based on the original work of:
# Copyright (C) 2001-2018 OTRS AG, http://otrs.com/
# --
# $Id: AgentTicketEmailOutbound.pm,v 1.1.1.1 2018/07/16 14:49:06 ud Exp $
# --
...
sub SendEmail {
    ...
    if ($NextState) {
        $GetParam{Body} =~ s/(&lt;|<)OFORK_TICKET_STATE(&gt;|>)/$NextState/g;
    }
