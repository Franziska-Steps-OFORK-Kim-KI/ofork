...
# --
# $Id: AdminPackageManager.pm,v 1.1.1.1 2018/07/16 14:49:06 ud Exp $
# --
...
sub Run {
    ...
    if ( $Self->{Subaction} eq 'ViewRemote' ) {
        ...
        my $CleanSource = $Source;
        $CleanSource =~ s/File=ofork\.xml//g;
    ...
    # Check if OFORK Daemon is running in the background.
