# --
# Kernel/Modules/AdminGenericInterfaceWebservice.pm
# Modified version of the work:
# Copyright (C) 2010-2025 OFORK, https://o-fork.de
# based on the original work of:
# Copyright (C) 2001-2018 OTRS AG, http://otrs.com/
# --
# $Id: AdminGenericInterfaceWebservice.pm,v 1.1.1.1 2018/07/16 14:49:06 ud Exp $
# --
...
sub Run {
    ...
    # ------------------------------------------------------------ #
        ...
        # Display any YAML error message as a normal ofork error message.
        if ( !IsHashRefWithData($ImportedConfig) ) {
            return $LayoutObject->ErrorScreen(
                Message =>
                    Translatable('The imported file has not valid YAML content! Please check OFORK log for details'),
            );
        }
    ...
    # Otherwise show all web services.
            ...
            )
        {
            ...
            if ( !$Webservice->{Config} || !IsHashRefWithData( $Webservice->{Config} ) ) {
                ...
                # Write an error message to the OFORK log.
...
sub _ShowEdit {
    ...
    my %CommTypeConfig = (
        Provider => {
            Title                 => Translatable('OFORK as provider'),
        ...
        Requester => {
            Title                 => Translatable('OFORK as requester'),
...
sub _UpdateConfiguration {
    ...
    # This function needs to be extended for further ofork versions
    #   it could be that newer ofork versions has different configuration options
