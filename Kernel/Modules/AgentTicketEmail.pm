...
# --
# $Id: AgentTicketEmail.pm,v 1.1.1.1 2018/07/16 14:49:06 ud Exp $
# --
...
sub Run {
    ...
    # create new ticket and article
        ...
        # cmdb info string
        my $CMDBSerchLimitObject = $ConfigObject->Get("ITSMConfigItem::Frontend::AgentITSMConfigItem");
        my $CMDBSearchLimit      = $CMDBSerchLimitObject->{SearchLimit};
            ...
            for my $Class ( %{$ClassList} ) {
                if ( $Class =~ /^\d+$/ ) {
                    ...
                    for my $ConfigItemID ( @ConfigItemArray) {
                        ...
                        my $True = $Kernel::OM->Get('Kernel::System::LinkObject')->LinkAdd(
                            SourceObject => 'Ticket',
                            SourceKey    => $TicketID,
