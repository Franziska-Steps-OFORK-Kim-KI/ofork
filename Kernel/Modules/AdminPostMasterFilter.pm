...
# --
# $Id: AdminPostMasterFilter.pm,v 1.1.1.1 2018/07/16 14:49:06 ud Exp $
# --
...
sub _MaskUpdate {
    ...
    for my $DynamicField ( values %$DynamicFields ) {
        push @Headers, 'X-OFORK-DynamicField-' . $DynamicField;
        push @Headers, 'X-OFORK-FollowUp-DynamicField-' . $DynamicField;
    }
