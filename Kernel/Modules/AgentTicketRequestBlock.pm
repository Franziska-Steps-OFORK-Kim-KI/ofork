# --
# Kernel/Modules/AgentTicketRequestBlock.pm - to handle customer messages
# Copyright (C) 2010-2025 OFORK, https://o-fork.de
# --
# $Id: AgentTicketRequestBlock.pm,v 1.21 2016/12/13 14:37:23 ud Exp $
# --
...
package Kernel::Modules::AgentTicketRequestBlock;
...
sub _MaskNew {
    ...
    if ( $CheckFields >= 1 ) {
        ...
        return $LayoutObject->Output(
            TemplateFile => 'AgentTicketRequestBlock',
            Data         => \%Param,
        );
    }
    else {
        ...
        # get output back
        return $LayoutObject->Output(
            TemplateFile => 'AgentTicketRequestBlockEmpty',
            Data         => \%Param,
        );
