# --
# Kernel/Modules/AgentTicketMerge.pm
# Modified version of the work:
# Copyright (C) 2010-2024 OFORK, https://o-fork.de
# based on the original work of:
# Copyright (C) 2001-2018 OTRS AG, http://otrs.com/
# --
# $Id: AgentTicketMerge.pm,v 1.1.1.1 2018/07/16 14:49:06 ud Exp $
# --
    ...
    if ( $Self->{Subaction} eq 'Merge' ) {
            ...
            )
        {
            ...
            if ( $GetParam{InformSender} ) {
                ...
                my %Ticket = $TicketObject->TicketGet( TicketID => $Self->{TicketID} );
                $GetParam{Body} =~ s/(&lt;|<)OFORK_TICKET(&gt;|>)/$Ticket{TicketNumber}/g;
                $GetParam{Body}
                    =~ s/(&lt;|<)OFORK_MERGE_TO_TICKET(&gt;|>)/$GetParam{'MainTicketNumber'}/g;
