# --
# Kernel/Modules/CustomerRequestOverview.pm
# Copyright (C) 2010-2025 OFORK, https://o-fork.de
# --
# $Id: CustomerRequestOverview.pm,v 1.3 2016/09/20 12:34:27 ud Exp $
# --
...
package Kernel::Modules::CustomerRequestOverview;
...
sub Run {
    ...
    if ( !$Self->{Subaction} ) {
        return $LayoutObject->Redirect(
            OP => 'Action=CustomerRequestOverview;Subaction=MyTickets',
        );
    }
    ...
    if ( !$AllTicketsTotal ) {
        ...
        my %PageNav = $LayoutObject->PageNavBar(
            ...
            PageShown => $PageShown,
            AllHits   => $AllTickets,
            Action    => 'Action=CustomerRequestOverview',
            Link      => $Link,
            IDPrefix  => 'CustomerRequestOverview',
        );
        ...
        my $Owner = $ConfigObject->Get('Ticket::Frontend::CustomerRequestOverview')->{Owner};
        my $Queue = $ConfigObject->Get('Ticket::Frontend::CustomerRequestOverview')->{Queue};
        ...
        my $DynamicFieldFilter = $ConfigObject->Get("Ticket::Frontend::CustomerRequestOverview")->{DynamicField};
    ...
    $Output .= $LayoutObject->Output(
        TemplateFile => 'CustomerRequestOverview',
        Data         => \%Param,
    );
...
sub ShowTicketStatus {
    ...
    my $Subject;
    my $ConfigObject          = $Kernel::OM->Get('Kernel::Config');
    my $SmallViewColumnHeader = $ConfigObject->Get('Ticket::Frontend::CustomerRequestOverview')->{ColumnHeader};
