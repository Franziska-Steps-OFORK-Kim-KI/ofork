# --
# Kernel/GenericInterface/Invoker/Ticket/Generic.pm
...
sub HandleResponse {
    ...
    for my $Key ( sort keys %{ $Param{Data} } ) {
        ...
        my $Success = 1;
        if ( $Key =~ m{OFORK_TicketDynamicFieldSet_(.*)}xmsi ) {
        ...
        elsif ( $Key eq 'OFORK_TicketTitleUpdate' ) {
        ...
        elsif ( $Key eq 'OFORK_TicketServiceSet' ) {
        ...
        elsif ( $Key eq 'OFORK_TicketTypeSet' ) {
        ...
        elsif ( $Key eq 'OFORK_TicketQueueSet' ) {
        ...
        elsif ( $Key eq 'OFORK_TicketSLASet' ) {
        ...
        elsif ( $Key eq 'OFORK_TicketCustomerSet' ) {
        ...
        elsif ( $Key eq 'OFORK_TicketStateSet' ) {
        ...
        elsif ( $Key eq 'OFORK_TicketOwnerSet' ) {
        ...
        elsif ( $Key eq 'OFORK_TicketResponsibleSet' ) {
        ...
        elsif ( $Key eq 'OFORK_TicketPrioritySet' ) {
        ...
        elsif ( $Key eq 'OFORK_TicketHistoryAdd' ) {
            NEEDED:
        ...
        elsif ( $Key eq 'OFORK_TicketArticleAdd' ) {
            NEEDED:
        ...
        elsif ( $Key eq 'OFORK_TicketCreate' ) {
            $Success = $TicketObject->TicketCreate(
                %{ $Param{Data}->{$Key} },
            );
        }
        elsif ( $Key eq 'OFORK_AsynchronousInvokerExecution' ) {
        ...
        elsif ( $Key eq 'OFORK_TicketArticleCreateEvent' ) {
