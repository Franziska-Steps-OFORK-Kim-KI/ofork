# --
# Kernel/GenericInterface/Operation/Ticket/TicketCreate.pm
# Modified version of the work:
# Copyright (C) 2010-2025 OFORK, https://o-fork.de
# based on the original work of:
# Copyright (C) 2001-2018 OTRS AG, http://otrs.com/
# --
# $Id: TicketCreate.pm,v 1.1.1.1 2018/07/16 14:49:06 ud Exp $
# --
...
perform TicketCreate Operation. This will return the created ticket number.
    ...
    $Result = {
        ...
        Data            => {                        # result data payload after Operation
            TicketID    => 123,                     # Ticket  ID number in OFORK (help desk system)
            TicketNumber => 2324454323322           # Ticket Number in OFORK (Help desk system)
            ArticleID   => 43,                      # Article ID number in OFORK (help desk system)
