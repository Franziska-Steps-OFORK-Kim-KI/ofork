# --
# scripts/DBUpdateTo11.pm
# Modified version of the work:
# Copyright (C) 2010-2024 OFORK, https://o-fork.de
# based on the original work of:
# Copyright (C) 2001-2018 OTRS AG, http://otrs.com/
# --
# $Id: DBUpdateTo11.pm,v 1.1.1.1 2018/07/16 14:49:06 ud Exp $
# --

package scripts::DBUpdateTo11;
...
scripts::DBUpdateTo11 - Perform system upgrade from OTRS 6 to OFORK 11.
...
Don't use the constructor directly, use the ObjectManager instead:
    ...
    my $DBUpdateTo11Object = $Kernel::OM->Get('scripts::DBUpdateTo11');
...
sub _ExecuteComponent {
    ...
    for my $Task (@Tasks) {
        ...
        my $ModuleName = "scripts::DBUpdateTo11::$Task->{Module}";
        ...
        $Kernel::OM->ObjectParamAdd(
            "scripts::DBUpdateTo11::$Task->{Module}" => {
                Opts => $Self->{Opts},
            },
        );
