...
package scripts::DBUpdateTo11::Base;
...
scripts::DBUpdateTo11::Base - Base class for migrations.
...
Refreshes the configuration to make sure that a ZZZAAuto.pm is present after the upgrade.
    ...
    $DBUpdateTo11Object->RebuildConfig(
...
Clean up the cache.
    ...
    $DBUpdateTo11Object->CacheCleanup();
...
Parse and execute an XML array.
    ...
    $DBUpdateTo11Object->ExecuteXMLDBArray(
        XMLArray          => \@XMLArray,
...
Parse and execute an XML string.
    ...
    $DBUpdateTo11Object->ExecuteXMLDBString(
        XMLString => '
...
Checks if the given table exists in the database.
    ...
    my $Result = $DBUpdateTo11Object->TableExists(
        Table => 'ticket',
    );
...
Checks if the given column exists in the given table.
    ...
    my $Result = $DBUpdateTo11Object->ColumnExists(
        Table  => 'ticket',
        Column =>  'id',
    );
...
Checks if the given index exists in the given table.
    ...
    my $Result = $DBUpdateTo11Object->IndexExists(
        Table => 'ticket',
        Index =>  'id',
    );
...
Clean up the cache.
    ...
    $DBUpdateTo11Object->GetTaskConfig( Module => "TaskModuleName");
