# --
# scripts/DBUpdateTo11/MigrateModifiedSettings.pm
...
package scripts::DBUpdateTo11::MigrateModifiedSettings;
...
scripts::DBUpdateTo11::MigrateModifiedSettings - Migrate config modified values that are changed to OFORK 11 .
