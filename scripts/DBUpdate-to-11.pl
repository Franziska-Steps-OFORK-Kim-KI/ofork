...
local $Kernel::OM = Kernel::System::ObjectManager->new(
    'Kernel::System::Log' => {
        LogPrefix => 'OFORK-DBUpdate-to-11.pl',
    },
);
...
DBUpdate-to-11.pl - Upgrade script for OTRS 6 to OFORK 11 migration.
Copyright (C) 2010-2024 OFORK, https://o-fork.de
...
";
    ...
    $Kernel::OM->Create('scripts::DBUpdateTo11')->Run(
