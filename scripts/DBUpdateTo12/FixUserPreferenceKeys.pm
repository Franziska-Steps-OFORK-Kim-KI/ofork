# --
# scripts/DBUpdateTo12/FixUserPreferenceKeys.pm
...
package scripts::DBUpdateTo12::FixUserPreferenceKeys;
...
scripts::DBUpdateTo12::FixUserPreferenceKeys - Make sure that user preferences do not contain
