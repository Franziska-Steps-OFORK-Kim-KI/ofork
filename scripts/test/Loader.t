...

{
    my $CSS = $MainObject->FileRead(
        Location => $Home . '/scripts/test/sample/Loader/OFORK.Reset.css',
    );

    $CSS = ${$CSS};

    my $ExpectedCSS = $MainObject->FileRead(
        Location => $Home . '/scripts/test/sample/Loader/OFORK.Reset.min.css',
    );
...

{
    my $JavaScript = $MainObject->FileRead(
        Location => $Home . '/scripts/test/sample/Loader/OFORK.Agent.App.Login.js',
    );
    ...
    my $ExpectedJS = $MainObject->FileRead(
        Location => $Home . '/scripts/test/sample/Loader/OFORK.Agent.App.Login.min.js',
    );
...

{
    my $MinifiedJSFilename = $LoaderObject->MinifyFiles(
        List => [
            $Home . '/scripts/test/sample/Loader/OFORK.Agent.App.Login.js',
            $Home . '/scripts/test/sample/Loader/OFORK.Agent.App.Dashboard.js',
        ],
        Type            => 'JavaScript',
