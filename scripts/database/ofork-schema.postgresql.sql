...
IF NOT EXISTS (
    SELECT 1
    FROM pg_indexes
    WHERE LOWER(indexname) = LOWER('article_data_ofork_chat_article_id')
    ) THEN
    CREATE INDEX article_data_ofork_chat_article_id ON article_data_ofork_chat (article_id);
END IF;
END$$;
;
-- ----------------------------------------------------------
...
CREATE TABLE request (
    ...
    ticket_responsible INTEGER NULL,
    valid_id SMALLINT NOT NULL,
    subject VARCHAR (2000) NULL,
    subject_changeable SMALLINT NULL,
    show_configitems VARCHAR (200) NULL,
...
CREATE TABLE request_form_block (
    ...
    request_form_value VARCHAR (1000) NULL,
    request_id INTEGER NOT NULL,
    feld_id INTEGER NULL,
    requiredfield SMALLINT NULL,
    orders INTEGER NOT NULL,
...
CREATE TABLE rooms (
    ...
    post_code VARCHAR (250) NULL,
    city VARCHAR (250) NULL,
    calendar VARCHAR (250) NULL,
    setup_time VARCHAR (250) NULL,
    persons VARCHAR (250) NULL,
    price VARCHAR (250) NULL,
    price_for SMALLINT NULL,
    currency VARCHAR (250) NULL,
    equipment_bookable VARCHAR (250) NULL,
    equipment VARCHAR (250) NULL,
    description VARCHAR (2000) NULL,
    queue_booking INTEGER NULL,
...
CREATE TABLE checklist (
    ...
    type_id INTEGER NULL,
    service_id INTEGER NULL,
    queue_ids VARCHAR (250) NULL,
    type_ids VARCHAR (250) NULL,
    service_ids VARCHAR (250) NULL,
...
CREATE TABLE t_process_step (
    ...
    step_no INTEGER NOT NULL,
    step_no_from INTEGER NOT NULL,
    to_id_from_one INTEGER NULL,
    to_id_from_two INTEGER NULL,
    step_no_to INTEGER NULL,
    process_color VARCHAR (250) NOT NULL,
    description VARCHAR (5000) NULL,
    group_id INTEGER NOT NULL,
    stepart_id INTEGER NOT NULL,
    step_end SMALLINT NULL,
    with_conditions_end SMALLINT NULL,
    without_conditions_end SMALLINT NULL,
    not_approved SMALLINT NULL,
    ...
    ticket_id INTEGER NOT NULL,
    ready SMALLINT NULL,
    step_active SMALLINT NULL,
    setarticle_id SMALLINT NOT NULL,
    parallel_step INTEGER NULL,
    set_parallel INTEGER NULL,
...
CREATE TABLE standard_templ_request_field (
    id serial NOT NULL,
    standard_request_field_id INTEGER NOT NULL,
    standard_template_id INTEGER NOT NULL,
    create_time timestamp(0) NOT NULL,
    create_by INTEGER NOT NULL,
    change_time timestamp(0) NOT NULL,
...
CREATE TABLE contractdevice (
    ...
    device_number INTEGER NULL,
    ticket_create INTEGER NULL,
    queue_id INTEGER NULL,
    notification timestamp(0) NULL,
    create_time timestamp(0) NOT NULL,
    create_by INTEGER NOT NULL,
    change_time timestamp(0) NOT NULL,
    change_by INTEGER NOT NULL,
...
CREATE TABLE contract (
    ...
    cp_id INTEGER NULL,
    customer_id VARCHAR (250) NULL,
    customeruser_id VARCHAR (250) NULL,
    ...
    noticeperiod VARCHAR (250) NULL,
    ticket_create VARCHAR (250) NULL,
    memory VARCHAR (250) NULL,
    memory_time timestamp(0) NULL,
    notification timestamp(0) NULL,
    queue_id INTEGER NULL,
    valid_id SMALLINT NOT NULL,
    create_time timestamp(0) NOT NULL,
...
CREATE TABLE handover (
    id serial NOT NULL,
    contract_id INTEGER NOT NULL,
    handover VARCHAR (250) NOT NULL,
    handoverdate timestamp(0) NOT NULL,
    create_time timestamp(0) NOT NULL,
    create_by INTEGER NOT NULL,
    change_time timestamp(0) NOT NULL,
    change_by INTEGER NOT NULL,
