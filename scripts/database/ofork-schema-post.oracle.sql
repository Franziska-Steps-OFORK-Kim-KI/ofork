...
;
BEGIN
    EXECUTE IMMEDIATE 'ALTER TABLE article_data_ofork_chat ADD CONSTRAINT FK_article_data_ofork_chat_arcf FOREIGN KEY (article_id) REFERENCES article (id)';
EXCEPTION
  WHEN OTHERS THEN NULL;
END;
/
...
;
BEGIN
    EXECUTE IMMEDIATE 'CREATE INDEX FK_article_data_ofork_chat_ar37 ON article_data_ofork_chat (article_id)';
EXCEPTION
  WHEN OTHERS THEN NULL;
END;
/
