...
;
-- ----------------------------------------------------------
--  create table ticket_flag_customer
-- ----------------------------------------------------------
CREATE TABLE ticket_flag_customer (
    ticket_id NUMBER (20, 0) NOT NULL,
    ticket_key VARCHAR2 (50) NOT NULL,
...
BEGIN
    EXECUTE IMMEDIATE 'CREATE INDEX ticket_flag_customer_article_id ON ticket_flag_customer (ticket_id)';
EXCEPTION
  WHEN OTHERS THEN NULL;
END;
/
...
;
-- ----------------------------------------------------------
--  create table article_flag_customer
-- ----------------------------------------------------------
CREATE TABLE article_flag_customer (
    article_id NUMBER (20, 0) NOT NULL,
    article_key VARCHAR2 (50) NOT NULL,
...
BEGIN
    EXECUTE IMMEDIATE 'CREATE INDEX article_flag_customer_article_id ON article_flag_customer (article_id)';
EXCEPTION
  WHEN OTHERS THEN NULL;
END;
/
...
;
-- ----------------------------------------------------------
--  create table article_data_ofork_chat
-- ----------------------------------------------------------
CREATE TABLE article_data_ofork_chat (
    id NUMBER (20, 0) NOT NULL,
    article_id NUMBER (20, 0) NOT NULL,
...
ALTER TABLE article_data_ofork_chat ADD CONSTRAINT PK_article_data_ofork_chat PRIMARY KEY (id);
BEGIN
    EXECUTE IMMEDIATE 'DROP SEQUENCE SE_article_data_ofork_chat';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE SEQUENCE SE_article_data_ofork_chat
INCREMENT BY 1
START WITH 1
NOMAXVALUE
NOCYCLE
...
;
BEGIN
    EXECUTE IMMEDIATE 'DROP TRIGGER SE_article_data_ofork_chat_t';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE OR REPLACE TRIGGER SE_article_data_ofork_chat_t
BEFORE INSERT ON article_data_ofork_chat
FOR EACH ROW
BEGIN
    IF :new.id IS NULL THEN
        SELECT SE_article_data_ofork_chat.nextval
        INTO :new.id
        FROM DUAL;
    END IF;
END;
...
;
BEGIN
    EXECUTE IMMEDIATE 'CREATE INDEX article_data_ofork_chat_artic16 ON article_data_ofork_chat (article_id)';
EXCEPTION
  WHEN OTHERS THEN NULL;
END;
/
...
ALTER TABLE standard_template_attachment ADD CONSTRAINT PK_standard_template_attachment PRIMARY KEY (id);
BEGIN
    EXECUTE IMMEDIATE 'DROP SEQUENCE SE_standard_template_attachment';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE SEQUENCE SE_standard_template_attachment
INCREMENT BY 1
START WITH 1
NOMAXVALUE
NOCYCLE
...
;
BEGIN
    EXECUTE IMMEDIATE 'DROP TRIGGER SE_standard_template_attachment_t';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE OR REPLACE TRIGGER SE_standard_template_attachment_t
BEFORE INSERT ON standard_template_attachment
FOR EACH ROW
BEGIN
    IF :new.id IS NULL THEN
        SELECT SE_standard_template_attachment.nextval
        INTO :new.id
        FROM DUAL;
    END IF;
END;
...
CREATE TABLE calendar_appointment (
    ...
    ticket_user_id NUMBER (12, 0) NULL
);
...
CREATE TABLE request (
    ...
    image_id NUMBER (12, 0) NULL,
    show_configitem NUMBER (12, 0) NULL,
    ticket_owner NUMBER (12, 0) NULL,
    ticket_responsible NUMBER (12, 0) NULL,
    valid_id NUMBER (5, 0) NOT NULL,
    subject VARCHAR2 (2000) NULL,
    subject_changeable NUMBER (5, 0) NULL,
    show_configitems VARCHAR2 (200) NULL,
    show_attachment NUMBER (12, 0) NULL,
    request_group NUMBER (12, 0) NULL,
    process_id NUMBER (12, 0) NULL,
    create_time DATE NOT NULL,
    create_by NUMBER (12, 0) NOT NULL,
    change_time DATE NOT NULL,
...
BEGIN
    EXECUTE IMMEDIATE 'DROP SEQUENCE SE_request';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
...
;
BEGIN
    EXECUTE IMMEDIATE 'DROP TRIGGER SE_request_t';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE OR REPLACE TRIGGER SE_request_t
BEFORE INSERT ON request
FOR EACH ROW
BEGIN
    IF :new.id IS NULL THEN
        SELECT SE_request.nextval
        INTO :new.id
        FROM DUAL;
    END IF;
END;
...
;
-- ----------------------------------------------------------
--  create table request_categories_icon
-- ----------------------------------------------------------
CREATE TABLE request_categories_icon (
    id NUMBER (12, 0) NOT NULL,
    name VARCHAR2 (250) NOT NULL,
...
--
;
CREATE SEQUENCE SE_request_categories_icon
INCREMENT BY 1
START WITH 1
NOMAXVALUE
NOCYCLE
...
;
BEGIN
    EXECUTE IMMEDIATE 'DROP TRIGGER SE_request_categories_icon_t';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
...
BEGIN
    IF :new.id IS NULL THEN
        SELECT SE_request_categories_icon.nextval
        INTO :new.id
        FROM DUAL;
    END IF;
END;
...
ALTER TABLE requestcategories ADD CONSTRAINT PK_requestcategories PRIMARY KEY (id);
BEGIN
    EXECUTE IMMEDIATE 'DROP SEQUENCE SE_requestcategories';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE SEQUENCE SE_requestcategories
INCREMENT BY 1
START WITH 1
NOMAXVALUE
NOCYCLE
...
;
BEGIN
    EXECUTE IMMEDIATE 'DROP TRIGGER SE_requestcategories_t';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE OR REPLACE TRIGGER SE_requestcategories_t
BEFORE INSERT ON requestcategories
FOR EACH ROW
BEGIN
    IF :new.id IS NULL THEN
        SELECT SE_requestcategories.nextval
        INTO :new.id
        FROM DUAL;
    END IF;
END;
...
;
-- ----------------------------------------------------------
--  create table requestcategories_request
-- ----------------------------------------------------------
CREATE TABLE requestcategories_request (
    id NUMBER (12, 0) NOT NULL,
    template_id NUMBER (12, 0) NOT NULL,
    requestcategories_id NUMBER (12, 0) NOT NULL,
    create_time DATE NOT NULL,
    create_by NUMBER (12, 0) NOT NULL,
    change_time DATE NOT NULL,
    change_by NUMBER (12, 0) NOT NULL
);
ALTER TABLE requestcategories_request ADD CONSTRAINT PK_requestcategories_request PRIMARY KEY (id);
BEGIN
    EXECUTE IMMEDIATE 'DROP SEQUENCE SE_requestcategories_request';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE SEQUENCE SE_requestcategories_request
INCREMENT BY 1
START WITH 1
NOMAXVALUE
NOCYCLE
...
;
BEGIN
    EXECUTE IMMEDIATE 'DROP TRIGGER SE_requestcategories_request_t';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE OR REPLACE TRIGGER SE_requestcategories_request_t
BEFORE INSERT ON requestcategories_request
FOR EACH ROW
BEGIN
    IF :new.id IS NULL THEN
        SELECT SE_requestcategories_request.nextval
        INTO :new.id
        FROM DUAL;
    END IF;
END;
...
CREATE TABLE request_fields (
    ...
    defaultvalue VARCHAR2 (1000) NULL,
    feld_rows NUMBER (5, 0) NULL,
    feld_cols NUMBER (5, 0) NULL,
    leer_wert NUMBER (5, 0) NULL,
    valid_id NUMBER (5, 0) NOT NULL,
    create_time DATE NOT NULL,
    create_by NUMBER (12, 0) NOT NULL,
    change_time DATE NOT NULL,
...
ALTER TABLE request_fields ADD CONSTRAINT PK_request_fields PRIMARY KEY (id);
BEGIN
    EXECUTE IMMEDIATE 'DROP SEQUENCE SE_request_fields';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE SEQUENCE SE_request_fields
INCREMENT BY 1
START WITH 1
NOMAXVALUE
NOCYCLE
...
;
BEGIN
    EXECUTE IMMEDIATE 'DROP TRIGGER SE_request_fields_t';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE OR REPLACE TRIGGER SE_request_fields_t
BEFORE INSERT ON request_fields
FOR EACH ROW
BEGIN
    IF :new.id IS NULL THEN
        SELECT SE_request_fields.nextval
        INTO :new.id
        FROM DUAL;
    END IF;
END;
...
;
-- ----------------------------------------------------------
--  create table request_fields_value
-- ----------------------------------------------------------
CREATE TABLE request_fields_value (
    id NUMBER (12, 0) NOT NULL,
    feld_id NUMBER (12, 0) NOT NULL,
    inhalt VARCHAR2 (1000) NOT NULL,
    schluessel VARCHAR2 (1000) NOT NULL,
    create_time DATE NOT NULL,
    create_by NUMBER (12, 0) NOT NULL,
    change_time DATE NOT NULL,
    change_by NUMBER (12, 0) NOT NULL
);
ALTER TABLE request_fields_value ADD CONSTRAINT PK_request_fields_value PRIMARY KEY (id);
BEGIN
    EXECUTE IMMEDIATE 'DROP SEQUENCE SE_request_fields_value';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE SEQUENCE SE_request_fields_value
INCREMENT BY 1
START WITH 1
NOMAXVALUE
NOCYCLE
...
;
BEGIN
    EXECUTE IMMEDIATE 'DROP TRIGGER SE_request_fields_value_t';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE OR REPLACE TRIGGER SE_request_fields_value_t
BEFORE INSERT ON request_fields_value
FOR EACH ROW
BEGIN
    IF :new.id IS NULL THEN
        SELECT SE_request_fields_value.nextval
        INTO :new.id
        FROM DUAL;
    END IF;
END;
...
CREATE TABLE request_form (
    ...
    beschreibung VARCHAR2 (3800) NULL,
    valid_id NUMBER (5, 0) NULL,
    create_time DATE NOT NULL,
    create_by NUMBER (12, 0) NOT NULL
);
ALTER TABLE request_form ADD CONSTRAINT PK_request_form PRIMARY KEY (id);
BEGIN
    EXECUTE IMMEDIATE 'DROP SEQUENCE SE_request_form';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE SEQUENCE SE_request_form
INCREMENT BY 1
START WITH 1
NOMAXVALUE
NOCYCLE
...
;
BEGIN
    EXECUTE IMMEDIATE 'DROP TRIGGER SE_request_form_t';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE OR REPLACE TRIGGER SE_request_form_t
BEFORE INSERT ON request_form
FOR EACH ROW
BEGIN
    IF :new.id IS NULL THEN
        SELECT SE_request_form.nextval
        INTO :new.id
        FROM DUAL;
    END IF;
END;
...
;
-- ----------------------------------------------------------
--  create table request_form_block
-- ----------------------------------------------------------
CREATE TABLE request_form_block (
    id NUMBER (12, 0) NOT NULL,
    request_form_id NUMBER (12, 0) NOT NULL,
    request_form_value VARCHAR2 (1000) NULL,
    request_id NUMBER (12, 0) NOT NULL,
    feld_id NUMBER (12, 0) NULL,
    requiredfield NUMBER (5, 0) NULL,
    orders NUMBER (12, 0) NOT NULL,
...
ALTER TABLE request_form_block ADD CONSTRAINT PK_request_form_block PRIMARY KEY (id);
BEGIN
    EXECUTE IMMEDIATE 'DROP SEQUENCE SE_request_form_block';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE SEQUENCE SE_request_form_block
INCREMENT BY 1
START WITH 1
NOMAXVALUE
NOCYCLE
...
;
BEGIN
    EXECUTE IMMEDIATE 'DROP TRIGGER SE_request_form_block_t';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE OR REPLACE TRIGGER SE_request_form_block_t
BEFORE INSERT ON request_form_block
FOR EACH ROW
BEGIN
    IF :new.id IS NULL THEN
        SELECT SE_request_form_block.nextval
        INTO :new.id
        FROM DUAL;
    END IF;
END;
...
;
-- ----------------------------------------------------------
--  create table ticket_id_request
-- ----------------------------------------------------------
CREATE TABLE ticket_id_request (
    id NUMBER (12, 0) NOT NULL,
...
ALTER TABLE ticket_id_request ADD CONSTRAINT PK_ticket_id_request PRIMARY KEY (id);
BEGIN
    EXECUTE IMMEDIATE 'DROP SEQUENCE SE_ticket_id_request';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE SEQUENCE SE_ticket_id_request
INCREMENT BY 1
START WITH 1
NOMAXVALUE
NOCYCLE
...
;
BEGIN
    EXECUTE IMMEDIATE 'DROP TRIGGER SE_ticket_id_request_t';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE OR REPLACE TRIGGER SE_ticket_id_request_t
BEFORE INSERT ON ticket_id_request
FOR EACH ROW
BEGIN
    IF :new.id IS NULL THEN
        SELECT SE_ticket_id_request.nextval
        INTO :new.id
        FROM DUAL;
    END IF;
END;
...
CREATE TABLE ticket_request (
    id NUMBER (12, 0) NOT NULL,
    ticket_id NUMBER (12, 0) NOT NULL,
    antrag_id NUMBER (12, 0) NOT NULL,
    feld_key VARCHAR (1000) NULL,
...
ALTER TABLE ticket_request ADD CONSTRAINT PK_ticket_request PRIMARY KEY (id);
BEGIN
    EXECUTE IMMEDIATE 'DROP SEQUENCE SE_ticket_request';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE SEQUENCE SE_ticket_request
INCREMENT BY 1
START WITH 1
NOMAXVALUE
NOCYCLE
...
;
BEGIN
    EXECUTE IMMEDIATE 'DROP TRIGGER SE_ticket_request_t';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE OR REPLACE TRIGGER SE_ticket_request_t
BEFORE INSERT ON ticket_request
FOR EACH ROW
BEGIN
    IF :new.id IS NULL THEN
        SELECT SE_ticket_request.nextval
        INTO :new.id
        FROM DUAL;
    END IF;
END;
...
ALTER TABLE request_groups ADD CONSTRAINT PK_request_groups PRIMARY KEY (id);
BEGIN
    EXECUTE IMMEDIATE 'DROP SEQUENCE SE_request_groups';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE SEQUENCE SE_request_groups
INCREMENT BY 1
START WITH 1
NOMAXVALUE
NOCYCLE
...
;
BEGIN
    EXECUTE IMMEDIATE 'DROP TRIGGER SE_request_groups_t';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE OR REPLACE TRIGGER SE_request_groups_t
BEFORE INSERT ON request_groups
FOR EACH ROW
BEGIN
    IF :new.id IS NULL THEN
        SELECT SE_request_groups.nextval
        INTO :new.id
        FROM DUAL;
    END IF;
END;
...
;
-- ----------------------------------------------------------
--  create table request_group_customer_user
-- ----------------------------------------------------------
CREATE TABLE request_group_customer_user (
    user_id VARCHAR2 (100) NOT NULL,
    group_id NUMBER (12, 0) NOT NULL,
...
BEGIN
    EXECUTE IMMEDIATE 'CREATE INDEX request_group_customer_user_group_id ON request_group_customer_user (group_id)';
EXCEPTION
  WHEN OTHERS THEN NULL;
END;
/
...
;
BEGIN
    EXECUTE IMMEDIATE 'CREATE INDEX request_group_customer_user_user_id ON request_group_customer_user (user_id)';
EXCEPTION
  WHEN OTHERS THEN NULL;
END;
/
...
CREATE TABLE room_equipments (
    id NUMBER (12, 0) NOT NULL,
    name VARCHAR2 (250) NOT NULL,
    quantity VARCHAR2 (250) NULL,
    equipment_type NUMBER (5, 0) NULL,
    price VARCHAR2 (250) NULL,
    currency NUMBER (5, 0) NULL,
    model VARCHAR2 (250) NULL,
    bookable NUMBER (5, 0) NULL,
    comments VARCHAR2 (250) NULL,
    valid_id NUMBER (5, 0) NOT NULL,
    create_time DATE NOT NULL,
    create_by NUMBER (12, 0) NOT NULL,
...
ALTER TABLE room_equipments ADD CONSTRAINT PK_room_equipments PRIMARY KEY (id);
BEGIN
    EXECUTE IMMEDIATE 'DROP SEQUENCE SE_room_equipments';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE SEQUENCE SE_room_equipments
INCREMENT BY 1
START WITH 1
NOMAXVALUE
NOCYCLE
...
;
BEGIN
    EXECUTE IMMEDIATE 'DROP TRIGGER SE_room_equipments_t';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE OR REPLACE TRIGGER SE_room_equipments_t
BEFORE INSERT ON room_equipments
FOR EACH ROW
BEGIN
    IF :new.id IS NULL THEN
        SELECT SE_room_equipments.nextval
        INTO :new.id
        FROM DUAL;
    END IF;
END;
...
CREATE TABLE room_booking (
    id NUMBER (12, 0) NOT NULL,
    room_id NUMBER (12, 0) NOT NULL,
    participant VARCHAR2 (250) NOT NULL,
    subject VARCHAR2 (250) NOT NULL,
    text VARCHAR2 (3000) NOT NULL,
    from_time DATE NOT NULL,
    to_time DATE NOT NULL,
    toend_time DATE NOT NULL,
    email_list VARCHAR2 (2000) NULL,
    equipment_order VARCHAR2 (2000) NULL,
    cal_uid VARCHAR2 (250) NOT NULL,
    sequence NUMBER (5, 0) NOT NULL,
    qb_tid NUMBER (12, 0) NULL,
    qd_tid NUMBER (12, 0) NULL,
    qc_tid NUMBER (12, 0) NULL,
    create_time DATE NOT NULL,
    create_by VARCHAR2 (250) NOT NULL,
    change_time DATE NOT NULL,
    change_by VARCHAR2 (250) NOT NULL
);
ALTER TABLE room_booking ADD CONSTRAINT PK_room_booking PRIMARY KEY (id);
BEGIN
    EXECUTE IMMEDIATE 'DROP SEQUENCE SE_room_booking';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE SEQUENCE SE_room_booking
INCREMENT BY 1
START WITH 1
NOMAXVALUE
NOCYCLE
...
;
BEGIN
    EXECUTE IMMEDIATE 'DROP TRIGGER SE_room_booking_t';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE OR REPLACE TRIGGER SE_room_booking_t
BEFORE INSERT ON room_booking
FOR EACH ROW
BEGIN
    IF :new.id IS NULL THEN
        SELECT SE_room_booking.nextval
        INTO :new.id
        FROM DUAL;
    END IF;
END;
...
CREATE TABLE rooms (
    id NUMBER (12, 0) NOT NULL,
    categories_id NUMBER (12, 0) NOT NULL,
    room VARCHAR2 (250) NOT NULL,
    building VARCHAR2 (250) NULL,
    floor VARCHAR2 (250) NULL,
    street VARCHAR2 (250) NULL,
    post_code VARCHAR2 (250) NULL,
    city VARCHAR2 (250) NULL,
    calendar VARCHAR2 (250) NULL,
    setup_time VARCHAR2 (250) NULL,
    persons VARCHAR2 (250) NULL,
    price VARCHAR2 (250) NULL,
    price_for NUMBER (5, 0) NULL,
    currency VARCHAR2 (250) NULL,
    equipment_bookable VARCHAR2 (250) NULL,
    equipment VARCHAR2 (250) NULL,
    description VARCHAR2 (2000) NULL,
    queue_booking NUMBER (12, 0) NULL,
    queue_device NUMBER (12, 0) NULL,
    queue_catering NUMBER (12, 0) NULL,
    valid_id NUMBER (5, 0) NOT NULL,
    comment VARCHAR2 (250) NULL,
    image_id NUMBER (12, 0) NULL,
    room_color VARCHAR2 (250) NULL,
    create_time DATE NOT NULL,
    create_by NUMBER (12, 0) NOT NULL,
    change_time DATE NOT NULL,
    change_by NUMBER (12, 0) NOT NULL
);
ALTER TABLE rooms ADD CONSTRAINT PK_rooms KEY (id);
BEGIN
    EXECUTE IMMEDIATE 'DROP SEQUENCE SE_rooms';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
...
;
BEGIN
    EXECUTE IMMEDIATE 'DROP TRIGGER SE_rooms_t';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE OR REPLACE TRIGGER SE_rooms_t
BEFORE INSERT ON rooms
FOR EACH ROW
BEGIN
    IF :new.id IS NULL THEN
        SELECT SE_rooms.nextval
        INTO :new.id
        FROM DUAL;
    END IF;
END;
...
ALTER TABLE roomcategories ADD CONSTRAINT PK_roomcategories KEY (id);
BEGIN
    EXECUTE IMMEDIATE 'DROP SEQUENCE SE_roomcategories';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE SEQUENCE SE_roomcategories
INCREMENT BY 1
START WITH 1
NOMAXVALUE
NOCYCLE
...
;
BEGIN
    EXECUTE IMMEDIATE 'DROP TRIGGER SE_roomcategories_t';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE OR REPLACE TRIGGER SE_roomcategories_t
BEFORE INSERT ON roomcategories
FOR EACH ROW
BEGIN
    IF :new.id IS NULL THEN
        SELECT SE_roomcategories.nextval
        INTO :new.id
        FROM DUAL;
    END IF;
END;
...
ALTER TABLE room_icon ADD CONSTRAINT PK_room_icon PRIMARY KEY (id);
BEGIN
    EXECUTE IMMEDIATE 'DROP SEQUENCE SE_room_icon';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
...
;
BEGIN
    EXECUTE IMMEDIATE 'DROP TRIGGER SE_room_icon_t';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE OR REPLACE TRIGGER SE_room_icon_t
BEFORE INSERT ON request
FOR EACH ROW
BEGIN
    IF :new.id IS NULL THEN
        SELECT SE_room_icon.nextval
        INTO :new.id
        FROM DUAL;
    END IF;
END;
...
CREATE TABLE checklist (
    ...
    type_id NUMBER (12, 0) NULL,
    service_id NUMBER (12, 0) NULL,
    queue_ids VARCHAR2 (250) NULL,
    type_ids VARCHAR2 (250) NULL,
    service_ids VARCHAR2 (250) NULL,
    set_article NUMBER (5, 0) NOT NULL,
    valid_id NUMBER (5, 0) NOT NULL,
    comment VARCHAR2 (250) NULL,
    create_time DATE NOT NULL,
    create_by NUMBER (12, 0) NOT NULL,
...
ALTER TABLE checklist ADD CONSTRAINT PK_checklist PRIMARY KEY (id);
BEGIN
    EXECUTE IMMEDIATE 'DROP SEQUENCE SE_checklist';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
...
;
BEGIN
    EXECUTE IMMEDIATE 'DROP TRIGGER SE_checklist_t';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE OR REPLACE TRIGGER SE_checklist_t
BEFORE INSERT ON request
FOR EACH ROW
BEGIN
    IF :new.id IS NULL THEN
        SELECT SE_checklist.nextval
        INTO :new.id
        FROM DUAL;
    END IF;
END;
...
CREATE TABLE checklist_field (
    id NUMBER (12, 0) NOT NULL,
    checklist_id NUMBER (12, 0) NOT NULL,
    task VARCHAR2 (250) NOT NULL,
    fieldorder NUMBER (12, 0) NOT NULL,
    field_type VARCHAR2 (250) NOT NULL,
    create_time DATE NOT NULL,
    create_by NUMBER (12, 0) NOT NULL,
    change_time DATE NOT NULL,
    change_by NUMBER (12, 0) NOT NULL
);
ALTER TABLE checklist_field ADD CONSTRAINT PK_checklist_field PRIMARY KEY (id);
BEGIN
    EXECUTE IMMEDIATE 'DROP SEQUENCE SE_checklist_field';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE SEQUENCE SE_checklist_field
INCREMENT BY 1
START WITH 1
NOMAXVALUE
NOCYCLE
...
;
BEGIN
    EXECUTE IMMEDIATE 'DROP TRIGGER SE_checklist_field_t';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE OR REPLACE TRIGGER SE_checklist_field_t
BEFORE INSERT ON request
FOR EACH ROW
BEGIN
    IF :new.id IS NULL THEN
        SELECT SE_checklist_field.nextval
        INTO :new.id
        FROM DUAL;
    END IF;
END;
...
CREATE TABLE checklist_field_value (
    ...
    field_type VARCHAR2 (250) NOT NULL,
    fieldorder NUMBER (12, 0) NOT NULL,
    if_set NUMBER (5, 0) NULL,
    create_time DATE NOT NULL,
    create_by NUMBER (12, 0) NOT NULL,
    change_time DATE NOT NULL,
    change_by NUMBER (12, 0) NOT NULL
);
ALTER TABLE checklist_field_value ADD CONSTRAINT PK_checklist_field_value PRIMARY KEY (id);
BEGIN
    EXECUTE IMMEDIATE 'DROP SEQUENCE SE_checklist_field_value';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE SEQUENCE SE_checklist_field_value
INCREMENT BY 1
START WITH 1
NOMAXVALUE
NOCYCLE
...
;
BEGIN
    EXECUTE IMMEDIATE 'DROP TRIGGER SE_checklist_field_value_t';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE OR REPLACE TRIGGER SE_checklist_field_value_t
BEFORE INSERT ON request
FOR EACH ROW
BEGIN
    IF :new.id IS NULL THEN
        SELECT SE_checklist_field_value.nextval
        INTO :new.id
        FROM DUAL;
    END IF;
END;
...
ALTER TABLE calendar_team ADD CONSTRAINT PK_calendar_team PRIMARY KEY (id);
BEGIN
    EXECUTE IMMEDIATE 'DROP SEQUENCE SE_calendar_team';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE SEQUENCE SE_calendar_team
INCREMENT BY 1
START WITH 1
NOMAXVALUE
NOCYCLE
...
;
BEGIN
    EXECUTE IMMEDIATE 'DROP TRIGGER SE_calendar_team_t';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE OR REPLACE TRIGGER SE_calendar_team_t
BEFORE INSERT ON request
FOR EACH ROW
BEGIN
    IF :new.id IS NULL THEN
        SELECT SE_calendar_team.nextval
        INTO :new.id
        FROM DUAL;
    END IF;
END;
...
ALTER TABLE calendar_team_user ADD CONSTRAINT PK_calendar_team_user PRIMARY KEY (id);
BEGIN
    EXECUTE IMMEDIATE 'DROP SEQUENCE SE_calendar_team_user';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE SEQUENCE SE_calendar_team_user
INCREMENT BY 1
START WITH 1
NOMAXVALUE
NOCYCLE
...
;
BEGIN
    EXECUTE IMMEDIATE 'DROP TRIGGER SE_calendar_team_user_t';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE OR REPLACE TRIGGER SE_calendar_team_user_t
BEFORE INSERT ON request
FOR EACH ROW
BEGIN
    IF :new.id IS NULL THEN
        SELECT SE_calendar_team_user.nextval
        INTO :new.id
        FROM DUAL;
    END IF;
END;
...
ALTER TABLE tracking_category ADD CONSTRAINT PK_tracking_category PRIMARY KEY (id);
BEGIN
    EXECUTE IMMEDIATE 'DROP SEQUENCE SE_tracking_category';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE SEQUENCE SE_tracking_category
INCREMENT BY 1
START WITH 1
NOMAXVALUE
NOCYCLE
...
;
BEGIN
    EXECUTE IMMEDIATE 'DROP TRIGGER SE_tracking_category_t';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE OR REPLACE TRIGGER SE_tracking_category_t
BEFORE INSERT ON request
FOR EACH ROW
BEGIN
    IF :new.id IS NULL THEN
        SELECT SE_tracking_category.nextval
        INTO :new.id
        FROM DUAL;
    END IF;
END;
...
CREATE TABLE time_tracking_article (
    ...
    ticket_id NUMBER (12, 0) NOT NULL,
    time_tracking_id NUMBER (5, 0) NOT NULL,
    time_tracking_time VARCHAR2 (250) NOT NULL,
    subject VARCHAR2 (250) NOT NULL,
    seen NUMBER (12, 0) NULL,
    content CLOB NULL,
    filename VARCHAR2 (250) NULL,
    comments VARCHAR2 (250) NULL,
    create_time DATE NOT NULL,
...
ALTER TABLE time_tracking_article ADD CONSTRAINT PK_time_tracking_article PRIMARY KEY (id);
BEGIN
    EXECUTE IMMEDIATE 'DROP SEQUENCE SE_time_tracking_article';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE SEQUENCE SE_time_tracking_article
INCREMENT BY 1
START WITH 1
NOMAXVALUE
NOCYCLE
...
;
BEGIN
    EXECUTE IMMEDIATE 'DROP TRIGGER SE_time_tracking_article_t';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE OR REPLACE TRIGGER SE_time_tracking_article_t
BEFORE INSERT ON request
FOR EACH ROW
BEGIN
    IF :new.id IS NULL THEN
        SELECT SE_time_tracking_article.nextval
        INTO :new.id
        FROM DUAL;
    END IF;
END;
...
CREATE TABLE t_process_transition (
    ...
    processstep_no NUMBER (12, 0) NOT NULL,
    step_no NUMBER (12, 0) NOT NULL,
    type_id NUMBER (12, 0) NULL,
...
ALTER TABLE t_process_transition ADD CONSTRAINT PK_t_process_transition PRIMARY KEY (id);
BEGIN
    EXECUTE IMMEDIATE 'DROP SEQUENCE SE_t_process_transition';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE SEQUENCE SE_t_process_transition
INCREMENT BY 1
START WITH 1
NOMAXVALUE
NOCYCLE
...
;
BEGIN
    EXECUTE IMMEDIATE 'DROP TRIGGER SE_t_process_transition_t';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
...
BEGIN
    IF :new.id IS NULL THEN
        SELECT SE_t_process_transition.nextval
        INTO :new.id
        FROM DUAL;
    END IF;
END;
...
CREATE TABLE t_process_step (
    ...
    step_no NUMBER (12, 0) NOT NULL,
    step_no_from NUMBER (12, 0) NOT NULL,
    to_id_from_one NUMBER (12, 0) NULL,
    ...
    with_conditions_end NUMBER (5, 0) NULL,
    ...
    change_time DATE NOT NULL,
    change_by NUMBER (12, 0) NOT NULL,
    with_conditions NUMBER (5, 0) NULL,
    ticket_id NUMBER (12, 0) NOT NULL,
    ready NUMBER (5, 0) NULL,
    step_active NUMBER (5, 0) NULL,
...
BEGIN
    EXECUTE IMMEDIATE 'DROP SEQUENCE SE_t_process_step';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE SEQUENCE SE_t_process_step
INCREMENT BY 1
START WITH 1
NOMAXVALUE
NOCYCLE
...
;
BEGIN
    EXECUTE IMMEDIATE 'DROP TRIGGER SE_t_process_step_t';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
...
BEGIN
    IF :new.id IS NULL THEN
        SELECT SE_t_process_step.nextval
        INTO :new.id
        FROM DUAL;
    END IF;
END;
...
CREATE TABLE t_process_merge (
    id NUMBER (12, 0) NOT NULL,
    old_id NUMBER (12, 0) NOT NULL,
    new_id NUMBER (12, 0) NOT NULL,
    ticket_id NUMBER (12, 0) NOT NULL
);
ALTER TABLE t_process_merge ADD CONSTRAINT PK_t_process_merge PRIMARY KEY (id);
BEGIN
    EXECUTE IMMEDIATE 'DROP SEQUENCE SE_t_process_merge';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE SEQUENCE SE_t_process_merge
INCREMENT BY 1
START WITH 1
NOMAXVALUE
NOCYCLE
...
;
BEGIN
    EXECUTE IMMEDIATE 'DROP TRIGGER SE_t_process_merge_t';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE OR REPLACE TRIGGER SE_t_process_merge_t
BEFORE INSERT ON request
FOR EACH ROW
BEGIN
    IF :new.id IS NULL THEN
        SELECT SE_t_process_merge.nextval
        INTO :new.id
        FROM DUAL;
    END IF;
END;
...
ALTER TABLE t_process_list ADD CONSTRAINT PK_t_process_list PRIMARY KEY (id);
BEGIN
    EXECUTE IMMEDIATE 'DROP SEQUENCE SE_t_process_list';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE SEQUENCE SE_t_process_list
INCREMENT BY 1
START WITH 1
NOMAXVALUE
NOCYCLE
...
;
BEGIN
    EXECUTE IMMEDIATE 'DROP TRIGGER SE_t_process_list_t';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
...
BEGIN
    IF :new.id IS NULL THEN
        SELECT SE_t_process_list.nextval
        INTO :new.id
        FROM DUAL;
    END IF;
END;
...
CREATE TABLE t_process_fields_value (
    ...
    queue_id NUMBER (12, 0) NULL,
    state_id NUMBER (12, 0) NULL,
    from_customer VARCHAR2 (250) NULL,
    user_id NUMBER (12, 0) NULL,
    approval NUMBER (5, 0) NULL,
    create_time DATE NOT NULL,
    create_by NUMBER (12, 0) NOT NULL,
    change_time DATE NOT NULL,
    change_by NUMBER (12, 0) NOT NULL
...
CREATE TABLE t_process_fields (
    ...
    processstep_id NUMBER (12, 0) NOT NULL,
    field_id NUMBER (12, 0) NOT NULL,
    required NUMBER (5, 0) NOT NULL,
    sequence NUMBER (12, 0) NOT NULL,
    create_time DATE NOT NULL,
    create_by NUMBER (12, 0) NOT NULL,
    change_time DATE NOT NULL,
    change_by NUMBER (12, 0) NOT NULL,
...
ALTER TABLE t_process_d_conditions ADD CONSTRAINT PK_t_process_d_conditions PRIMARY KEY (id);
BEGIN
    EXECUTE IMMEDIATE 'DROP SEQUENCE SE_t_process_d_conditions';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE SEQUENCE SE_t_process_d_conditions
INCREMENT BY 1
START WITH 1
NOMAXVALUE
NOCYCLE
...
;
BEGIN
    EXECUTE IMMEDIATE 'DROP TRIGGER SE_t_process_d_conditions_t';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
...
BEGIN
    IF :new.id IS NULL THEN
        SELECT SE_t_process_d_conditions.nextval
        INTO :new.id
        FROM DUAL;
    END IF;
END;
...
CREATE TABLE t_process_conditions (
    ...
    processstep_no NUMBER (12, 0) NOT NULL,
    title VARCHAR2 (250) NULL,
    type NUMBER (12, 0) NULL,
    queue NUMBER (12, 0) NULL,
    state NUMBER (12, 0) NULL,
    service NUMBER (12, 0) NULL,
    sla NUMBER (12, 0) NULL,
    from_customer VARCHAR2 (250) NULL,
    owner VARCHAR2 (250) NULL,
    create_time DATE NOT NULL,
    create_by NUMBER (12, 0) NOT NULL,
    change_time DATE NOT NULL,
    change_by NUMBER (12, 0) NOT NULL,
...
ALTER TABLE t_process_conditions ADD CONSTRAINT PK_t_process_conditions PRIMARY KEY (id);
BEGIN
    EXECUTE IMMEDIATE 'DROP SEQUENCE SE_t_process_conditions';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE SEQUENCE SE_t_process_conditions
INCREMENT BY 1
START WITH 1
NOMAXVALUE
NOCYCLE
...
;
BEGIN
    EXECUTE IMMEDIATE 'DROP TRIGGER SE_t_process_conditions_t';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE OR REPLACE TRIGGER SE_t_process_conditions_t
BEFORE INSERT ON request
FOR EACH ROW
BEGIN
    IF :new.id IS NULL THEN
        SELECT SE_t_process_conditions.nextval
        INTO :new.id
        FROM DUAL;
    END IF;
END;
...
ALTER TABLE t_dynamicprocess_fields ADD CONSTRAINT PK_t_dynamicprocess_fields PRIMARY KEY (id);
BEGIN
    EXECUTE IMMEDIATE 'DROP SEQUENCE SE_t_dynamicprocess_fields';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE SEQUENCE SE_t_dynamicprocess_fields
INCREMENT BY 1
START WITH 1
NOMAXVALUE
NOCYCLE
...
;
BEGIN
    EXECUTE IMMEDIATE 'DROP TRIGGER SE_t_dynamicprocess_fields_t';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE OR REPLACE TRIGGER SE_t_dynamicprocess_fields_t
BEFORE INSERT ON request
FOR EACH ROW
BEGIN
    IF :new.id IS NULL THEN
        SELECT SE_t_dynamicprocess_fields.nextval
        INTO :new.id
        FROM DUAL;
    END IF;
END;
...
ALTER TABLE process_transition ADD CONSTRAINT PK_process_transition PRIMARY KEY (id);
BEGIN
    EXECUTE IMMEDIATE 'DROP SEQUENCE SE_process_transition';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE SEQUENCE SE_process_transition
INCREMENT BY 1
START WITH 1
NOMAXVALUE
NOCYCLE
...
;
BEGIN
    EXECUTE IMMEDIATE 'DROP TRIGGER SE_process_transition_t';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
...
BEGIN
    IF :new.id IS NULL THEN
        SELECT SE_process_transition.nextval
        INTO :new.id
        FROM DUAL;
    END IF;
END;
...
BEGIN
    EXECUTE IMMEDIATE 'DROP SEQUENCE SE_process_step';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE SEQUENCE SE_process_step
INCREMENT BY 1
START WITH 1
NOMAXVALUE
NOCYCLE
...
;
BEGIN
    EXECUTE IMMEDIATE 'DROP TRIGGER SE_process_step_t';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
...
BEGIN
    IF :new.id IS NULL THEN
        SELECT SE_process_step.nextval
        INTO :new.id
        FROM DUAL;
    END IF;
END;
...
ALTER TABLE process_list ADD CONSTRAINT PK_process_list PRIMARY KEY (id);
BEGIN
    EXECUTE IMMEDIATE 'DROP SEQUENCE SE_process_list';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE SEQUENCE SE_process_list
INCREMENT BY 1
START WITH 1
NOMAXVALUE
NOCYCLE
...
;
BEGIN
    EXECUTE IMMEDIATE 'DROP TRIGGER SE_process_list_t';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
...
BEGIN
    IF :new.id IS NULL THEN
        SELECT SE_process_list.nextval
        INTO :new.id
        FROM DUAL;
    END IF;
END;
...
ALTER TABLE process_d_conditions ADD CONSTRAINT PK_process_d_conditions PRIMARY KEY (id);
BEGIN
    EXECUTE IMMEDIATE 'DROP SEQUENCE SE_process_d_conditions';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE SEQUENCE SE_process_d_conditions
INCREMENT BY 1
START WITH 1
NOMAXVALUE
NOCYCLE
...
;
BEGIN
    EXECUTE IMMEDIATE 'DROP TRIGGER SE_process_d_conditions_t';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
...
BEGIN
    IF :new.id IS NULL THEN
        SELECT SE_process_d_conditions.nextval
        INTO :new.id
        FROM DUAL;
    END IF;
END;
...
ALTER TABLE process_conditions ADD CONSTRAINT PK_process_conditions PRIMARY KEY (id);
BEGIN
    EXECUTE IMMEDIATE 'DROP SEQUENCE SE_process_conditions';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE SEQUENCE SE_process_conditions
INCREMENT BY 1
START WITH 1
NOMAXVALUE
NOCYCLE
...
;
BEGIN
    EXECUTE IMMEDIATE 'DROP TRIGGER SE_process_conditions_t';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE OR REPLACE TRIGGER SE_process_conditions_t
BEFORE INSERT ON request
FOR EACH ROW
BEGIN
    IF :new.id IS NULL THEN
        SELECT SE_process_conditions.nextval
        INTO :new.id
        FROM DUAL;
    END IF;
END;
...
ALTER TABLE dynamicprocess_fields ADD CONSTRAINT PK_dynamicprocess_fields PRIMARY KEY (id);
BEGIN
    EXECUTE IMMEDIATE 'DROP SEQUENCE SE_dynamicprocess_fields';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE SEQUENCE SE_dynamicprocess_fields
INCREMENT BY 1
START WITH 1
NOMAXVALUE
NOCYCLE
...
;
BEGIN
    EXECUTE IMMEDIATE 'DROP TRIGGER SE_dynamicprocess_fields_t';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE OR REPLACE TRIGGER SE_dynamicprocess_fields_t
BEFORE INSERT ON request
FOR EACH ROW
BEGIN
    IF :new.id IS NULL THEN
        SELECT SE_dynamicprocess_fields.nextval
        INTO :new.id
        FROM DUAL;
    END IF;
END;
...
CREATE TABLE signature_user (
    id NUMBER (12, 0) NOT NULL,
    user_login NUMBER (12, 0) NOT NULL,
    signature_id NUMBER (12, 0) NOT NULL,
    create_time DATE NOT NULL,
    create_by NUMBER (12, 0) NOT NULL,
);
ALTER TABLE signature_user ADD CONSTRAINT PK_signature_user PRIMARY KEY (id);
BEGIN
    EXECUTE IMMEDIATE 'DROP SEQUENCE SE_signature_user';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE SEQUENCE SE_signature_user
INCREMENT BY 1
START WITH 1
NOMAXVALUE
NOCYCLE
...
;
BEGIN
    EXECUTE IMMEDIATE 'DROP TRIGGER SE_signature_user_t';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE OR REPLACE TRIGGER SE_signature_user_t
BEFORE INSERT ON request
FOR EACH ROW
BEGIN
    IF :new.id IS NULL THEN
        SELECT SE_signature_user.nextval
        INTO :new.id
        FROM DUAL;
    END IF;
END;
...
;
-- ----------------------------------------------------------
--  create table standard_templ_request_field
-- ----------------------------------------------------------
CREATE TABLE standard_templ_request_field (
    id NUMBER (12, 0) NOT NULL,
    standard_request_field_id NUMBER (12, 0) NOT NULL,
    standard_template_id NUMBER (12, 0) NOT NULL,
    create_time DATE NOT NULL,
    create_by NUMBER (12, 0) NOT NULL,
    change_time DATE NOT NULL,
...
ALTER TABLE standard_templ_request_field ADD CONSTRAINT PK_standard_templ_request_field PRIMARY KEY (id);
BEGIN
    EXECUTE IMMEDIATE 'DROP SEQUENCE SE_standard_templ_request_field';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE SEQUENCE SE_standard_templ_request_field
INCREMENT BY 1
START WITH 1
NOMAXVALUE
NOCYCLE
...
;
BEGIN
    EXECUTE IMMEDIATE 'DROP TRIGGER SE_standard_templ_request_field_t';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE OR REPLACE TRIGGER SE_standard_templ_request_field_t
BEFORE INSERT ON standard_templ_request_field
FOR EACH ROW
BEGIN
    IF :new.id IS NULL THEN
        SELECT SE_standard_templ_request_field.nextval
        INTO :new.id
        FROM DUAL;
    END IF;
END;
...
;
-- ----------------------------------------------------------
--  create table contractualpartner
-- ----------------------------------------------------------
CREATE TABLE contractualpartner (
    id NUMBER (12, 0) NOT NULL,
    company VARCHAR2 (250) NOT NULL,
    street VARCHAR2 (250) NULL,
    postcode VARCHAR2 (250) NULL,
    city VARCHAR2 (250) NULL,
    country VARCHAR2 (250) NULL,
    phone VARCHAR2 (250) NULL,
    contactperson VARCHAR2 (250) NULL,
    e_mail VARVARCHAR2CHAR (250) NULL,
    description VARCHAR2 (2000) NULL,
    valid_id NUMBER (5, 0) NOT NULL,
    create_time DATE NOT NULL,
    create_by NUMBER (12, 0) NOT NULL,
...
ALTER TABLE contractualpartner ADD CONSTRAINT PK_contractualpartner PRIMARY KEY (id);
BEGIN
    EXECUTE IMMEDIATE 'DROP SEQUENCE SE_contractualpartner';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE SEQUENCE SE_contractualpartner
INCREMENT BY 1
START WITH 1
NOMAXVALUE
NOCYCLE
...
;
BEGIN
    EXECUTE IMMEDIATE 'DROP TRIGGER SE_contractualpartner_t';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE OR REPLACE TRIGGER SE_contractualpartner_t
BEFORE INSERT ON contractualpartner
FOR EACH ROW
BEGIN
    IF :new.id IS NULL THEN
        SELECT SE_contractualpartner.nextval
        INTO :new.id
        FROM DUAL;
    END IF;
END;
...
ALTER TABLE contracttype ADD CONSTRAINT PK_contracttype PRIMARY KEY (id);
BEGIN
    EXECUTE IMMEDIATE 'DROP SEQUENCE SE_contracttype';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE SEQUENCE SE_contracttype
INCREMENT BY 1
START WITH 1
NOMAXVALUE
NOCYCLE
...
;
BEGIN
    EXECUTE IMMEDIATE 'DROP TRIGGER SE_contracttype_t';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE OR REPLACE TRIGGER SE_contracttype_t
BEFORE INSERT ON contracttype
FOR EACH ROW
BEGIN
    IF :new.id IS NULL THEN
        SELECT SE_contracttype.nextval
        INTO :new.id
        FROM DUAL;
    END IF;
END;
...
ALTER TABLE contractdevice ADD CONSTRAINT PK_contractdevice PRIMARY KEY (id);
BEGIN
    EXECUTE IMMEDIATE 'DROP SEQUENCE SE_contractdevice';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE SEQUENCE SE_contractdevice
INCREMENT BY 1
START WITH 1
NOMAXVALUE
NOCYCLE
...
;
BEGIN
    EXECUTE IMMEDIATE 'DROP TRIGGER SE_contractdevice_t';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE OR REPLACE TRIGGER SE_contractdevice_t
BEFORE INSERT ON contractdevice
FOR EACH ROW
BEGIN
    IF :new.id IS NULL THEN
        SELECT SE_contractdevice.nextval
        INTO :new.id
        FROM DUAL;
    END IF;
END;
...
CREATE TABLE contract (
    ...
    ticket_create VARCHAR2 (250) NULL,
...
BEGIN
    EXECUTE IMMEDIATE 'DROP SEQUENCE SE_contract';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
...
;
BEGIN
    EXECUTE IMMEDIATE 'DROP TRIGGER SE_contract_t';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE OR REPLACE TRIGGER SE_contract_t
BEFORE INSERT ON contract
FOR EACH ROW
BEGIN
    IF :new.id IS NULL THEN
        SELECT SE_contract.nextval
        INTO :new.id
        FROM DUAL;
    END IF;
END;
...
BEGIN
    EXECUTE IMMEDIATE 'DROP SEQUENCE SE_handover';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
...
;
BEGIN
    EXECUTE IMMEDIATE 'DROP TRIGGER SE_handover_t';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE OR REPLACE TRIGGER SE_handover_t
BEFORE INSERT ON handover
FOR EACH ROW
BEGIN
    IF :new.id IS NULL THEN
        SELECT SE_handover.nextval
        INTO :new.id
        FROM DUAL;
    END IF;
END;
...
;
-- ----------------------------------------------------------
--  create table selfservice_categories_icon
-- ----------------------------------------------------------
CREATE TABLE selfservice_categories_icon (
    id NUMBER (12, 0) NOT NULL,
    name VARCHAR2 (250) NOT NULL,
...
ALTER TABLE selfservicecategories ADD CONSTRAINT PK_selfservicecategories PRIMARY KEY (id);
BEGIN
    EXECUTE IMMEDIATE 'DROP SEQUENCE SE_selfservicecategories';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE SEQUENCE SE_selfservicecategories
INCREMENT BY 1
START WITH 1
NOMAXVALUE
NOCYCLE
...
;
BEGIN
    EXECUTE IMMEDIATE 'DROP TRIGGER SE_selfservicecategories_t';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE OR REPLACE TRIGGER SE_selfservicecategories_t
BEFORE INSERT ON selfservicecategories
FOR EACH ROW
BEGIN
    IF :new.id IS NULL THEN
        SELECT SE_selfservicecategories.nextval
        INTO :new.id
        FROM DUAL;
    END IF;
END;
...
;
-- ----------------------------------------------------------
--  create table selfservicecat_selfservice
-- ----------------------------------------------------------
CREATE TABLE selfservicecat_selfservice (
    id NUMBER (12, 0) NOT NULL,
    template_id NUMBER (12, 0) NOT NULL,
    selfservicecategories_id NUMBER (12, 0) NOT NULL,
    create_time DATE NOT NULL,
    create_by NUMBER (12, 0) NOT NULL,
    change_time DATE NOT NULL,
    change_by NUMBER (12, 0) NOT NULL
);
ALTER TABLE selfservicecat_selfservice ADD CONSTRAINT PK_selfservicecat_selfservice PRIMARY KEY (id);
BEGIN
    EXECUTE IMMEDIATE 'DROP SEQUENCE SE_selfservicecat_selfservice';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE SEQUENCE SE_selfservicecat_selfservice
INCREMENT BY 1
START WITH 1
NOMAXVALUE
NOCYCLE
...
;
BEGIN
    EXECUTE IMMEDIATE 'DROP TRIGGER SE_selfservicecat_selfservice_t';
EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
--
;
CREATE OR REPLACE TRIGGER SE_selfservicecat_selfservice_t
BEFORE INSERT ON selfservicecat_selfservice
FOR EACH ROW
BEGIN
    IF :new.id IS NULL THEN
        SELECT SE_selfservicecat_selfservice.nextval
        INTO :new.id
        FROM DUAL;
    END IF;
END;
