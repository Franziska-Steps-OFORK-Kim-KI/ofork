    ...
    TargetNS.InitAjaxDnDUpload = function () {
        ...
        function UploadFiles(SelectedFiles, $DropObj) {
            ...
            $.each(SelectedFiles, function(index, File) {
			    ...
			    var NewSessionName = Core.Config.Get('SessionName');
			    var NewSessionID = Core.Config.Get('SessionID');
			    var new_names = NewSessionName + "=" + NewSessionID;

                $.ajax({
                    url: Core.Config.Get('CGIHandle') + '?Action=AjaxAttachment;Subaction=Upload;FormID=' + FormID + ';' + new_names + ';ChallengeToken=' + ChallengeToken + SessionToken,
                    type: 'post',
                    data: Upload,
                    xhr: function() {
