...
/**
 * @namespace Core.Agent.Admin.TemplateRequestField
 * @memberof Core.Agent.Admin
 * @author OTRS AG
 * @description
 *      This namespace contains the special module function for TemplateRequestField selection.
 */
 Core.Agent.Admin.TemplateRequestField = (function (TargetNS) {

    /*
    * @name Init
    * @memberof Core.Agent.Admin.TemplateRequestField
    * @function
    * @description
    ...
    */
    TargetNS.Init = function () {
        ...
        Core.UI.Table.InitTableFilter($("#FilterRequestField"), $("#RequestField"));
        Core.UI.Table.InitTableFilter($("#Filter"), $("#TemplateRequestField"));
    };

    Core.Init.RegisterNamespace(TargetNS, 'APP_MODULE');

    return TargetNS;
}(Core.Agent.Admin.TemplateRequestField || {}));
