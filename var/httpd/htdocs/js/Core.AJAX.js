...
Core.AJAX = (function (TargetNS) {
    ...
    function HandleAJAXError(XHRObject, Status, Error) {
        ...
        // We are out of the OFORK App scope, that's why an exception would not be caught. Therefore we handle the error manually.
    ...
    function RedirectAfterSessionTimeOut(XHRObject) {
        ...
        if (Headers.match(/X-OFORK-Login: /i)) {
     ...
     *                      but is not needed any more and will be removed in a future version of OFORK.
