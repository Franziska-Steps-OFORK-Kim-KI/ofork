...
/**
 * @namespace Core.Agent.Admin.SelfServiceCategoriesIcon
 * @memberof Core.Agent.Admin
 * @author OTRS AG
 * @description
 *      This namespace contains the special module function for CategoriesIcon module.
 */
 Core.Agent.Admin.SelfServiceCategoriesIcon = (function (TargetNS) {

    /**
     * @name Init
     * @memberof Core.Agent.Admin.SelfServiceCategoriesIcon
     * @function
     * @description
                ...
                [
                    {
                        ...
                        Function: function() {
                            ...
                            Core.AJAX.FunctionCall(
                                Core.Config.Get('Baselink') + 'Action=AdminSelfServiceCategoriesIcon;Subaction=Delete',
