...
/**
 * @namespace Core.Agent.Admin.TimeTracking
 * @memberof Core.Agent.Admin
 * @author OTRS AG
 * @description
 *      This namespace contains the special module function for CategoriesIcon module.
 */
 Core.Agent.Admin.TimeTracking = (function (TargetNS) {

    /**
     * @name Init
     * @memberof Core.Agent.Admin.TimeTracking
     * @function
     * @description
                ...
                [
                    {
                        ...
                        Function: function() {
                            ...
                            Core.AJAX.FunctionCall(
                                Core.Config.Get('Baselink') + 'Action=AgentTicketTimeTracking;Subaction=Delete;ID=',
                                { ID: $AttachmentDeleteElement.data('id'), TicketID: $AttachmentDeleteElement.data('ticketid') },
                                function(Reponse) {
                                    ...
                                    if (parseInt(Reponse, 10) > 0) {
                                        ...
                                        window.location.href = window.location + '?Action=AgentTicketTimeTracking;TicketID=' + Reponse;
                                    }
