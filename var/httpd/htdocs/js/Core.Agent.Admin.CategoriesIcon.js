...
/**
 * @namespace Core.Agent.Admin.CategoriesIcon
 * @memberof Core.Agent.Admin
 * @author OTRS AG
 * @description
 *      This namespace contains the special module function for CategoriesIcon module.
 */
 Core.Agent.Admin.CategoriesIcon = (function (TargetNS) {

    /**
     * @name Init
     * @memberof Core.Agent.Admin.CategoriesIcon
     * @function
     * @description
                ...
                [
                    {
                        ...
                        Function: function() {
                            ...
                            Core.AJAX.FunctionCall(
                                Core.Config.Get('Baselink') + 'Action=AdminRequestCategoriesIcon;Subaction=Delete',
